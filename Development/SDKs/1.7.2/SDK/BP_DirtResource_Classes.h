...
namespace CG
{
	 ...
	 * Size -> 0x000C (FullSize[0x04A4] - InheritedSize[0x0498])
	 */
	class ABP_DirtResource_C : public ABP_ParentResource_C
	{
	public:
		struct FPointerToUberGraphFrame                            UberGraphFrame;                                          // 0x0498(0x0008) ZeroConstructor, Transient, DuplicateTransient
		int32_t                                                    DirtQuality;                                             // 0x04A0(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash
