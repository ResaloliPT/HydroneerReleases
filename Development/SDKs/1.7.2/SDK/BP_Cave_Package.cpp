...
namespace CG
{
	 ...
	 * Function:
	 * 		Offset -> 0x00B73C40
	 * 		Name   -> Function BP_Cave.BP_Cave_C.PostLoad
	 * 		Flags  -> (BlueprintCallable, BlueprintEvent)
	 */
	void ABP_Cave_C::PostLoad()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_Cave.BP_Cave_C.PostLoad");
		
		ABP_Cave_C_PostLoad_Params params {};
