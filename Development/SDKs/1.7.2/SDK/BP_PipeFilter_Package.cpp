...
namespace CG
{
	 ...
	 */
	void ABP_PipeFilter_C::OverrideWaterIn(const class FString& Box, int32_t Water_Quality, float Water_Pressure)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_PipeFilter.BP_PipeFilter_C.OverrideWaterIn");
	 ...
	 */
	void ABP_PipeFilter_C::ExecuteUbergraph_BP_PipeFilter(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_PipeFilter.BP_PipeFilter_C.ExecuteUbergraph_BP_PipeFilter");
	 ...
	 * Function:
	 * 		Offset -> 0x00000000
	 * 		Name   -> PredefindFunction ABP_PipeFilter_C.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* ABP_PipeFilter_C::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass BP_PipeFilter.BP_PipeFilter_C");
		return ptr;
	}
