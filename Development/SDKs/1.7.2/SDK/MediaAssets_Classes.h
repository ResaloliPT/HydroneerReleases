...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_V26Y[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_YJWT[0x17];                                  // 0x0049(0x0017) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_26B8[0x2];                                   // 0x00C2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_J7R9[0x3];                                   // 0x00C5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_PECT[0x4];                                   // 0x00D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_5KTJ[0x2C];                                  // 0x00F4(0x002C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_FWPM[0x8];                                   // 0x0130(0x0008) MISSED OFFSET (PADDING)
	 ...
	 * Size -> 0x0210 (FullSize[0x0880] - InheritedSize[0x0670])
	 */
	...
	public:
		...
		unsigned char                                              UnknownData_LXEW[0x3];                                   // 0x0670(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		...
		unsigned char                                              UnknownData_ZCIS[0x3];                                   // 0x0675(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_TANR[0x4];                                   // 0x068C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_PZ59[0x1E8];                                 // 0x0698(0x01E8) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_DF8G[0x1];                                   // 0x00BB(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_0K8X[0x4];                                   // 0x00CC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_9IR3[0xA8];                                  // 0x00D8(0x00A8) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_4NGE[0x7];                                   // 0x0039(0x0007) MISSED OFFSET (PADDING)
