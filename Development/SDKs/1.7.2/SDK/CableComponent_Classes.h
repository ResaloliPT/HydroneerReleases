...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_X4ZN[0x6];                                   // 0x05A2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		int32_t                                                    NumSegments;                                             // 0x05D8(0x0004) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		...
		int32_t                                                    SolverIterations;                                        // 0x05E0(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		...
		unsigned char                                              UnknownData_YP7S[0x2];                                   // 0x05E6(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_GV6H[0x18];                                  // 0x0608(0x0018) MISSED OFFSET (PADDING)
