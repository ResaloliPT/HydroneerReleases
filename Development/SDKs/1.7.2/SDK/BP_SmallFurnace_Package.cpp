...
namespace CG
{
	 ...
	 */
	void ABP_SmallFurnace_C::OverridePlacedDown()
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * Function:
	 * 		Offset -> 0x00B73C40
	 * 		Name   -> Function BP_SmallFurnace.BP_SmallFurnace_C.OverrideLoaded
	 * 		Flags  -> (BlueprintCallable, BlueprintEvent)
	 */
	void ABP_SmallFurnace_C::OverrideLoaded()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_SmallFurnace.BP_SmallFurnace_C.OverrideLoaded");
		
		ABP_SmallFurnace_C_OverrideLoaded_Params params {};
	 ...
	 * Function:
	 * 		Offset -> 0x00B73C40
	 * 		Name   -> Function BP_SmallFurnace.BP_SmallFurnace_C.OverrideMouseActivated
	 * 		Flags  -> (BlueprintCallable, BlueprintEvent)
	 * Parameters:
	 * 		class UPrimitiveComponent*                         Component                                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void ABP_SmallFurnace_C::OverrideMouseActivated(class UPrimitiveComponent* Component)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_SmallFurnace.BP_SmallFurnace_C.OverrideMouseActivated");
		
		ABP_SmallFurnace_C_OverrideMouseActivated_Params params {};
