...
namespace CG
{
	...
	{
	private:
		static constexpr int32_t                                   NAME_WIDE_MASK = 0x1;                                    // 0x0000(0x0000)
		static constexpr int32_t                                   NAME_INDEX_SHIFT = 0x1;                                  // 0x0000(0x0000)
	...
	{
	private:
		static constexpr int32_t                                   ChunkTableSize = (MaxTotalElements + ElementsPerChunk - 1) / ElementsPerChunk; // 0x0000(0x0000)
	...
	private:
		ElementType* GetItemPtr(int32_t index) const
		{
			...
			uintptr_t ptrAddress = *reinterpret_cast<uintptr_t*>(reinterpret_cast<uint8*>(Chunk) + offset);
