...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_CloutiumBar.BP_CloutiumBar_C
	 * Size -> 0x0018 (FullSize[0x04B0] - InheritedSize[0x0498])
	 */
	class ABP_CloutiumBar_C : public ABP_ParentResource_C
	{
	public:
		...
		unsigned char                                              UnknownData_RS6K[0x4];                                   // 0x04A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_BP_CloutiumBar(int32_t EntryPoint);
