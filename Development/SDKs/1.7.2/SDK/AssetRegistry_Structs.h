...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_0LCG[0x28];                                  // 0x0028(0x0028) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_BF66[0x50];                                  // 0x0040(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_67S1[0x5];                                   // 0x00E3(0x0005) MISSED OFFSET (PADDING)
