...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_GE68[0xB];                                   // 0x0005(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_L5ZG[0x18];                                  // 0x0048(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_LO76[0x7];                                   // 0x0011(0x0007) MISSED OFFSET (PADDING)
