...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_KNN9[0x1];                                   // 0x0000(0x0001) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_X2FG[0x1];                                   // 0x0000(0x0001) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_60EL[0x7];                                   // 0x0031(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_TGXW[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_8DP1[0x7];                                   // 0x0049(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_F0PV[0x7];                                   // 0x0091(0x0007) MISSED OFFSET (PADDING)
