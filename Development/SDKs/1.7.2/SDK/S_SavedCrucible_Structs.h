...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_HW3K[0x8];                                   // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		E_MoltenType_E_MoltenType                                  MoltenType_12_015155B8416433E97CD807ACF2CF9DCF;          // 0x0040(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_I7ZX[0x3];                                   // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
