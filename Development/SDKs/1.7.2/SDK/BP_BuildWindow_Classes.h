...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_BuildWindow.BP_BuildWindow_C
	 * Size -> 0x0010 (FullSize[0x0540] - InheritedSize[0x0530])
	 */
	class ABP_BuildWindow_C : public ABP_ParentBuild_C
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_BP_BuildWindow(int32_t EntryPoint);
