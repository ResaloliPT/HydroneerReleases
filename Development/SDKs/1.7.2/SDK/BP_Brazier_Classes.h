...
namespace CG
{
	...
	{
	public:
		class UParticleSystemComponent*                            FX_FurnaceFire;                                          // 0x0340(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
