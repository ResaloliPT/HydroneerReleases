...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_58CQ[0x8];                                   // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_42LM[0x6];                                   // 0x0042(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		E_LogicButtonSymbols_E_LogicButtonSymbols                  Symbol_36_83A3DF974A7A558F8D74F8823177ED8E;              // 0x0059(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
