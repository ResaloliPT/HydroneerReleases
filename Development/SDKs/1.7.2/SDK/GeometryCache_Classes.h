...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_YYWE[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_4WQM[0x10];                                  // 0x0050(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_8962[0x4];                                   // 0x003C(0x0004) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_PPLL[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (PADDING)
	 ...
	 * Size -> 0x0060 (FullSize[0x0600] - InheritedSize[0x05A0])
	 */
	...
	public:
		...
		unsigned char                                              UnknownData_FFWX[0x2];                                   // 0x05AA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		int32_t                                                    NumTracks;                                               // 0x05B4(0x0004) Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected
		...
		unsigned char                                              UnknownData_NW4D[0x30];                                  // 0x05BC(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_LMI9[0xF];                                   // 0x05F1(0x000F) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_0MZ4[0x2C];                                  // 0x002C(0x002C) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_4QSA[0x24];                                  // 0x005C(0x0024) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_FQJ9[0x128];                                 // 0x0060(0x0128) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_BTBK[0x4];                                   // 0x018C(0x0004) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_8RY0[0xA8];                                  // 0x0058(0x00A8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_HCG8[0xA8];                                  // 0x0058(0x00A8) MISSED OFFSET (PADDING)
