...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_LogicCableDiode.BP_LogicCableDiode_C
	 * Size -> 0x0014 (FullSize[0x05A8] - InheritedSize[0x0594])
	 */
	class ABP_LogicCableDiode_C : public ABP_ParentLogic_C
	{
	public:
		unsigned char                                              UnknownData_3L5O[0x4];                                   // 0x0594(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_BP_LogicCableDiode(int32_t EntryPoint);
