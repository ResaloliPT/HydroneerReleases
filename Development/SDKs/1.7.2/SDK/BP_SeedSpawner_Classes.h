...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_SeedSpawner.BP_SeedSpawner_C
	 * Size -> 0x0029 (FullSize[0x0359] - InheritedSize[0x0330])
	 */
	class ABP_SeedSpawner_C : public AActor
	{
	public:
		...
		class UClass*                                              BagToSpawn;                                              // 0x0350(0x0008) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash
	...
	public:
		void SpawnBag();
		void PostLoaded();
		void ExecuteUbergraph_BP_SeedSpawner(int32_t EntryPoint);
