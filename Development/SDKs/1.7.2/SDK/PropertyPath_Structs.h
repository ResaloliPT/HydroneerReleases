...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_5E66[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_AG3J[0x8];                                   // 0x0010(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_MHGT[0x8];                                   // 0x0020(0x0008) MISSED OFFSET (PADDING)
