...
namespace CG
{
	 ...
	 */
	void ABP_LogicWeightReader_C::OverridePlacedDown()
	{
	 ...
	 * Function:
	 * 		Offset -> 0x00B73C40
	 * 		Name   -> Function BP_LogicWeightReader.BP_LogicWeightReader_C.ReceiveEndPlay
	 ...
	 */
	void ABP_LogicWeightReader_C::ReceiveEndPlay(Engine_EEndPlayReason EndPlayReason)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_LogicWeightReader.BP_LogicWeightReader_C.ReceiveEndPlay");
		
		ABP_LogicWeightReader_C_ReceiveEndPlay_Params params {};
	 ...
	 * Function:
	 * 		Offset -> 0x00B73C40
	 * 		Name   -> Function BP_LogicWeightReader.BP_LogicWeightReader_C.BndEvt__WeightDetectBox_K2Node_ComponentBoundEvent_1_ComponentBeginOverlapSignature__DelegateSignature
	 ...
	 */
	void ABP_LogicWeightReader_C::BndEvt__WeightDetectBox_K2Node_ComponentBoundEvent_1_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, const struct FHitResult& SweepResult)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_LogicWeightReader.BP_LogicWeightReader_C.BndEvt__WeightDetectBox_K2Node_ComponentBoundEvent_1_ComponentBeginOverlapSignature__DelegateSignature");
		
		ABP_LogicWeightReader_C_BndEvt__WeightDetectBox_K2Node_ComponentBoundEvent_1_ComponentBeginOverlapSignature__DelegateSignature_Params params {};
	 ...
	 * 		Flags  -> (BlueprintCallable, BlueprintEvent)
	 */
	void ABP_LogicWeightReader_C::OverrideDroppedItem()
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * Function:
	 * 		Offset -> 0x00B73C40
	 * 		Name   -> Function BP_LogicWeightReader.BP_LogicWeightReader_C.OverrideNewLogic
	 * 		Flags  -> (BlueprintCallable, BlueprintEvent)
	 * Parameters:
	 ...
	 */
	void ABP_LogicWeightReader_C::OverrideNewLogic(const class FString& Box, const class FString& New_Logic)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_LogicWeightReader.BP_LogicWeightReader_C.OverrideNewLogic");
		
		ABP_LogicWeightReader_C_OverrideNewLogic_Params params {};
		params.Box = Box;
