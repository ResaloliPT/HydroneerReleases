...
namespace CG
{
	 ...
	 * Function:
	 * 		Offset -> 0x00B73C40
	 * 		Name   -> Function BP_WorldMap.BP_WorldMap_C.OverrideMouseActivated
	 * 		Flags  -> (BlueprintCallable, BlueprintEvent)
	 * Parameters:
	 * 		class UPrimitiveComponent*                         Component                                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void ABP_WorldMap_C::OverrideMouseActivated(class UPrimitiveComponent* Component)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_WorldMap.BP_WorldMap_C.OverrideMouseActivated");
		
		ABP_WorldMap_C_OverrideMouseActivated_Params params {};
