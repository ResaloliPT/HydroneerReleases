...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_ProjectilePower.BP_ProjectilePower_C
	 * Size -> 0x0020 (FullSize[0x0350] - InheritedSize[0x0330])
	 */
	class ABP_ProjectilePower_C : public AActor
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_BP_ProjectilePower(int32_t EntryPoint);
