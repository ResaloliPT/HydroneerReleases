...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_8WB1[0x50];                                  // 0x0000(0x0050) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_69G1[0x4];                                   // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_1PHL[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_3SSQ[0x4];                                   // 0x0084(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_IDYO[0x4];                                   // 0x0094(0x0004) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_0XFV[0x1];                                   // 0x0000(0x0001) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_0H22[0x20];                                  // 0x0000(0x0020) MISSED OFFSET (PADDING)
