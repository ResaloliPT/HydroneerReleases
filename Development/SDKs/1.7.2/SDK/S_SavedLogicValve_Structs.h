...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * UserDefinedStruct S_SavedLogicValve.S_SavedLogicValve
	 * Size -> 0x005A
	 */
	struct FS_SavedLogicValve
	{
	public:
		...
		unsigned char                                              UnknownData_FMY2[0x8];                                   // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_AFF2[0x6];                                   // 0x0042(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FString                                              Logic_30_64B6492749435479A48DB0A030988118;               // 0x0048(0x0010) Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash
		...
		bool                                                       Switch_35_BA6CDBA04DB080B9514810A97657CBF8;              // 0x0059(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
