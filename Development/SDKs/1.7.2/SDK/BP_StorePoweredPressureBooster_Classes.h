...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_StorePoweredPressureBooster.BP_StorePoweredPressureBooster_C
	 * Size -> 0x0008 (FullSize[0x0348] - InheritedSize[0x0340])
	 */
	class ABP_StorePoweredPressureBooster_C : public ABP_ParentStoreItem_C
	{
	public:
