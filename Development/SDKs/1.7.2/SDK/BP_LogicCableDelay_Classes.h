...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_LogicCableDelay.BP_LogicCableDelay_C
	 * Size -> 0x0014 (FullSize[0x05A8] - InheritedSize[0x0594])
	 */
	class ABP_LogicCableDelay_C : public ABP_ParentLogic_C
	{
	public:
		unsigned char                                              UnknownData_O9ET[0x4];                                   // 0x0594(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_BP_LogicCableDelay(int32_t EntryPoint);
