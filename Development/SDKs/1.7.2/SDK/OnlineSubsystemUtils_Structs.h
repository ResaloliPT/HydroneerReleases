...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_YU6I[0xB8];                                  // 0x0000(0x00B8) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_ONVF[0x3];                                   // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_3UID[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
