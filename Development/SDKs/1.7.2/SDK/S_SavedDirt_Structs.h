...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_ATPK[0x8];                                   // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		int32_t                                                    Quality_13_A80D543041170510BBF27FA06C6A1F68;             // 0x0044(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
