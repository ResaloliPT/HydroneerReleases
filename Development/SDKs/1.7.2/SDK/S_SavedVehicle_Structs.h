...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_QDSI[0x8];                                   // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		int32_t                                                    DirtQualityAverage_15_3502A749413253FBE638CDB7B6C0C3A3;  // 0x0048(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
