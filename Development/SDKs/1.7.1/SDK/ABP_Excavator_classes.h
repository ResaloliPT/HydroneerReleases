...
public:
	...
	unsigned char                                      UnknownData_4BOG[0x8];                                     // 0x0A48(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("AnimBlueprintGeneratedClass ABP_Excavator.ABP_Excavator_C");
		return ptr;
	}



	void ExecuteUbergraph_ABP_Excavator(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
