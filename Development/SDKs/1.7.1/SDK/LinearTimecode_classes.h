...
public:
	...
	unsigned char                                      UnknownData_ADQK[0x4];                                     // 0x027C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TFZU[0x30];                                    // 0x0290(0x0030) MISSED OFFSET (PADDING)
