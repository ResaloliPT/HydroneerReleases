...
struct FFoliageVertexColorChannelMask
{
	...
	unsigned char                                      UnknownData_5Q1C[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6F0R[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FFoliageTypeObject
{
	...
	unsigned char                                      UnknownData_6NIL[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FProceduralFoliageInstance
{
	...
	unsigned char                                      UnknownData_ZTAE[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C4AJ[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_84VP[0x20];                                    // 0x0040(0x0020) MISSED OFFSET (PADDING)
