...
struct FPropertyPathSegment
{
	...
	unsigned char                                      UnknownData_ZNHA[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCachedPropertyPath
{
	...
	unsigned char                                      UnknownData_6G9C[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GFPB[0x8];                                     // 0x0020(0x0008) MISSED OFFSET (PADDING)
