...
public:
	...
	unsigned char                                      UnknownData_KZ0B[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_O9L3[0x7];                                     // 0x0059(0x0007) MISSED OFFSET (PADDING)
