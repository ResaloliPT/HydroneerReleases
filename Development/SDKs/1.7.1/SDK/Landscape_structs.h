...
struct FLandscapeProxyMaterialOverride
{
	...
	unsigned char                                      UnknownData_KSKX[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWeightmapLayerAllocationInfo
{
	...
	unsigned char                                      UnknownData_OLNL[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (PADDING)
...
{
	struct FPerPlatformInt                             LODIndex;                                                  // 0x0000(0x0004) (Edit, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_5OHP[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UMaterialInterface*                          Material;                                                  // 0x0008(0x0008) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FGrassVariety
{
	...
	unsigned char                                      UnknownData_PUY4[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VW1T[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GE7U[0x5];                                     // 0x0043(0x0005) MISSED OFFSET (PADDING)
...
struct FLandscapeSplineConnection
{
	...
	unsigned char                                      UnknownData_AZE7[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
struct FLandscapeSplineSegmentConnection
{
	...
	unsigned char                                      UnknownData_YKX3[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FGrassInput
{
	...
	unsigned char                                      UnknownData_LTKL[0xC];                                     // 0x001C(0x000C) MISSED OFFSET (PADDING)
...
struct FLayerBlendInput
{
	...
	unsigned char                                      UnknownData_C4MB[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FExpressionInput                            LayerInput;                                                // 0x000C(0x000C) (NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_V15N[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FExpressionInput                            HeightInput;                                               // 0x0020(0x000C) (NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_TXE3[0x8];                                     // 0x002C(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FProceduralLayer
{
	...
	unsigned char                                      UnknownData_AHDZ[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_T26N[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FRenderDataPerHeightmap
{
	...
	unsigned char                                      UnknownData_L1K6[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_74Z2[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_UPEC[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_BH0Z[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ANEX[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_BLBT[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FLandscapeSplineMeshEntry
{
	...
	unsigned char                                      UnknownData_6ZMT[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_N8S5[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M0N4[0x1];                                     // 0x0037(0x0001) MISSED OFFSET (PADDING)
