...
{
public:
	unsigned char                                      UnknownData_5T1L[0x20];                                    // 0x0030(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_DM8Q[0x10];                                    // 0x0070(0x0010) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnSuccess;                                                 // 0x0050(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	struct FScriptMulticastDelegate                    OnFailed;                                                  // 0x0060(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_AI1M[0x28];                                    // 0x0070(0x0028) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_1EDP[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EMUC[0x1F];                                    // 0x00A1(0x001F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KR6D[0x10];                                    // 0x00E0(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_EIT1[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4N5P[0x3];                                     // 0x0055(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RLRJ[0x2];                                     // 0x0086(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_JWJ1[0x64];                                    // 0x041C(0x0064) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_B0JA[0x8];                                     // 0x03C0(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_CZUM[0x8];                                     // 0x0678(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_A0IE[0x8];                                     // 0x0348(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_H2KN[0x3];                                     // 0x00B9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_XYG4[0x5];                                     // 0x00DB(0x0005) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_NM4Q[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7KKE[0x37];                                    // 0x0091(0x0037) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_D3AU[0x10];                                    // 0x00E0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H5AO[0x8];                                     // 0x00F8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_UQP7[0x8];                                     // 0x00C8(0x0008) Fix Super Size
...
{
public:
	unsigned char                                      UnknownData_I0AU[0x8];                                     // 0x00C8(0x0008) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_YH0E[0x3];                                     // 0x00D5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TMap<AugmentedReality_EARFaceBlendShape, float>    BlendShapes;                                               // 0x00D8(0x0050) (ZeroConstructor, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_E0IZ[0x98];                                    // 0x0128(0x0098) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_5HQF[0x8];                                     // 0x00C8(0x0008) Fix Super Size
	unsigned char                                      UnknownData_ADVU[0x8];                                     // 0x00D0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_PO84[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_2HVX[0x3];                                     // 0x0111(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_FWXZ[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (PADDING)
