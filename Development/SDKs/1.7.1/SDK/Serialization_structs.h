...
struct FStructSerializerNumericTestStruct
{
	...
	unsigned char                                      UnknownData_00F7[0x1];                                     // 0x0001(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ATJU[0x1];                                     // 0x0011(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TIHK[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStructSerializerBooleanTestStruct
{
	...
	unsigned char                                      UnknownData_88ZU[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStructSerializerBuiltinTestStruct
{
	...
	unsigned char                                      UnknownData_W8JB[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_50ZH[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (PADDING)
...
struct FStructSerializerArrayTestStruct
{
	...
	unsigned char                                      UnknownData_YN45[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
