...
// 0x001C (FullSize[0x0580] - InheritedSize[0x0564])
class ABP_PressureGaugePipe_C : public ABP_ParentWaterItem_C
{
public:
	unsigned char                                      UnknownData_5K7S[0x4];                                     // 0x0564(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_PressureGaugePipe.BP_PressureGaugePipe_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_PressureGaugePipe(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
