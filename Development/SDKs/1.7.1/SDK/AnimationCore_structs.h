...
struct FAxis
{
	...
	unsigned char                                      UnknownData_Y7ZP[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FConstraintDescriptor
{
	...
	unsigned char                                      UnknownData_BZEZ[0xF];                                     // 0x0001(0x000F) MISSED OFFSET (PADDING)
...
struct FConstraintData
{
	...
	unsigned char                                      UnknownData_ST9I[0xB];                                     // 0x0015(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_INUR[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FFilterOptionPerAxis                        AxesFilterOption;                                          // 0x0008(0x0003) (Edit, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_OA6P[0x5];                                     // 0x000B(0x0005) MISSED OFFSET (PADDING)
...
struct FAimConstraintDescription : public FConstraintDescriptionEx
{
	...
	unsigned char                                      UnknownData_YET4[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTransformConstraintDescription : public FConstraintDescriptionEx
{
	...
	unsigned char                                      UnknownData_XQUC[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FTransformConstraint
{
	...
	unsigned char                                      UnknownData_10A9[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C3Z7[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
struct FConstraintOffset
{
	...
	unsigned char                                      UnknownData_QFAS[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2K2Q[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_AGZ4[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
