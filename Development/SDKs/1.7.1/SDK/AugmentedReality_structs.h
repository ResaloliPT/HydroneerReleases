...
struct FARTraceResult
{
	...
	unsigned char                                      UnknownData_J4BM[0xB];                                     // 0x0005(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QEFM[0x18];                                    // 0x0048(0x0018) MISSED OFFSET (PADDING)
...
struct FARSessionStatus
{
	...
	unsigned char                                      UnknownData_Q24V[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
