...
public:
	...
	unsigned char                                      UnknownData_I3LE[0x6];                                     // 0x05A2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2SNE[0x2];                                     // 0x05E6(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_U9SX[0x18];                                    // 0x0608(0x0018) MISSED OFFSET (PADDING)
