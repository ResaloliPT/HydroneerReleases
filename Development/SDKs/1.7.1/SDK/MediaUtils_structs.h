...
struct FMediaPlayerOptions
{
	...
	unsigned char                                      UnknownData_M6IT[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4HQT[0x6];                                     // 0x002A(0x0006) MISSED OFFSET (PADDING)
