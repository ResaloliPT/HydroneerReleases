...
{
public:
	unsigned char                                      UnknownData_AQ0X[0x8];                                     // 0x0330(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NYF8[0x3];                                     // 0x03A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OOL4[0x3];                                     // 0x03AD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RH21[0xD0];                                    // 0x03B8(0x00D0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FSupportedAreaData>                  SupportedAreas;                                            // 0x0488(0x0010) (ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_KQPU[0x58];                                    // 0x0498(0x0058) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_NKS9[0x6];                                     // 0x0042(0x0006) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_HVWL[0x10];                                    // 0x0070(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NTPK[0x2F];                                    // 0x00A9(0x002F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_HM6M[0x3F];                                    // 0x0049(0x003F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_3QHS[0x8];                                     // 0x0040(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_16WI : 1;                                      // 0x0060(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_SU8W[0x2];                                     // 0x0062(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AMGC[0x3];                                     // 0x0065(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AOWP[0x3];                                     // 0x0069(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UAN7[0x4];                                     // 0x0084(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_A9FO[0x60];                                    // 0x00A8(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PM08[0xCC];                                    // 0x0128(0x00CC) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y9R6[0x23B];                                   // 0x01F5(0x023B) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_L7SE[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_RA9X[0x10];                                    // 0x0330(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NJM6[0x7];                                     // 0x0351(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IAXG[0x4];                                     // 0x0394(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WRC3[0x2];                                     // 0x03AE(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CKR1[0x3];                                     // 0x03B1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0H3F[0x3];                                     // 0x03BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3A8A[0x4];                                     // 0x03CC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4K0D[0x30];                                    // 0x03E8(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_KBH9[0x8];                                     // 0x0578(0x0008) Fix Super Size
...
{
public:
	unsigned char                                      UnknownData_5S8U[0x24];                                    // 0x00F8(0x0024) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B0U0[0x3];                                     // 0x011D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_WJFO[0x8];                                     // 0x0128(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZTLG[0x4];                                     // 0x0134(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6Y3B[0x3];                                     // 0x0161(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P1NJ[0x3];                                     // 0x0165(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_G33M[0x3F];                                    // 0x0191(0x003F) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_5ZWE[0x8];                                     // 0x0578(0x0008) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_LLC8[0x4];                                     // 0x036C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_7MIS[0x8];                                     // 0x0578(0x0008) Fix Super Size
	unsigned char                                      UnknownData_JTLE[0x10];                                    // 0x0580(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_TS2L[0x13];                                    // 0x013D(0x0013) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Z0FR[0x8];                                     // 0x0368(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_COQK[0x7];                                     // 0x0339(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_0WB5[0x8];                                     // 0x0578(0x0008) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_Y1EF[0x1];                                     // 0x04F3(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QZXE[0x3];                                     // 0x04F9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EZNH[0x2];                                     // 0x055A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7HPL[0x2];                                     // 0x0566(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GHEF[0x34];                                    // 0x0574(0x0034) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_HHXN[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (PADDING)
