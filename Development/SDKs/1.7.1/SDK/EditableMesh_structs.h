...
struct FPolygonToSplit
{
	...
	unsigned char                                      UnknownData_HQ8O[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_QZM5[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FMeshElementAttributeData
{
	...
	unsigned char                                      UnknownData_NNPP[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPolygonGroupToCreate
{
	...
	unsigned char                                      UnknownData_LV4K[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FSubdividedWireEdge
{
	...
	unsigned char                                      UnknownData_2C7T[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
struct FPolygonToCreate
{
	...
	unsigned char                                      UnknownData_EYE5[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Z0Z5[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FAttributesForVertex
{
	...
	unsigned char                                      UnknownData_5015[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FVertexInstanceID                           VertexInstanceID;                                          // 0x0000(0x0004) (BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_G0GS[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FPolygonID                                  PolygonID;                                                 // 0x0000(0x0004) (BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_UDOU[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FEdgeID                                     EdgeID;                                                    // 0x0000(0x0004) (BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_4C2K[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FVertexToCreate
{
	...
	unsigned char                                      UnknownData_DK1F[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
{
	struct FVertexID                                   VertexID;                                                  // 0x0000(0x0004) (BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_6KDX[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FMeshElementAttributeList                   VertexInstanceAttributes;                                  // 0x0008(0x0010) (BlueprintVisible, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_P784[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FEdgeToCreate
{
	...
	unsigned char                                      UnknownData_KI6L[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
{
	struct FPolygonID                                  PolygonID;                                                 // 0x0000(0x0004) (BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_JO5T[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAdaptorPolygon2Group
{
	...
	unsigned char                                      UnknownData_XR4H[0x3C];                                    // 0x000C(0x003C) MISSED OFFSET (PADDING)
...
struct FAdaptorPolygon
{
	...
	unsigned char                                      UnknownData_EF23[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRenderingPolygonGroup
{
	...
	int                                                MaterialIndex;                                             // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int                                                MaxTriangles;                                              // 0x0008(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_H9ZU[0x3C];                                    // 0x000C(0x003C) MISSED OFFSET (PADDING)
...
{
	struct FPolygonGroupID                             PolygonGroupID;                                            // 0x0000(0x0004) (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_MD4E[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
