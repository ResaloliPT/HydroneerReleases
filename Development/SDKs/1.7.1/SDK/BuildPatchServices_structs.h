...
struct FFileManifestData
{
	...
	unsigned char                                      UnknownData_XHT9[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_U5E3[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8ULM[0x6];                                     // 0x0062(0x0006) MISSED OFFSET (PADDING)
...
struct FChunkInfoData
{
	...
	unsigned char                                      UnknownData_OTDI[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UX7V[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
