...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_ProjectilePower.BP_ProjectilePower_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_ProjectilePower(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
