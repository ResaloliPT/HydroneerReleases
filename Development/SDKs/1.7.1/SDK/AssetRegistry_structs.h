...
struct FAssetData
{
	...
	unsigned char                                      UnknownData_6HA3[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (PADDING)
...
struct FARFilter
{
	...
	unsigned char                                      UnknownData_FUOR[0x50];                                    // 0x0040(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L4K5[0x5];                                     // 0x00E3(0x0005) MISSED OFFSET (PADDING)
