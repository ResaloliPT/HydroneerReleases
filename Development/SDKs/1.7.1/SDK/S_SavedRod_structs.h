...
struct FS_SavedRod
{
	...
	unsigned char                                      UnknownData_XB8D[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TEnumAsByte<E_Rod_E_Rod>                           Type_12_3F9519AB4066DE0A2FB03DB1DC8B92D0;                  // 0x0040(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
