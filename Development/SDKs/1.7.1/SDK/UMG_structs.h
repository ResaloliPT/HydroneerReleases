...
struct FEventReply
{
	unsigned char                                      UnknownData_VH3J[0xB8];                                    // 0x0000(0x00B8) MISSED OFFSET (PADDING)
...
struct FSlateChildSize
{
	...
	unsigned char                                      UnknownData_MBUX[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FWidgetNavigationData
{
	...
	unsigned char                                      UnknownData_HJ9F[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimationEventBinding
{
	...
	unsigned char                                      UnknownData_QYTJ[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XLJY[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3I0I[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
struct FWidgetAnimationBinding
{
	...
	unsigned char                                      UnknownData_DLUT[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (PADDING)
...
struct FBlueprintWidgetAnimationDelegateBinding
{
	...
	unsigned char                                      UnknownData_I90B[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDelegateRuntimeBinding
{
	...
	unsigned char                                      UnknownData_MY4O[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieScene2DTransformSectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_V6N0[0x3];                                     // 0x04A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneMarginSectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_BOLJ[0x7];                                     // 0x02C9(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_PYIP[0x10];                                    // 0x00A8(0x0010) MISSED OFFSET (PADDING)
