...
struct FPaperFlipbookKeyFrame
{
	...
	unsigned char                                      UnknownData_7RGU[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FPaperSpriteSocket
{
	...
	unsigned char                                      UnknownData_13J7[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
...
struct FPaperTerrainMaterialRule
{
	...
	unsigned char                                      UnknownData_8TG4[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FOTN[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FPaperTileInfo
{
	...
	unsigned char                                      UnknownData_PWDN[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FPaperTileSetTerrain
{
	...
	unsigned char                                      UnknownData_XD0G[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FSpriteGeometryShape
{
	...
	unsigned char                                      UnknownData_B6JV[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NF7E[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (PADDING)
...
struct FSpriteGeometryCollection
{
	...
	unsigned char                                      UnknownData_G1MH[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UHP7[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XO8I[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FPaperTileMetadata
{
	...
	unsigned char                                      UnknownData_AI62[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
struct FPaperSpriteAtlasSlot
{
	...
	unsigned char                                      UnknownData_1SV1[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
struct FSpriteDrawCallRecord
{
	...
	unsigned char                                      UnknownData_6NJE[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DFUU[0x30];                                    // 0x0018(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FNX2[0x84];                                    // 0x004C(0x0084) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_T3T8[0x40];                                    // 0x0000(0x0040) MISSED OFFSET (PADDING)
