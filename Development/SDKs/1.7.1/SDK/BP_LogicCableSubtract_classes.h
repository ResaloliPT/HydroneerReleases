...
// BlueprintGeneratedClass BP_LogicCableSubtract.BP_LogicCableSubtract_C
// 0x0010 (FullSize[0x05C0] - InheritedSize[0x05B0])
class ABP_LogicCableSubtract_C : public ABP_ParentDualLogic_C
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_LogicCableSubtract.BP_LogicCableSubtract_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_LogicCableSubtract(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
