...
// BlueprintGeneratedClass BP_LogicCableCompare.BP_LogicCableCompare_C
// 0x0010 (FullSize[0x05C0] - InheritedSize[0x05B0])
class ABP_LogicCableCompare_C : public ABP_ParentDualLogic_C
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_LogicCableCompare.BP_LogicCableCompare_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_LogicCableCompare(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
