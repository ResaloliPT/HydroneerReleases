...
void UNativeUserListEntry::AfterRead()
{
	UInterface::AfterRead();

}

void UNativeUserListEntry::BeforeDelete()
{
...
{
	UNativeUserListEntry::AfterRead();

}

void UUserListEntry::BeforeDelete()
{
	UNativeUserListEntry::BeforeDelete();
...
void UWidgetBlueprintGeneratedClass::AfterRead()
{
	...
	READ_PTR_FULL(WidgetTree, UWidgetTree);
	READ_PTR_FULL(Template, UUserWidget);
}
