...
struct FGameplayTagQuery
{
	...
	unsigned char                                      UnknownData_SYT6[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayTagSource
{
	...
	unsigned char                                      UnknownData_FXVK[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRestrictedGameplayTagTableRow : public FGameplayTagTableRow
{
	...
	unsigned char                                      UnknownData_U7OR[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_C6UC[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6ONT[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_1O72[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
