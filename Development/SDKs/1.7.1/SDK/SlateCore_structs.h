...
struct FGeometry
{
	unsigned char                                      UnknownData_KM9K[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (PADDING)
...
struct FSlateColor
{
	...
	unsigned char                                      UnknownData_DUMZ[0x17];                                    // 0x0011(0x0017) MISSED OFFSET (PADDING)
...
struct FSlateBrush
{
	unsigned char                                      UnknownData_9GK6[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_63OT[0x10];                                    // 0x0070(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FS33[0x7];                                     // 0x0081(0x0007) MISSED OFFSET (PADDING)
...
struct FInputEvent
{
	unsigned char                                      UnknownData_9IYK[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_BORJ[0x58];                                    // 0x0018(0x0058) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_41XS[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_CXF2[0x20];                                    // 0x0018(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_RNQ6[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_IYNH[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_UXBZ[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FFontOutlineSettings
{
	...
	unsigned char                                      UnknownData_2PGA[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSlateFontInfo
{
	...
	unsigned char                                      UnknownData_6AM1[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TFKA[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
struct FSlateSound
{
	...
	unsigned char                                      UnknownData_T13J[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FFontData
{
	...
	unsigned char                                      UnknownData_C7VL[0x2];                                     // 0x0012(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCompositeFallbackFont
{
	...
	unsigned char                                      UnknownData_5QSW[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_HRM4[0x30];                                    // 0x0018(0x0030) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_P597[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FFocusEvent
{
	unsigned char                                      UnknownData_MFH3[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FDockTabStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_L03F[0x4];                                     // 0x06D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInlineTextImageStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_4FYA[0x6];                                     // 0x0092(0x0006) MISSED OFFSET (PADDING)
...
struct FSliderStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_V7NL[0x4];                                     // 0x033C(0x0004) MISSED OFFSET (PADDING)
...
struct FSearchBoxStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_8UZV[0x7];                                     // 0x0A79(0x0007) MISSED OFFSET (PADDING)
...
struct FExpandableAreaStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_T9FE[0x4];                                     // 0x011C(0x0004) MISSED OFFSET (PADDING)
...
struct FCheckBoxStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_FPRV[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
