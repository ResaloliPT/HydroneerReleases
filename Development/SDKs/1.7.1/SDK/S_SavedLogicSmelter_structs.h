...
struct FS_SavedLogicSmelter
{
	...
	unsigned char                                      UnknownData_WDU3[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TEnumAsByte<E_MoltenType_E_MoltenType>             MoltenType_17_244DA78240304FC6DA16C99F7DFCF7C2;            // 0x0042(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_DFQD[0x1];                                     // 0x0043(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FString                                     Logic_23_23FEA9BC4D493315D9BCC3A14FC84351;                 // 0x0048(0x0010) (Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash)
