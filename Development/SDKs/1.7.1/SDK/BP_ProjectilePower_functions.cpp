...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_ProjectilePower.BP_ProjectilePower_C.BndEvt__StaticMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_ProjectilePower.BP_ProjectilePower_C.ReceiveBeginPlay");
...
void ABP_ProjectilePower_C::ExecuteUbergraph_BP_ProjectilePower(int EntryPoint)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_ProjectilePower.BP_ProjectilePower_C.ExecuteUbergraph_BP_ProjectilePower");
...
void ABP_ProjectilePower_C::AfterRead()
{
	AActor::AfterRead();
...
void ABP_ProjectilePower_C::BeforeDelete()
{
	AActor::BeforeDelete();
