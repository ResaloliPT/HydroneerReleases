...
struct FChannelDefinition
{
	...
	unsigned char                                      UnknownData_DQRZ[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_E6QO[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TURK[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VTD5[0x33];                                    // 0x000D(0x0033) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AXM0[0xC];                                     // 0x0044(0x000C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_JLKJ[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
struct FRepAttachment
{
	...
	unsigned char                                      UnknownData_DG13[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHitResult
{
	...
	unsigned char                                      UnknownData_5J3U[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_16TV[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
struct FBasedMovementInfo
{
	...
	unsigned char                                      UnknownData_XN3N[0x5];                                     // 0x002B(0x0005) MISSED OFFSET (PADDING)
...
struct FInterpolationParameter
{
	...
	unsigned char                                      UnknownData_CXIL[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FBoneReference
{
	...
	unsigned char                                      UnknownData_QUIS[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FBlendParameter
{
	...
	unsigned char                                      UnknownData_T0C7[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FCurveEdEntry
{
	...
	unsigned char                                      UnknownData_RYQF[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInterpControlPoint
{
	...
	unsigned char                                      UnknownData_THCR[0xF];                                     // 0x000D(0x000F) MISSED OFFSET (PADDING)
...
struct FAnimControlTrackKey
{
	...
	unsigned char                                      UnknownData_PFJ2[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3C0B[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FBoolTrackKey
{
	...
	unsigned char                                      UnknownData_3HOX[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5279[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_PN82[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_B35I[0xB0];                                    // 0x0000(0x00B0) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YLKT[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FPoseLinkBase
{
	...
	unsigned char                                      UnknownData_903K[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (PADDING)
...
struct FAnimNotifyTrack
{
	...
	unsigned char                                      UnknownData_ZQHV[0x20];                                    // 0x0018(0x0020) MISSED OFFSET (PADDING)
...
struct FResponseChannel
{
	...
	unsigned char                                      UnknownData_NXGT[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FWalkableSlopeOverride
{
	...
	unsigned char                                      UnknownData_3GCY[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1MCC[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Q265[0x6];                                     // 0x0000(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_X6QQ[0x1];                                     // 0x0007(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VI74[0x1];                                     // 0x0009(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IOEO : 1;                                      // 0x000C(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_96IV : 2;                                      // 0x000E(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_L0RL[0xD];                                     // 0x000F(0x000D) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KAM8[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R6WY[0x8];                                     // 0x0060(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JT9B[0x10];                                    // 0x0098(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OWZJ[0x70];                                    // 0x00D8(0x0070) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_J0VE[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
struct FLightmassPrimitiveSettings
{
	...
	unsigned char                                      UnknownData_8W8V[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_NGLF[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_O7ZU[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9U0I[0x18];                                    // 0x0010(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CJQU[0x60];                                    // 0x0030(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_CJWU[0xE8];                                    // 0x0000(0x00E8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_REE7[0x2];                                     // 0x00EA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDistributionLookupTable
{
	...
	unsigned char                                      UnknownData_I59K[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2G85[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FEmitterDynamicParameter
{
	...
	unsigned char                                      UnknownData_VO8W[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C8IX[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ROP7[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAssetEditorOrbitCameraPosition
{
	...
	unsigned char                                      UnknownData_2GHC[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMeshSectionInfo
{
	...
	unsigned char                                      UnknownData_31EX[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (PADDING)
...
struct FRootMotionMovementParams
{
	...
	unsigned char                                      UnknownData_5M5C[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Z5BX[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRepRootMotionMontage
{
	...
	unsigned char                                      UnknownData_Q5J2[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WYYJ[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6V27[0x6];                                     // 0x0042(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	float                                              Time;                                                      // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_4KLZ[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMaterialParameterInfo
{
	...
	unsigned char                                      UnknownData_5JLU[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBakedStateExitTransition
{
	...
	unsigned char                                      UnknownData_9BNI[0x2];                                     // 0x000E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBakedAnimationState
{
	...
	unsigned char                                      UnknownData_QENN[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZNZM[0x7];                                     // 0x0041(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimationTransitionBetweenStates : public FAnimationStateBase
{
	...
	unsigned char                                      UnknownData_I8HA[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IGSK[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
struct FBakedAnimationStateMachine
{
	...
	unsigned char                                      UnknownData_AUSJ[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMarkerSyncData
{
	...
	unsigned char                                      UnknownData_O9GL[0x10];                                    // 0x0010(0x0010) MISSED OFFSET (PADDING)
...
struct FPSCPoolElem
{
	...
	unsigned char                                      UnknownData_90MK[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FPSCPool
{
	...
	unsigned char                                      UnknownData_A1HK[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)
...
struct FWorldPSCPool
{
	...
	unsigned char                                      UnknownData_PW19[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
struct FBeamModifierOptions
{
	...
	unsigned char                                      UnknownData_Q2DT[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FWeightedBlendable
{
	...
	unsigned char                                      UnknownData_ORZX[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPostProcessSettings
{
	...
	unsigned char                                      UnknownData_0ZFK[0x2];                                     // 0x000E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1A2Z[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_46BD[0x1];                                     // 0x001B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5SG7[0x2];                                     // 0x001E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GAAP[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_74AO[0x3];                                     // 0x03F9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZML2[0x3];                                     // 0x0439(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UBR4[0x3];                                     // 0x04D9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y9KO[0x2];                                     // 0x04F6(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IQDO[0x2];                                     // 0x0506(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CFA0[0x4];                                     // 0x051C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMinimalViewInfo
{
	...
	unsigned char                                      UnknownData_Y1VP[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y9F3[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OGP6[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I1Y0[0x8];                                     // 0x0578(0x0008) MISSED OFFSET (PADDING)
...
struct FCameraCacheEntry
{
	...
	unsigned char                                      UnknownData_TBUG[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_6SEC[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSoundClassAdjuster
{
	...
	unsigned char                                      UnknownData_X473[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_47PM[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
struct FActiveForceFeedbackEffect
{
	...
	unsigned char                                      UnknownData_TIK0[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FViewTargetTransitionParams
{
	...
	unsigned char                                      UnknownData_KFV1[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Z0T1[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FUpdateLevelVisibilityLevelInfo
{
	...
	unsigned char                                      UnknownData_NEI0[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FUpdateLevelStreamingLevelStatus
{
	...
	unsigned char                                      UnknownData_451G[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FForceFeedbackParameters
{
	...
	unsigned char                                      UnknownData_XKJZ[0x1];                                     // 0x000B(0x0001) MISSED OFFSET (PADDING)
...
struct FFontParameterValue
{
	...
	unsigned char                                      UnknownData_LO4R[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FSoundTrackKey
{
	...
	unsigned char                                      UnknownData_8RI2[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FToggleTrackKey
{
	...
	unsigned char                                      UnknownData_05K6[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FVisibilityTrackKey
{
	...
	unsigned char                                      UnknownData_2FII[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_47OP[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_UGIR[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FDrawToRenderTargetContext
{
	...
	unsigned char                                      UnknownData_M3IY[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FPaintedVertex
{
	...
	unsigned char                                      UnknownData_16SQ[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1XA7[0xC];                                     // 0x0024(0x000C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YLXE[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FPaintedVertex>                      PaintedVertices;                                           // 0x0020(0x0010) (ZeroConstructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_EGV7[0x78];                                    // 0x0030(0x0078) MISSED OFFSET (PADDING)
...
struct FBlueprintComponentChangedPropertyInfo
{
	...
	unsigned char                                      UnknownData_OOI6[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBlueprintCookedComponentInstancingData
{
	...
	unsigned char                                      UnknownData_7GCD[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3K6A[0x38];                                    // 0x0018(0x0038) MISSED OFFSET (PADDING)
...
struct FNavAgentSelector
{
	...
	unsigned char                                      UnknownData_8A2W[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (PADDING)
...
struct FNavigationLinkBase
{
	...
	unsigned char                                      UnknownData_OKXL[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TVX8[0x2];                                     // 0x001E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CKHU[0x6];                                     // 0x0022(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4KN3[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_T7J5[0x17];                                    // 0x0001(0x0017) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSplinePoint
{
	...
	unsigned char                                      UnknownData_Z1OI[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (PADDING)
...
struct FSkelMeshComponentLODInfo
{
	...
	unsigned char                                      UnknownData_HWL7[0x10];                                    // 0x0010(0x0010) MISSED OFFSET (PADDING)
...
struct FSingleAnimationPlayData
{
	...
	unsigned char                                      UnknownData_Y4PK[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6OEX[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FPoseSnapshot
{
	...
	unsigned char                                      UnknownData_55H7[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5H8G[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_RM2W[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VVI5[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNotifyEvent : public FAnimLinkableElement
{
	...
	unsigned char                                      UnknownData_GRAB[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1864[0x2];                                     // 0x0092(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DHVA[0x3];                                     // 0x0099(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5HDY[0x2];                                     // 0x00A2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                TrackIndex;                                                // 0x00A4(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_CQVS[0x10];                                    // 0x00A8(0x0010) MISSED OFFSET (PADDING)
...
struct FAudioComponentParam
{
	...
	unsigned char                                      UnknownData_RASX[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4C3O[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_WF3E[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
struct FLightmassMaterialInterfaceSettings
{
	...
	unsigned char                                      UnknownData_GS73[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RHKC[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FStaticTerrainLayerWeightParameter
{
	...
	unsigned char                                      UnknownData_SUU4[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FGuid                                       ExpressionGUID;                                            // 0x0014(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_1W23[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (PADDING)
...
struct FStaticMaterialLayersParameter
{
	...
	unsigned char                                      UnknownData_MT1I[0x3];                                     // 0x0051(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6M5D[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)
...
struct FCustomInput
{
	...
	unsigned char                                      UnknownData_P4DU[0x8];                                     // 0x0014(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_24E5[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_1GCA[0x690];                                   // 0x0000(0x0690) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_F7QR[0x150];                                   // 0x0690(0x0150) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_PR0W[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKShapeElem
{
	unsigned char                                      UnknownData_CYSZ[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YPR6[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HB0H[0x17];                                    // 0x0019(0x0017) MISSED OFFSET (PADDING)
...
struct FKBoxElem : public FKShapeElem
{
	...
	unsigned char                                      UnknownData_OMUR[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
struct FKConvexElem : public FKShapeElem
{
	...
	unsigned char                                      UnknownData_W2M8[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  Transform;                                                 // 0x0060(0x0030) (IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_QWGP[0x10];                                    // 0x0090(0x0010) MISSED OFFSET (PADDING)
...
struct FKTaperedCapsuleElem : public FKShapeElem
{
	...
	unsigned char                                      UnknownData_6NES[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
struct FKAggregateGeom
{
	...
	unsigned char                                      UnknownData_8SZ7[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
struct FCollisionResponseTemplate
{
	...
	unsigned char                                      UnknownData_UG8A[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I27M[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NCMU[0x27];                                    // 0x0039(0x0027) MISSED OFFSET (PADDING)
...
struct FCustomChannelSetup
{
	...
	unsigned char                                      UnknownData_1OSP[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W2S4[0x1];                                     // 0x000F(0x0001) MISSED OFFSET (PADDING)
...
struct FInputAxisProperties
{
	...
	unsigned char                                      UnknownData_PIYA[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_011Z[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRealCurve : public FIndexedCurve
{
	...
	unsigned char                                      UnknownData_LQ4A[0x2];                                     // 0x006A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSimpleCurve : public FRealCurve
{
	...
	unsigned char                                      UnknownData_8RAW[0x7];                                     // 0x0071(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_B55R[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_KU3S[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_61L8[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSplineInstanceData : public FSceneComponentInstanceData
{
	...
	unsigned char                                      UnknownData_ZL30[0x7];                                     // 0x00A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	float                                              Time;                                                      // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_VLVP[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_XTE1[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_1A7T[0xA0];                                    // 0x0000(0x00A0) MISSED OFFSET (PADDING)
...
struct FStreamingTexturePrimitiveInfo
{
	...
	unsigned char                                      UnknownData_2XPM[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FTimeStretchCurveInstance
{
	...
	unsigned char                                      UnknownData_J530[0x2F];                                    // 0x0001(0x002F) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_R7SU[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_RMN5[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
struct FLevelViewportInfo
{
	...
	unsigned char                                      UnknownData_FX69[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FLightmassWorldInfoSettings
{
	...
	unsigned char                                      UnknownData_Y2E5[0x2];                                     // 0x0026(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRichCurveKey
{
	...
	unsigned char                                      UnknownData_25VP[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_6LUA[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3ZGL[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0X4L[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSoundConcurrencySettings
{
	...
	unsigned char                                      UnknownData_LEON[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IO0R[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSoundSubmixSendInfo
{
	...
	unsigned char                                      UnknownData_4X0D[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	float                                              SendLevel;                                                 // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_AHM9[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSmartName
{
	...
	unsigned char                                      UnknownData_SKEO[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimSegment
{
	...
	unsigned char                                      UnknownData_SDCN[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FBlueprintInputDelegateBinding
{
	...
	unsigned char                                      UnknownData_3HIS[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FBlueprintInputActionDelegateBinding : public FBlueprintInputDelegateBinding
{
	...
	unsigned char                                      UnknownData_1T8R[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       FunctionNameToBind;                                        // 0x0010(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FSoundAttenuationSettings : public FBaseAttenuationSettings
{
	...
	unsigned char                                      UnknownData_UP86[0x2];                                     // 0x00B6(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHLODProxyMesh
{
	...
	unsigned char                                      UnknownData_UJ52[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStreamingLevelsToConsider
{
	...
	unsigned char                                      UnknownData_R0HO[0x18];                                    // 0x0010(0x0018) MISSED OFFSET (PADDING)
...
struct FNodeItem
{
	...
	unsigned char                                      UnknownData_7DLZ[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FParticleRandomSeedInfo
{
	...
	unsigned char                                      UnknownData_U8VO[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTimelineVectorTrack
{
	...
	unsigned char                                      UnknownData_EZEX[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (PADDING)
...
struct FTimelineFloatTrack
{
	...
	unsigned char                                      UnknownData_VEOU[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (PADDING)
...
struct FTimelineLinearColorTrack
{
	...
	unsigned char                                      UnknownData_W6G8[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (PADDING)
...
struct FTimeline
{
	...
	unsigned char                                      UnknownData_LX6D[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AILE[0x10];                                    // 0x0080(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTTTrackBase
{
	unsigned char                                      UnknownData_U8FK[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2TSD[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimationGroupReference
{
	...
	unsigned char                                      UnknownData_PRTM[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_85GR[0x70];                                    // 0x0000(0x0070) MISSED OFFSET (PADDING)
...
struct FAnimTickRecord
{
	...
	unsigned char                                      UnknownData_IJ3C[0x40];                                    // 0x0008(0x0040) MISSED OFFSET (PADDING)
...
struct FBlendFilter
{
	unsigned char                                      UnknownData_WBLZ[0x78];                                    // 0x0000(0x0078) MISSED OFFSET (PADDING)
...
struct FBlendSampleData
{
	...
	unsigned char                                      UnknownData_UT4Y[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EYOE[0x20];                                    // 0x0020(0x0020) MISSED OFFSET (PADDING)
...
struct FAnimationRecordingSettings
{
	...
	unsigned char                                      UnknownData_4M9H[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NUE8[0x2];                                     // 0x000E(0x0002) MISSED OFFSET (PADDING)
...
struct FNamedTransform
{
	...
	unsigned char                                      UnknownData_Z5TP[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_XTRP[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_53EN[0x1E0];                                   // 0x00A8(0x01E0) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3WM1[0x3C];                                    // 0x0000(0x003C) MISSED OFFSET (PADDING)
...
struct FEditedDocumentInfo
{
	...
	unsigned char                                      UnknownData_V17Z[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEdGraphTerminalType
{
	...
	unsigned char                                      UnknownData_FHOD[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (PADDING)
...
struct FEdGraphPinType
{
	...
	unsigned char                                      UnknownData_3C08[0x2];                                     // 0x0056(0x0002) MISSED OFFSET (PADDING)
...
struct FBPVariableDescription
{
	...
	unsigned char                                      UnknownData_JVE5[0x7];                                     // 0x00A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_M8J0[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FCompilerNativizationOptions
{
	...
	unsigned char                                      UnknownData_TN5A[0x5];                                     // 0x000B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEventGraphFastCallPair
{
	...
	unsigned char                                      UnknownData_5C0U[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3DJI[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_MY9M[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3CXU[0x190];                                   // 0x0000(0x0190) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6UUZ[0x14];                                    // 0x0000(0x0014) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_CBYE[0x2];                                     // 0x0000(0x0002) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_LMIY[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_K16S[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FCachedAnimTransitionData
{
	...
	unsigned char                                      UnknownData_8DS1[0xC];                                     // 0x0018(0x000C) MISSED OFFSET (PADDING)
...
struct FCachedAnimRelevancyData
{
	...
	unsigned char                                      UnknownData_527S[0xC];                                     // 0x0010(0x000C) MISSED OFFSET (PADDING)
...
struct FCachedAnimAssetPlayerData
{
	struct FName                                       StateMachineName;                                          // 0x0000(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FName                                       StateName;                                                 // 0x0008(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_RZNU[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
struct FCachedAnimStateData
{
	struct FName                                       StateMachineName;                                          // 0x0000(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FName                                       StateName;                                                 // 0x0008(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_V2CJ[0xC];                                     // 0x0010(0x000C) MISSED OFFSET (PADDING)
...
struct FCachedAnimStateArray
{
	...
	unsigned char                                      UnknownData_LY39[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2G83[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FDamageEvent
{
	unsigned char                                      UnknownData_PKV5[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMeshBuildSettings
{
	...
	unsigned char                                      UnknownData_KNE7[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J7XH[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_U93S[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TCG5[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I0ZP[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FOverlapResult
{
	...
	unsigned char                                      UnknownData_F8N3[0x4];                                     // 0x0010(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      bBlockingHit : 1;                                          // 0x0014(0x0001) BIT_FIELD (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_127T[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FSwarmDebugOptions
{
	...
	unsigned char                                      UnknownData_HFKY[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FLightmassDebugOptions
{
	...
	unsigned char                                      UnknownData_AJBZ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UJWK[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRigidBodyContactInfo
{
	...
	unsigned char                                      UnknownData_YPK2[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRigidBodyState
{
	...
	unsigned char                                      UnknownData_1BMQ[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JW7Y[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
struct FActiveHapticFeedbackEffect
{
	...
	unsigned char                                      UnknownData_VGZL[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_46E1[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_90F7[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStaticComponentMaskParameter
{
	...
	unsigned char                                      UnknownData_3RQO[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FGuid                                       ExpressionGUID;                                            // 0x0018(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FUserActivity
{
	...
	unsigned char                                      UnknownData_TUVT[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
struct FDebugFloatHistory
{
	...
	unsigned char                                      UnknownData_7UYU[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FFormatArgumentData
{
	...
	unsigned char                                      UnknownData_NCGM[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_15TU[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
struct FLayerActorStats
{
	...
	unsigned char                                      UnknownData_92OF[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FParticleEvent_GenerateInfo
{
	...
	unsigned char                                      UnknownData_B74H[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2HLX[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSkeletalMeshSamplingRegionBoneFilter
{
	...
	unsigned char                                      UnknownData_AXUF[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FSkeletalMeshSamplingRegion
{
	...
	unsigned char                                      UnknownData_2UYT[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPrecomputedSkyLightInstanceData : public FSceneComponentInstanceData
{
	...
	unsigned char                                      UnknownData_KCUL[0xA4];                                    // 0x00BC(0x00A4) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2V1B[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8KGN[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_V5V8[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_S5Y8[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_CPMV[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
struct FMaterialRemapIndex
{
	...
	unsigned char                                      UnknownData_GDZ4[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFindFloorResult
{
	...
	unsigned char                                      UnknownData_SJUJ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStaticSwitchParameter
{
	...
	unsigned char                                      UnknownData_DOIL[0x2];                                     // 0x0012(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FGuid                                       ExpressionGUID;                                            // 0x0014(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FExposedValueCopyRecord
{
	...
	unsigned char                                      UnknownData_GDLS[0x1];                                     // 0x0017(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FExposedValueHandler
{
	...
	unsigned char                                      UnknownData_B0R5[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_DORW[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSoundWaveSpectralTimeData
{
	...
	unsigned char                                      UnknownData_G9P4[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FSubtitleCue
{
	...
	unsigned char                                      UnknownData_78BO[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FInstancedStaticMeshComponentInstanceData : public FSceneComponentInstanceData
{
	...
	unsigned char                                      UnknownData_AKFR[0x20];                                    // 0x0100(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9D9O[0xC];                                     // 0x0124(0x000C) MISSED OFFSET (PADDING)
...
struct FIntegralCurve : public FIndexedCurve
{
	...
	unsigned char                                      UnknownData_YFSJ[0x3];                                     // 0x007D(0x0003) MISSED OFFSET (PADDING)
...
struct FSubTrackGroup
{
	...
	unsigned char                                      UnknownData_BQL8[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FSupportedSubTrackInfo
{
	...
	unsigned char                                      UnknownData_DO10[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_XUC0[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
struct FLevelSimplificationDetails
{
	...
	unsigned char                                      UnknownData_PRKU[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IVC4[0x3];                                     // 0x0079(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TZYK[0x2];                                     // 0x00FA(0x0002) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_EFKU[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
struct FDynamicTextureInstance : public FStreamableTextureInstance
{
	...
	unsigned char                                      UnknownData_P5EW[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_SCP2[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L8UG[0xC];                                     // 0x00F4(0x000C) MISSED OFFSET (PADDING)
...
struct FBatchedPoint
{
	...
	unsigned char                                      UnknownData_O8YP[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
struct FBatchedLine
{
	...
	unsigned char                                      UnknownData_IPBS[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (PADDING)
...
struct FClientReceiveData
{
	...
	unsigned char                                      UnknownData_2OGC[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FParameterGroupData
{
	...
	unsigned char                                      UnknownData_CYZM[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FClothingAssetData_Legacy
{
	...
	unsigned char                                      UnknownData_JVIM[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FClothPhysicsProperties_Legacy              PhysicsProperties;                                         // 0x001C(0x0050) (NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_487R[0xC];                                     // 0x006C(0x000C) MISSED OFFSET (PADDING)
...
struct FSkeletalMeshClothBuildParams
{
	...
	unsigned char                                      UnknownData_ENC6[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I1UU[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBoneMirrorExport
{
	...
	unsigned char                                      UnknownData_AN1Y[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2SOE[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_XAG1[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
struct FAlphaBlend
{
	...
	unsigned char                                      UnknownData_4QVU[0x18];                                    // 0x000C(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JEKF[0xB];                                     // 0x0025(0x000B) MISSED OFFSET (PADDING)
...
struct FCompositeSection : public FAnimLinkableElement
{
	...
	unsigned char                                      UnknownData_4AKB[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBranchingPointMarker
{
	...
	unsigned char                                      UnknownData_QUIT[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FTimeStretchCurve
{
	...
	unsigned char                                      UnknownData_E4CL[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FClassRedirect
{
	...
	unsigned char                                      UnknownData_CGJG[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (PADDING)
...
struct FDebugDisplayProperty
{
	...
	unsigned char                                      UnknownData_6BEJ[0x10];                                    // 0x0010(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_A479[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FDebugTextInfo
{
	...
	unsigned char                                      UnknownData_0L0K[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MWPX[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LSGV[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (PADDING)
...
struct FTextureLODGroup
{
	...
	unsigned char                                      UnknownData_UL2O[0xB];                                     // 0x0001(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MAYA[0x4];                                     // 0x0018(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PGY3[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BYWA[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FImportanceTexture
{
	...
	unsigned char                                      UnknownData_UYOJ[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0ST2[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
struct FInputActionKeyMapping
{
	...
	unsigned char                                      UnknownData_KN24[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGPUSpriteLocalVectorFieldInfo
{
	...
	unsigned char                                      UnknownData_00J2[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  Transform;                                                 // 0x0010(0x0030) (IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_WQJW[0x3];                                     // 0x006D(0x0003) MISSED OFFSET (PADDING)
...
struct FGPUSpriteEmitterInfo
{
	...
	unsigned char                                      UnknownData_BWH8[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HJ9F[0x2];                                     // 0x018A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      bEnableCollision : 1;                                      // 0x018C(0x0001) BIT_FIELD (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_YNB6[0x3];                                     // 0x018D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LZM7[0x3];                                     // 0x0191(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      bRemoveHMDRoll : 1;                                        // 0x0194(0x0001) BIT_FIELD (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_2GKT[0x3];                                     // 0x0195(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IF0R[0x10];                                    // 0x02B0(0x0010) MISSED OFFSET (PADDING)
...
struct FGPUSpriteResourceData
{
	...
	unsigned char                                      UnknownData_I8OB[0x2];                                     // 0x0146(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2QBE[0x3];                                     // 0x0151(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OPJU[0x4];                                     // 0x015C(0x0004) MISSED OFFSET (PADDING)
...
struct FConstraintBaseParams
{
	...
	unsigned char                                      UnknownData_00CT[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FLinearConstraint : public FConstraintBaseParams
{
	...
	unsigned char                                      UnknownData_XTK0[0x1];                                     // 0x001B(0x0001) MISSED OFFSET (PADDING)
...
struct FConeConstraint : public FConstraintBaseParams
{
	...
	unsigned char                                      UnknownData_8Y2F[0x2];                                     // 0x001E(0x0002) MISSED OFFSET (PADDING)
...
struct FTwistConstraint : public FConstraintBaseParams
{
	...
	unsigned char                                      UnknownData_A1CE[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (PADDING)
...
struct FConstraintDrive
{
	...
	unsigned char                                      UnknownData_2TMF[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FLinearDriveConstraint
{
	...
	unsigned char                                      UnknownData_AH1V[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (PADDING)
...
struct FAngularDriveConstraint
{
	...
	unsigned char                                      UnknownData_RCJM[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (PADDING)
...
struct FConstraintProfileProperties
{
	...
	unsigned char                                      UnknownData_S087[0x3];                                     // 0x0101(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_VXBK[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7UI2[0x7];                                     // 0x0085(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FConstraintProfileProperties                ProfileInstance;                                           // 0x008C(0x0104) (Edit, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_8NF2[0x28];                                    // 0x0190(0x0028) MISSED OFFSET (PADDING)
...
struct FBoneFilter
{
	...
	unsigned char                                      UnknownData_LCND[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSkeletalMeshOptimizationSettings
{
	...
	unsigned char                                      UnknownData_FDBZ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3P89[0x2];                                     // 0x001E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VYZR[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3BHC[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSkeletalMeshLODGroupSettings
{
	...
	unsigned char                                      UnknownData_GGB6[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OZBD[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JFFZ[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (PADDING)
...
struct FMeshUVChannelInfo
{
	...
	unsigned char                                      UnknownData_IHLT[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStaticMaterial
{
	...
	unsigned char                                      UnknownData_VZNN[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FPrimaryAssetRules
{
	...
	unsigned char                                      UnknownData_H6IH[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P169[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FPrimaryAssetTypeInfo
{
	...
	unsigned char                                      UnknownData_CM37[0x6];                                     // 0x003A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QHSA[0x3];                                     // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEditorImportExportTestDefinition
{
	...
	unsigned char                                      UnknownData_IMC2[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_ADD7[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInputAlphaBoolBlend
{
	...
	unsigned char                                      UnknownData_J96Q[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_AssetPlayerBase : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_ZA48[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7OE5[0x10];                                    // 0x0020(0x0010) MISSED OFFSET (PADDING)
...
{
	struct FName                                       Name;                                                      // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_4V5H[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
struct FSlotEvaluationPose
{
	...
	unsigned char                                      UnknownData_IE7M[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              Weight;                                                    // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_6W40[0x38];                                    // 0x0008(0x0038) MISSED OFFSET (PADDING)
...
struct FChildActorComponentInstanceData : public FSceneComponentInstanceData
{
	...
	unsigned char                                      UnknownData_OWIR[0x10];                                    // 0x00C0(0x0010) MISSED OFFSET (PADDING)
...
struct FAutoCompleteNode
{
	...
	unsigned char                                      UnknownData_5U8U[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<int>                                        AutoCompleteListIndices;                                   // 0x0008(0x0010) (ZeroConstructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_1QNZ[0x10];                                    // 0x0018(0x0010) MISSED OFFSET (PADDING)
...
struct FLevelNameAndTime
{
	...
	unsigned char                                      UnknownData_U5ZD[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_WCHM[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FScreenMessageString
{
	...
	unsigned char                                      UnknownData_YDST[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FFullyLoadedPackagesInfo
{
	...
	unsigned char                                      UnknownData_K8NW[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLevelStreamingStatus
{
	...
	unsigned char                                      UnknownData_77Z2[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNamedNetDriver
{
	...
	unsigned char                                      UnknownData_EYNJ[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FDepthFieldGlowInfo
{
	...
	unsigned char                                      UnknownData_HLW4[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFontRenderInfo
{
	...
	unsigned char                                      UnknownData_1VU6[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FComponentReference
{
	...
	unsigned char                                      UnknownData_SPSG[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
struct FLensImperfectionSettings
{
	...
	unsigned char                                      UnknownData_LTM0[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FConvolutionBloomSettings
{
	...
	unsigned char                                      UnknownData_PKPT[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FLensBloomSettings
{
	...
	unsigned char                                      UnknownData_22HA[0x4];                                     // 0x0084(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WGWA[0x7];                                     // 0x00B1(0x0007) MISSED OFFSET (PADDING)
...
struct FLensSettings
{
	...
	unsigned char                                      UnknownData_LV17[0x4];                                     // 0x00DC(0x0004) MISSED OFFSET (PADDING)
...
struct FColorGradingSettings
{
	...
	unsigned char                                      UnknownData_ZXAM[0x8];                                     // 0x0148(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_IYPK[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F6BG[0x4];                                     // 0x00E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStaticMeshVertexColorLODData
{
	...
	unsigned char                                      UnknownData_Z8VQ[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FStaticMeshComponentInstanceData : public FPrimitiveComponentInstanceData
{
	...
	unsigned char                                      UnknownData_1A44[0x8];                                     // 0x0128(0x0008) MISSED OFFSET (PADDING)
...
struct FOrbitOptions
{
	...
	unsigned char                                      UnknownData_YM6T[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FRigTransformConstraint
{
	...
	unsigned char                                      UnknownData_5A6R[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_JEKS[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
struct FRootMotionFinishVelocitySettings
{
	...
	unsigned char                                      UnknownData_9F4K[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_OKDP[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5NA9[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_S8FO[0xD];                                     // 0x0033(0x000D) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CUCT[0x4];                                     // 0x0094(0x0004) Fix Super Size
...
struct FRootMotionSource_JumpForce : public FRootMotionSource
{
	...
	unsigned char                                      UnknownData_KIQP[0x3];                                     // 0x00AD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NS42[0x10];                                    // 0x00C0(0x0010) MISSED OFFSET (PADDING)
...
struct FRootMotionSource_MoveToDynamicForce : public FRootMotionSource
{
	...
	unsigned char                                      UnknownData_AMUH[0x3];                                     // 0x00BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRootMotionSource_MoveToForce : public FRootMotionSource
{
	...
	unsigned char                                      UnknownData_1RL8[0x7];                                     // 0x00B1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMeshReductionSettings
{
	...
	unsigned char                                      UnknownData_A5PU[0x1];                                     // 0x0023(0x0001) MISSED OFFSET (PADDING)
...
struct FStaticMeshSourceModel
{
	...
	unsigned char                                      UnknownData_ATWZ[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStaticMeshOptimizationSettings
{
	...
	unsigned char                                      UnknownData_GNC7[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6QW1[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LHZ4[0x1];                                     // 0x001B(0x0001) MISSED OFFSET (PADDING)
...
struct FAudioQualitySettings
{
	...
	unsigned char                                      UnknownData_3C8R[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FReverbSettings
{
	...
	unsigned char                                      UnknownData_WJQK[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInteriorSettings
{
	...
	unsigned char                                      UnknownData_STMF[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEditorMapPerformanceTestDefinition
{
	...
	unsigned char                                      UnknownData_JBVC[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FBoneNode
{
	...
	unsigned char                                      UnknownData_USYW[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_LG91[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FPhysicalAnimationData
{
	...
	unsigned char                                      UnknownData_IA9A[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPhysicalSurfaceName
{
	...
	unsigned char                                      UnknownData_B8BE[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       Name;                                                      // 0x0004(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FBroadphaseSettings
{
	...
	unsigned char                                      UnknownData_NIUO[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEngineShowFlagsSetting
{
	...
	unsigned char                                      UnknownData_P0ZY[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FTViewTarget
{
	...
	unsigned char                                      UnknownData_XS8L[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6PEC[0x8];                                     // 0x0598(0x0008) MISSED OFFSET (PADDING)
...
struct FKeyBind
{
	...
	unsigned char                                      UnknownData_HNZY[0x6];                                     // 0x002A(0x0006) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_BJBY[0xB0];                                    // 0x0000(0x00B0) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_D22A[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ZBT4[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_MCAK[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_EWCI[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_X582[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRootMotionSource_RadialForce : public FRootMotionSource
{
	...
	unsigned char                                      UnknownData_124N[0x4];                                     // 0x00A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2T65[0x6];                                     // 0x00BA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YQ2H[0x3];                                     // 0x00D1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRootMotionSource_ConstantForce : public FRootMotionSource
{
	...
	unsigned char                                      UnknownData_1XND[0x4];                                     // 0x00A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCameraExposureSettings
{
	...
	unsigned char                                      UnknownData_HFI0[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZP76[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FFOscillator
{
	...
	unsigned char                                      UnknownData_XGSC[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (PADDING)
...
struct FTireFrictionScalePair
{
	...
	unsigned char                                      UnknownData_X0TD[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FMeshMergingSettings
{
	...
	unsigned char                                      UnknownData_03TP[0x1];                                     // 0x0087(0x0001) MISSED OFFSET (PADDING)
...
struct FHierarchicalSimplification
{
	...
	unsigned char                                      UnknownData_2OZ2[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FQueuedDrawDebugItem
{
	...
	unsigned char                                      UnknownData_68DY[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F5M0[0x3];                                     // 0x0045(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimMontageInstance
{
	...
	unsigned char                                      UnknownData_S631[0x20];                                    // 0x0008(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	bool                                               bPlaying;                                                  // 0x0028(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_V5J0[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0WCB[0xB8];                                    // 0x0030(0x00B8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q08J[0x10];                                    // 0x0108(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W1CC[0x20];                                    // 0x0160(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B2LQ[0x24];                                    // 0x0184(0x0024) MISSED OFFSET (PADDING)
...
struct FAnimNode_ApplyMeshSpaceAdditive : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_LLCQ[0x8];                                     // 0x0040(0x0008) MISSED OFFSET (PADDING)
...
struct FAnimNode_SaveCachedPose : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_KJWG[0x90];                                    // 0x0028(0x0090) MISSED OFFSET (PADDING)
...
struct FInputScaleBiasClamp
{
	...
	unsigned char                                      UnknownData_CRAJ[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DZPZ[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_SequencePlayer : public FAnimNode_AssetPlayerBase
{
	...
	unsigned char                                      UnknownData_QF0M[0x3];                                     // 0x0075(0x0003) MISSED OFFSET (PADDING)
...
struct FAnimNode_StateMachine : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_KG1A[0x96];                                    // 0x001A(0x0096) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_NDAR[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_MQFF[0xB8];                                    // 0x0000(0x00B8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_A3CN[0x8];                                     // 0x00C0(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3KY0[0x38];                                    // 0x0010(0x0038) MISSED OFFSET (PADDING)
...
struct FAnimNode_SubInstance : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_UNQK[0x20];                                    // 0x0078(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_22QQ[0x38];                                    // 0x0010(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_96UL[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AW9Q[0x6];                                     // 0x0052(0x0006) MISSED OFFSET (PADDING)
...
struct FAnimNode_TransitionResult : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_ABY7[0x17];                                    // 0x0011(0x0017) MISSED OFFSET (PADDING)
...
struct FAnimNode_SingleNode : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_HJMG[0x10];                                    // 0x0020(0x0010) MISSED OFFSET (PADDING)
...
struct FAnimationTransitionRule
{
	...
	unsigned char                                      UnknownData_Q917[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_UQX6[0xD0];                                    // 0x0000(0x00D0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_123E[0x10];                                    // 0x01B8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class ULevel*>                              LoadedLevelsForPendingMapChange;                           // 0x01C8(0x0010) (ZeroConstructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_PMYQ[0x18];                                    // 0x01D8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_90M0[0x40];                                    // 0x0230(0x0040) MISSED OFFSET (PADDING)
...
struct FExposureSettings
{
	...
	unsigned char                                      UnknownData_8VFL[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_DYH6[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FStatColorMapping
{
	...
	unsigned char                                      UnknownData_S3UQ[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FLightmassLightSettings
{
	...
	unsigned char                                      UnknownData_8UUG[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FBlueprintInputTouchDelegateBinding : public FBlueprintInputDelegateBinding
{
	...
	unsigned char                                      UnknownData_4DNS[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPrimitiveMaterialRef
{
	...
	unsigned char                                      UnknownData_KEOD[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FFontCharacter
{
	...
	unsigned char                                      UnknownData_DOEF[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFontImportOptionsData
{
	...
	unsigned char                                      UnknownData_PTDA[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZF6Q[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7SIH[0x3];                                     // 0x0061(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5AWC[0x3];                                     // 0x0075(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MT2N[0x3];                                     // 0x0099(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AC69[0x3];                                     // 0x00A1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YPFY[0x4];                                     // 0x00AC(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SMO8[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
struct FPlatformInterfaceData
{
	...
	unsigned char                                      UnknownData_8L36[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ILQU[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPlatformInterfaceDelegateResult
{
	...
	unsigned char                                      UnknownData_8L8S[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_C2G8[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
struct FForceFeedbackChannelDetails
{
	...
	unsigned char                                      UnknownData_AI9Z[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPredictProjectilePathParams
{
	...
	unsigned char                                      UnknownData_ETV9[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BOOM[0x2];                                     // 0x0026(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T87L[0x3];                                     // 0x0051(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4MZ8[0x7];                                     // 0x0059(0x0007) MISSED OFFSET (PADDING)
...
struct FPredictProjectilePathResult
{
	...
	unsigned char                                      UnknownData_11YI[0x4];                                     // 0x00B4(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2PHL[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNode
{
	...
	unsigned char                                      UnknownData_FSNZ[0xF];                                     // 0x0051(0x000F) MISSED OFFSET (PADDING)
...
struct FBoneMirrorInfo
{
	...
	unsigned char                                      UnknownData_L7KR[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FSkeletalMeshLODInfo
{
	...
	unsigned char                                      UnknownData_B73O[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KGUN[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3B4S[0x7];                                     // 0x00A1(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_0E60[0x48];                                    // 0x0000(0x0048) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_FYOT[0x78];                                    // 0x0000(0x0078) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9ZEX[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCachedKeyToActionInfo
{
	...
	unsigned char                                      UnknownData_LR4D[0x68];                                    // 0x0008(0x0068) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_BWZ5[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DRIQ[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GG6N[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_825B[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FParticleSysParam
{
	...
	unsigned char                                      UnknownData_ITOD[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WEXC[0x40];                                    // 0x0040(0x0040) MISSED OFFSET (PADDING)
...
struct FInputAxisKeyMapping
{
	...
	unsigned char                                      UnknownData_U17I[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FKey                                        Key;                                                       // 0x0010(0x0018) (Edit, BlueprintVisible, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FSkeletalMaterial
{
	...
	unsigned char                                      UnknownData_4L9R[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FSourceEffectChainEntry
{
	...
	unsigned char                                      UnknownData_29K4[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
struct FSoundGroup
{
	...
	unsigned char                                      UnknownData_YWX3[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XRPL[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FModulatorContinuousParams
{
	...
	unsigned char                                      UnknownData_4HHX[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FFunctionExpressionInput
{
	...
	unsigned char                                      UnknownData_1A48[0xC];                                     // 0x0024(0x000C) MISSED OFFSET (PADDING)
...
struct FMemberReference
{
	...
	unsigned char                                      UnknownData_QPHN[0x6];                                     // 0x0032(0x0006) MISSED OFFSET (PADDING)
...
struct FMeshInstancingSettings
{
	...
	unsigned char                                      UnknownData_CSJJ[0x1];                                     // 0x000F(0x0001) MISSED OFFSET (PADDING)
...
struct FMaterialSpriteElement
{
	...
	unsigned char                                      UnknownData_QHP2[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RBCG[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSoundClassProperties
{
	...
	unsigned char                                      UnknownData_S34Y[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WIX5[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (PADDING)
