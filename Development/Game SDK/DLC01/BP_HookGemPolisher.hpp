...
class ABP_HookGemPolisher_C : public ABP_ParentHook_C
{
    ...
    class UStaticMeshComponent* Drum2;                                                // 0x04C0 (size: 0x8)
    class UStaticMeshComponent* Drum1;                                                // 0x04C8 (size: 0x8)
    class USceneComponent* DrumRoot2;                                                 // 0x04D0 (size: 0x8)
    class USceneComponent* DrumRoot1;                                                 // 0x04D8 (size: 0x8)
    class UBoxComponent* PolishBox;                                                   // 0x04E0 (size: 0x8)
    float ShredderMaximumWeight;                                                      // 0x04E8 (size: 0x4)
