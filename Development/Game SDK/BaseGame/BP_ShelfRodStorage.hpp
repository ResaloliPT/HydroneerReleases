...
{
    class USC_ShelfLocation_C* SC_ShelfLocation7;                                     // 0x04E0 (size: 0x8)
    class USC_ShelfLocation_C* SC_ShelfLocation6;                                     // 0x04E8 (size: 0x8)
    class USC_ShelfLocation_C* SC_ShelfLocation5;                                     // 0x04F0 (size: 0x8)
