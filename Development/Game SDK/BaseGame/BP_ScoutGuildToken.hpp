#ifndef UE4SS_SDK_BP_ScoutGuildToken_HPP
#define UE4SS_SDK_BP_ScoutGuildToken_HPP

class ABP_ScoutGuildToken_C : public ABP_ParentCurrency_C
{
    ...
    void CombineCoins(class ABP_ScoutGuildToken_C* OtherCoins);
    void UserConstructionScript();
    void ReceiveBeginPlay();
    void CheckForCostumeChange();
    void RemoveCoins(int32 AmountToRemove);
    void PlayCoinSound();
    void RestackCoins(const TArray<class ABP_ScoutGuildToken_C*>& Coins);
    void OverrideLoaded();
    ...
    void ExecuteUbergraph_BP_ScoutGuildToken(int32 EntryPoint);
}; // Size: 0x47C
