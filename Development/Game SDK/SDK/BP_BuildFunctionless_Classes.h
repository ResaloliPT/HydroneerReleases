...
namespace CG
{
	 ...
	 * Size -> 0x0009 (FullSize[0x0411] - InheritedSize[0x0408])
	 */
	...
	public:
		...
		E_Functionless                                           ItemName;                                                // 0x0410(0x0001) Edit, BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash
	...
	public:
		...
		void ExecuteUbergraph_BP_BuildFunctionless(
int32_t EntryPoint
);
