...
namespace CG
{
	...
	public:
		...
		unsigned char                                            UnknownData_O9O2[0x3];                                   // 0x0015(0x0003) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_TYCW[0x3];                                   // 0x0015(0x0003) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_YWQE[0x3];                                   // 0x0015(0x0003) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_8NU1[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_IQKF[0x2];                                   // 0x0016(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_AGPQ[0x3];                                   // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_GEKF[0x2];                                   // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_1JFB[0x3];                                   // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_4307[0x2];                                   // 0x003E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_BNER[0x4];                                   // 0x004C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_9OOM[0x18];                                  // 0x0000(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_0D0L[0x1];                                   // 0x0000(0x0001) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_ECNE[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_1F4B[0x8];                                   // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_P0X6[0x2];                                   // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_VZDJ[0x14];                                  // 0x0044(0x0014) MISSED OFFSET (PADDING)
