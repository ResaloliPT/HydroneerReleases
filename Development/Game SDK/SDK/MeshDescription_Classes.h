...
namespace CG
{
	...
	public:
		...
		unsigned char                                            UnknownData_1EHW[0x368];                                 // 0x0028(0x0368) MISSED OFFSET (PADDING)
...
TArray<struct FPolygonID>* OutPolygonIDs
		...
		int32_t GetNumVertexVertexInstances(
const struct FVertexID& VertexID
);
...
const struct FVertexInstanceID& VertexInstanceID
		...
		int32_t GetNumVertexConnectedTriangles(
const struct FVertexID& VertexID
);
...
const struct FVertexID& VertexID
		...
		int32_t GetNumPolygonVertices(
const struct FPolygonID& PolygonID
);

		int32_t GetNumPolygonTriangles(
const struct FPolygonID& PolygonID
);

		int32_t GetNumPolygonInternalEdges(
const struct FPolygonID& PolygonID
);

		int32_t GetNumPolygonGroupPolygons(
const struct FPolygonGroupID& PolygonGroupID
);

		int32_t GetNumEdgeConnectedTriangles(
const struct FEdgeID& EdgeID
);

		int32_t GetNumEdgeConnectedPolygons(
const struct FEdgeID& EdgeID
);
...
TArray<struct FEdgeID>* NewEdgeIDs
		...
		struct FTriangleID CreateTriangle(
const struct FPolygonGroupID& PolygonGroupID
, 
TArray<struct FVertexInstanceID> VertexInstanceIDs
, 
...
const struct FPolygonGroupID& PolygonGroupID
		...
		struct FPolygonID CreatePolygon(
const struct FPolygonGroupID& PolygonGroupID
, 
TArray<struct FVertexInstanceID>* VertexInstanceIDs
, 
