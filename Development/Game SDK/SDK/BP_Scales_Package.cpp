...
namespace CG
{
	 ...
	 */
	void ABP_Scales_C::BndEvt__Sphere1_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature(
...
int32_t OtherBodyIndex
	 ...
	 */
	void ABP_Scales_C::BndEvt__Sphere1_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(
class UPrimitiveComponent* OverlappedComponent
, 
class AActor* OtherActor
, 
...
const struct FHitResult& SweepResult
	 ...
	 */
	void ABP_Scales_C::ExecuteUbergraph_BP_Scales(
int32_t EntryPoint
)
	{
		static UFunction* fn = nullptr;
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ABP_Scales_C.StaticClass
