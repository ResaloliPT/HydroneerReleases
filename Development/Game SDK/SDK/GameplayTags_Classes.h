...
const struct FGameplayTagContainer& Value
		...
		struct FGameplayTag MakeLiteralGameplayTag(
...
const struct FGameplayTagContainer& OtherContainer
		...
		class FName GetTagName(
const struct FGameplayTag& GameplayTag
);

		int32_t GetNumGameplayTagsInContainer(
const struct FGameplayTagContainer& TagContainer
);
...
const struct FGameplayTagContainer& TagContainer
		...
		class FString GetDebugStringFromGameplayTag(
const struct FGameplayTag& GameplayTag
);
...
struct FGameplayTagContainer* TagContainer
	...
	public:
		...
		unsigned char                                            UnknownData_X0IV[0x10];                                  // 0x0038(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_EMZB[0x98];                                  // 0x0028(0x0098) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)


		TArray<struct FGameplayTagSource>                        TagSources;                                              // 0x00C0(0x0010) ZeroConstructor, NativeAccessSpecifierPrivate


		unsigned char                                            UnknownData_JE9P[0xE0];                                  // 0x00D0(0x00E0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)


		TArray<class UDataTable*>                                GameplayTagTables;                                       // 0x01B0(0x0010) ZeroConstructor, NativeAccessSpecifierPrivate


		unsigned char                                            UnknownData_LUKB[0x50];                                  // 0x01C0(0x0050) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_5ZMF[0x5];                                   // 0x004B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
