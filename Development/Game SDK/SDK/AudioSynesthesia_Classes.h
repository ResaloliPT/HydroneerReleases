...
namespace CG
{
	...
	public:
		...
		unsigned char                                            UnknownData_RORW[0x3];                                   // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
TArray<float>* OutConstantQ
	...
	public:
		...
		unsigned char                                            UnknownData_CQV1[0x3];                                   // 0x0035(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_DADH[0x4];                                   // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
float* OutLoudness
	...
	public:
		...
		unsigned char                                            UnknownData_CSEE[0x3];                                   // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_6H8L[0x4];                                   // 0x003C(0x0004) MISSED OFFSET (PADDING)
