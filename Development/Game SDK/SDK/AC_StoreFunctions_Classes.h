...
namespace CG
{
	...
	public:
		...
		TArray<class ABP_ParentCurrency_C*>                      Currency;                                                // 0x00B0(0x0010) Edit, BlueprintVisible, DisableEditOnTemplate, DisableEditOnInstance
...
int32_t* Total
		...
		void CalculateCraftedPrice(
class ABP_ParentCraftedResource_C* CraftedItem
, 
int32_t* Price
);

		void CalculateFishPrice(
class ABP_CaughtFish_C* Fish
, 
int32_t* Cost
);

		void ReplaceCoinsWithNewValue(
int32_t NewValue
, 
