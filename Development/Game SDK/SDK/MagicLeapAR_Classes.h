...
TArray<struct FARTraceResult>* OutHitResults
	...
	public:
		...
		class ULuminARCandidateImage* AddLuminRuntimeCandidateImageEx(
...
EMagicLeapImageTargetOrientation InAxisOrientation
		...
		class ULuminARCandidateImage* AddLuminRuntimeCandidateImage(
class UARSessionConfig* SessionConfig
, 
class UTexture2D* CandidateTexture
, 
...
bool bImageIsStationary
	...
	public:
		...
		unsigned char                                            UnknownData_FY1W[0xA8];                                  // 0x0238(0x00A8) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_EPR2[0x3];                                   // 0x0179(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_GYKA[0x6];                                   // 0x019A(0x0006) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_TUVM[0x5];                                   // 0x005B(0x0005) MISSED OFFSET (PADDING)
