...
namespace CG
{
	...
	public:
		...
		unsigned char                                            UnknownData_KJHG[0x18];                                  // 0x0030(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_8CS2[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
...
int32_t AppID
	...
	public:
		...
		unsigned char                                            UnknownData_RNDS[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
...
int32_t AppID
		...
		class FString GetLaunchQueryParam(
const class FString& Key
);

		int32_t GetLaunchCommandLine(
class FString* CommandLine
);

		int32_t GetInstalledDepots(
int32_t AppID
, 
int32_t MaxDepots
, 
...
const class FString& Filename
		...
		int32_t GetEarliestPurchaseUnixTime(
int32_t AppID
);
...
bool bWasSuccessful
		...
		class USteamCoreAppsAsyncActionGetFileDetails* GetFileDetailsAsync(
...
float Timeout
	...
	public:
		...
		unsigned char                                            UnknownData_4QL1[0x4];                                   // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_J3JH[0x1E0];                                 // 0x0138(0x01E0) MISSED OFFSET (PADDING)
...
TArray<ESteamFriendFlags> Flags
		...
		class UTexture2D* GetSmallFriendAvatar(
const struct FSteamID& SteamIDFriend
);

		class FString GetPlayerNickname_Pure(
...
const struct FSteamID& SteamIDPlayer
		...
		class UTexture2D* GetMediumFriendAvatar(
const struct FSteamID& SteamIDFriend
);

		class UTexture2D* GetLargeFriendAvatar(
const struct FSteamID& SteamIDFriend
);

		int32_t GetFriendSteamLevel(
const struct FSteamID& SteamIDFriend
);

		class FString GetFriendsGroupName(
...
int32_t MembersCount
		...
		int32_t GetFriendsGroupMembersCount(
const struct FSteamFriendsGroupID& FriendsGroupID
);

		struct FSteamFriendsGroupID GetFriendsGroupIDByIndex(
int32_t FriendGroup
);

		int32_t GetFriendsGroupCount();

		int32_t GetFriendRichPresenceKeyCount(
const struct FSteamID& SteamIDFriend
);

		class FString GetFriendRichPresenceKeyByIndex(
const struct FSteamID& SteamIDFriend
, 
int32_t Key
);

		class FString GetFriendRichPresence(
const struct FSteamID& SteamIDFriend
, 
const class FString& Key
);

		ESteamFriendRelationship GetFriendRelationship(
const struct FSteamID& SteamIDFriend
);

		ESteamPersonaState GetFriendPersonaState(
const struct FSteamID& SteamIDFriend
);

		class FString GetFriendPersonaNameHistory(
const struct FSteamID& SteamIDFriend
, 
int32_t PersonaName
);

		class FString GetFriendPersonaName(
const struct FSteamID& SteamIDFriend
);

		int32_t GetFriendMessage(
const struct FSteamID& SteamIDFriend
, 
int32_t MessageID
, 
...
struct FSteamID* SteamIDLobby
		...
		struct FSteamID GetFriendFromSourceByIndex(
const struct FSteamID& SteamIDSource
, 
int32_t Ifriend
);

		int32_t GetFriendCountFromSource(
const struct FSteamID& SteamIDSource
);
...
TArray<ESteamFriendFlags> Flags
		...
		int32_t GetFriendCoplayTime(
const struct FSteamID& SteamIDFriend
);

		int32_t GetFriendCoplayGame(
const struct FSteamID& SteamIDFriend
);

		struct FSteamID GetFriendByIndex(
int32_t Ifriend
, 
TArray<ESteamFriendFlags> Flags
);
...
const struct FSteamID& SteamID
		...
		struct FSteamID GetCoplayFriend(
int32_t CoplayFriend
);

		class FString GetClanTag(
const struct FSteamID& SteamIDClan
);

		struct FSteamID GetClanOwner(
const struct FSteamID& SteamIDClan
);

		int32_t GetClanOfficerCount(
const struct FSteamID& SteamIDClan
);

		struct FSteamID GetClanOfficerByIndex(
const struct FSteamID& SteamIDClan
, 
int32_t Officer
);

		class FString GetClanName(
const struct FSteamID& SteamIDClan
);

		int32_t GetClanCount();

		int32_t GetClanChatMessage(
const struct FSteamID& SteamIDClanChat
, 
int32_t MessageID
, 
...
struct FSteamID* SteamIDChatter
		...
		int32_t GetClanChatMemberCount(
const struct FSteamID& SteamIDClan
);

		struct FSteamID GetClanByIndex(
int32_t Clan
);
...
int32_t* Chatting
		...
		struct FSteamID GetChatMemberByIndex(
const struct FSteamID& SteamIDClan
, 
int32_t User
);
...
const class FString& Dialog
	...
	public:
		...
		class USteamCoreFriendsAsyncActionSetPersonaName* SetPersonaNameAsync(
class UObject* WorldContextObject
, 
const class FString& Name
, 
...
bool bWasSuccessful
		...
		class USteamCoreFriendsAsyncActionDownloadClanActivityCounts* DownloadClanActivityCountsAsync(
class UObject* WorldContextObject
, 
TArray<struct FSteamID> SteamIDClans
, 
float Timeout
	...
	public:
		...
		class USteamCoreFriendsAsyncActionRequestClanOfficerList* RequestClanOfficerListAsync(
class UObject* WorldContextObject
, 
const struct FSteamID& SteamIDClan
, 
...
bool bWasSuccessful
	...
	public:
		...
		class USteamCoreFriendsAsyncActionJoinClanChatRoom* JoinClanChatRoomAsync(
class UObject* WorldContextObject
, 
const struct FSteamID& SteamIDClan
, 
...
bool bWasSuccessful
		...
		class USteamCoreFriendsAsyncActionEnumerateFollowingList* EnumerateFollowingListAsync(
class UObject* WorldContextObject
, 
int32_t StartIndex
, 
float Timeout
	...
	public:
		...
		class USteamCoreFriendsAsyncActionIsFollowing* IsFollowingAsync(
class UObject* WorldContextObject
, 
const struct FSteamID& SteamID
, 
...
bool bWasSuccessful
		...
		class USteamCoreFriendsAsyncActionGetFollowerCount* GetFollowerCountAsync(
class UObject* WorldContextObject
, 
const struct FSteamID& SteamID
, 
float Timeout
	...
	public:
		...
		unsigned char                                            UnknownData_5EE3[0x30];                                  // 0x0048(0x0030) MISSED OFFSET (PADDING)


	public:

		class USteamCoreFriendsAsyncActionRequestUserInformation* RequestUserInformationAsync(
class UObject* WorldContextObject
, 
const struct FSteamID& SteamIDUser
, 
...
float Timeout
	...
	public:
		...
		unsigned char                                            UnknownData_MT5W[0xE0];                                  // 0x00B8(0x00E0) MISSED OFFSET (PADDING)


	public:

		ESteamGameSearchErrorCode SubmitPlayerResult(
...
ESteamPlayerResult PlayerResult
		...
		ESteamGameSearchErrorCode SetGameHostParams(
const class FString& Key
, 
TArray<class FString> Values
);

		ESteamGameSearchErrorCode SetConnectionDetails(
const class FString& ConnectionDetails
);

		ESteamGameSearchErrorCode SearchForGameWithLobby(
const struct FSteamID& SteamIDLobby
, 
int32_t PlayerMin
, 
int32_t PlayerMax
		...
		ESteamGameSearchErrorCode SearchForGameSolo(
int32_t PlayerMin
, 
int32_t PlayerMax
);

		ESteamGameSearchErrorCode RetrieveConnectionDetails(
...
int32_t NumConnectionDetails
		...
		ESteamGameSearchErrorCode RequestPlayersForGame(
int32_t PlayerMin
, 
int32_t PlayerMax
, 
int32_t MaxTeamSize
		...
		ESteamGameSearchErrorCode HostConfirmGameStart(
const class FString& UniqueGameID
);

		ESteamGameSearchErrorCode EndGameSearch();

		ESteamGameSearchErrorCode EndGame(
const class FString& UniqueGameID
);
		...
		ESteamGameSearchErrorCode AddGameSearchParams(
...
TArray<class FString> ValuesToFind
	...
	public:
		...
		unsigned char                                            UnknownData_P9VG[0xA0];                                  // 0x0098(0x00A0) MISSED OFFSET (PADDING)
	...
	public:
		...
		ESteamUserHasLicenseForAppResult UserHasLicenseForApp(
const struct FSteamID& SteamID
, 
int32_t AppID
);
...
const class FString& Token
		...
		struct FSteamTicketHandle GetAuthSessionTicket(
...
int32_t Score
		...
		ESteamBeginAuthSessionResult BeginAuthSession(
TArray<unsigned char> Ticket
, 
const struct FSteamID& SteamID
);
...
const struct FSteamID& SteamIDClan
	...
	public:
		...
		unsigned char                                            UnknownData_59JI[0x20];                                  // 0x0058(0x0020) MISSED OFFSET (PADDING)
...
const class FString& Name
		...
		void ServerStoreUserStats(
const class FScriptDelegate& Callback
, 
const struct FSteamID& SteamIDUser
);

		void ServerRequestUserStats(
const class FScriptDelegate& Callback
, 
const struct FSteamID& SteamIDUser
);
...
unsigned char DurationMicroSec
		...
		ESteamCoreInputActionOrigin TranslateActionOrigin(
...
ESteamCoreInputLEDFlag Flags
		...
		class FString GetStringForXboxOrigin(
ESteamCoreXboxOrigin Origin
);

		class FString GetStringForActionOrigin(
ESteamCoreInputActionOrigin Origin
);

		int32_t GetRemotePlaySessionID(
const struct FInputHandle& Handle
);

		struct FInputMotionData GetMotionData(
const struct FInputHandle& Handle
);

		ESteamCoreInputType GetInputTypeForHandle(
const struct FInputHandle& Handle
);

		class FString GetGlyphForXboxOrigin(
ESteamCoreXboxOrigin Origin
);

		class FString GetGlyphForActionOrigin(
ESteamCoreInputActionOrigin Origin
);

		int32_t GetGamepadIndexForController(
const struct FInputHandle& Handle
);
...
TArray<ESteamCoreInputActionOrigin>* OriginsOut
		...
		struct FInputDigitalActionHandle GetDigitalActionHandle(
const class FString& PszActionName
);

		struct FInputDigitalActionData GetDigitalActionData(
const struct FInputHandle& Handle
, 
const struct FInputDigitalActionHandle& DigitalActionHandle
);
...
int32_t* Minor
		...
		struct FInputActionSetHandle GetCurrentActionSet(
const struct FInputHandle& Handle
);

		struct FInputHandle GetControllerForGamepadIndex(
int32_t Index
);

		int32_t GetConnectedControllers(
TArray<struct FInputHandle>* OutHandles
);

		int32_t GetAnalogActionOrigins(
const struct FInputHandle& Handle
, 
const struct FInputActionSetHandle& ActionSetHandle
, 
...
TArray<ESteamCoreInputActionOrigin>* OriginsOut
		...
		struct FInputAnalogActionHandle GetAnalogActionHandle(
const class FString& PszActionName
);

		struct FInputAnalogActionData GetAnalogActionData(
const struct FInputHandle& Handle
, 
const struct FInputAnalogActionHandle& AnalogActionHandle
);

		int32_t GetActiveActionSetLayers(
const struct FInputHandle& Handle
, 
TArray<struct FInputActionSetHandle>* Data
);

		struct FInputActionSetHandle GetActionSetHandle(
const class FString& ActionSetName
);

		ESteamCoreInputActionOrigin GetActionOriginFromXboxOrigin(
const struct FInputHandle& Handle
, 
ESteamCoreXboxOrigin Origin
);
...
const struct FInputActionSetHandle& ActionSetHandle
	...
	public:
		...
		unsigned char                                            UnknownData_PFSD[0xC0];                                  // 0x00A8(0x00C0) MISSED OFFSET (PADDING)
...
struct FSteamInventoryResult* Result
		...
		int32_t GetResultTimestamp(
const struct FSteamInventoryResult& Handle
);

		ESteamResult GetResultStatus(
const struct FSteamInventoryResult& Handle
);
...
const struct FSteamItemDef& ItemDef
	...
	public:
		...
		class USteamCoreInventoryAsyncActionRequestEligiblePromoItemDefinitionsIDs* RequestEligiblePromoItemDefinitionsIDsAsync(
class UObject* WorldContextObject
, 
const struct FSteamID& SteamID
, 
...
bool bWasSuccessful
	...
	public:
		...
		class USteamCoreInventoryAsyncActionRequestPricesResult* RequestPricesAsync(
class UObject* WorldContextObject
, 
float Timeout
);
...
bool bWasSuccessful
	...
	public:
		...
		class USteamCoreInventoryAsyncActionStartPurchaseResult* StartPurchaseAsync(
class UObject* WorldContextObject
, 
TArray<struct FSteamItemDef> ItemDefs
, 
...
bool bWasSuccessful
	...
	public:
		...
		unsigned char                                            UnknownData_HOSN[0x120];                                 // 0x00D8(0x0120) MISSED OFFSET (PADDING)
...
const struct FSteamID& SteamIDInvitee
		...
		int32_t GetNumLobbyMembers(
const struct FSteamID& SteamIDLobby
);

		struct FSteamID GetLobbyOwner(
const struct FSteamID& SteamIDLobby
);

		int32_t GetLobbyMemberLimit(
const struct FSteamID& SteamIDLobby
);

		class FString GetLobbyMemberData(
const struct FSteamID& SteamIDLobby
, 
const struct FSteamID& SteamIDUser
, 
const class FString& Key
		...
		struct FSteamID GetLobbyMemberByIndex(
const struct FSteamID& SteamIDLobby
, 
int32_t Member
);
...
class FString* Value
		...
		class FString GetLobbyData(
const struct FSteamID& SteamIDLobby
, 
const class FString& Key
);

		int32_t GetLobbyChatEntry(
const struct FSteamID& SteamIDLobby
, 
int32_t MessageID
, 
...
ESteamChatEntryType* ChatEntryType
		...
		struct FSteamID GetLobbyByIndex(
int32_t Lobby
);
...
bool bWasSuccessful
		...
		class USteamCoreMatchmakingAsyncActionCreateLobby* CreateLobbyAsync(
class UObject* WorldContextObject
, 
ESteamLobbyType LobbyType
, 
...
float Timeout
	...
	public:
		...
		class USteamCoreMatchmakingAsyncActionRequestLobbyList* RequestLobbyListAsync(
class UObject* WorldContextObject
, 
float Timeout
);
...
bool bWasSuccessful
	...
	public:
		...
		class USteamCoreMatchmakingAsyncActionJoinLobby* JoinLobbyAsync(
class UObject* WorldContextObject
, 
const struct FSteamID& SteamIDLobby
, 
...
bool bWasSuccessful
	...
	public:
		...
		unsigned char                                            UnknownData_OZ3D[0xE8];                                  // 0x0058(0x00E8) MISSED OFFSET (PADDING)
...
float Timeout
	...
	public:
		...
		unsigned char                                            UnknownData_UKLV[0x90];                                  // 0x0048(0x0090) MISSED OFFSET (PADDING)
...
bool bSuccessful
		...
		class USteamCoreFindSession* FindSteamCoreSessions(
class UObject* WorldContextObject
, 
...
float Timeout
	...
	public:
		...
		unsigned char                                            UnknownData_39LS[0x20];                                  // 0x0058(0x0020) MISSED OFFSET (PADDING)
...
bool bWasSuccessful
		...
		class USteamCoreDestroySession* DestroySteamCoreSession(
class UObject* WorldContextObject
, 
float Timeout
);
	...
	public:
		...
		unsigned char                                            UnknownData_KLIO[0xE0];                                  // 0x0048(0x00E0) MISSED OFFSET (PADDING)


	public:

		class USteamCoreUpdateSession* UpdateSteamCoreSession(
class UObject* WorldContextObject
, 
...
int32_t QueryPort
	...
	public:
		...
		class USteamCoreMatchmakingServersAsyncActionPingServer* PingServerAsync(
class UObject* WorldContextObject
, 
const class FString& IP
, 
...
bool bWasSuccessful
	...
	public:
		...
		class USteamCoreMatchmakingServersAsyncActionRequestServerList* RequestSpectatorServerListAsync(
class UObject* WorldContextObject
, 
int32_t AppID
, 
...
class UServerFilter* ServerFilter
		...
		class USteamCoreMatchmakingServersAsyncActionRequestServerList* RequestLANServerListAsync(
class UObject* WorldContextObject
, 
int32_t AppID
, 
...
class UServerFilter* ServerFilter
		...
		class USteamCoreMatchmakingServersAsyncActionRequestServerList* RequestInternetServerListAsync(
class UObject* WorldContextObject
, 
int32_t AppID
, 
...
class UServerFilter* ServerFilter
		...
		class USteamCoreMatchmakingServersAsyncActionRequestServerList* RequestHistoryServerListAsync(
class UObject* WorldContextObject
, 
int32_t AppID
, 
...
class UServerFilter* ServerFilter
		...
		class USteamCoreMatchmakingServersAsyncActionRequestServerList* RequestFriendsServerListAsync(
class UObject* WorldContextObject
, 
int32_t AppID
, 
...
class UServerFilter* ServerFilter
		...
		class USteamCoreMatchmakingServersAsyncActionRequestServerList* RequestFavoritesServerListAsync(
class UObject* WorldContextObject
, 
int32_t AppID
, 
...
const struct FGameServerItem& Data
	...
	public:
		...
		class USteamCoreMatchmakingServersAsyncActionServerRules* ServerRulesAsync(
class UObject* WorldContextObject
, 
const class FString& IP
, 
...
bool bWasSuccessful
	...
	public:
		...
		unsigned char                                            UnknownData_ODZY[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (PADDING)
...
const class FString& Value
		...
		void AddFilterGameTagsNor(
const class FString& Value
);

		void AddFilterGameTagsAnd(
const class FString& Value
);

		void AddFilterGameDataOr(
const class FString& Value
);

		void AddFilterGameDataNor(
const class FString& Value
);

		void AddFilterGameDataAnd(
const class FString& Value
);

		void AddFilterGameAddr(
const class FString& Value
);
...
const class FString& Value
	...
	public:
		...
		unsigned char                                            UnknownData_5LYF[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
...
float flVolume
	...
	public:
		...
		unsigned char                                            UnknownData_9M7H[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
...
struct FSteamNetworkPingLocation* Result
		...
		int32_t EstimatePingTimeFromLocalHost(
const struct FSteamNetworkPingLocation& RemoteLocation
);

		int32_t EstimatePingTimeBetweenTwoLocations(
...
int32_t AppID
	...
	public:
		...
		unsigned char                                            UnknownData_GM6W[0xC0];                                  // 0x00A8(0x00C0) MISSED OFFSET (PADDING)
...
class FString* OutMetadata
		...
		struct FPartyBeaconID GetBeaconByIndex(
int32_t Index
);
...
const struct FSteamID& SteamIDUser
	...
	public:
		...
		class USteamCoreSteamPartiesAsyncActionJoinParty* JoinPartyAsync(
class UObject* WorldContextObject
, 
const struct FPartyBeaconID& BeaconID
, 
...
bool bWasSuccessful
		...
		class USteamCoreSteamPartiesAsyncActionCreateBeacon* CreateBeaconAsync(
class UObject* WorldContextObject
, 
int32_t OpenSlots
, 
...
bool bWasSuccessful
		...
		class USteamCoreSteamPartiesAsyncActionChangeNumOpenSlots* ChangeNumOpenSlotsAsync(
class UObject* WorldContextObject
, 
const struct FPartyBeaconID& BeaconID
, 
...
float Timeout
	...
	public:
		...
		unsigned char                                            UnknownData_OXA7[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)


	public:

		struct FSteamID GetSessionSteamID(
int32_t SessionID
);
...
int32_t SessionIndex
		...
		class FString GetSessionClientName(
int32_t SessionID
);

		ESteamCoreDeviceFormFactor GetSessionClientFormFactor(
int32_t SessionID
);
...
int32_t* ResolutionY
	...
	public:
		...
		unsigned char                                            UnknownData_XS6U[0x80];                                  // 0x0088(0x0080) MISSED OFFSET (PADDING)
...
struct FSteamID* SteamIDOwner
		...
		ESteamRemoteStoragePlatform GetSyncPlatforms(
const class FString& File
);
...
const class FString& File
		...
		class FString GetFileNameAndSize(
int32_t File
, 
int32_t* FileSizeInBytes
);
		...
		struct FSteamUGCHandle GetCachedUGCHandle(
...
TArray<unsigned char> Data
		...
		struct FUGCFileWriteStreamHandle FileWriteStreamOpen(
const class FString& File
);
...
const class FString& File
	...
	public:
		...
		unsigned char                                            UnknownData_P642[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)


	public:

		struct FScreenshotHandle WriteScreenshot(
...
bool bHook
		...
		struct FScreenshotHandle AddVRScreenshotToLibrary(
...
const class FString& VRFileName
		...
		struct FScreenshotHandle AddScreenshotToLibrary(
const class FString& Filename
, 
...
int32_t Height
	...
	public:
		...
		unsigned char                                            UnknownData_UJHI[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
...
TArray<struct FPublishedFileID> PublishedFileID
		...
		struct FUGCUpdateHandle StartItemUpdate(
...
class FString* URL
		...
		int32_t GetQueryUGCNumTags(
const struct FUGCQueryHandle& Handle
, 
int32_t Index
);

		int32_t GetQueryUGCNumKeyValueTags(
const struct FUGCQueryHandle& Handle
, 
int32_t Index
);

		int32_t GetQueryUGCNumAdditionalPreviews(
const struct FUGCQueryHandle& Handle
, 
int32_t Index
);
...
ESteamItemPreviewType* PreviewType
		...
		ESteamItemUpdateStatus GetItemUpdateProgress(
const struct FUGCUpdateHandle& Handle
, 
...
const struct FPublishedFileID& PublishedFileID
		...
		struct FUGCQueryHandle CreateQueryUserUGCRequest(
const struct FSteamID& SteamID
, 
...
int32_t Page
		...
		struct FUGCQueryHandle CreateQueryUGCDetailsRequest(
TArray<struct FPublishedFileID> PublishedFileIDs
);

		struct FUGCQueryHandle CreateQueryAllUGCRequest(
...
int32_t AppID
	...
	public:
		...
		class USteamCoreUGCAsyncActionStopPlaytimeTrackingForAllItems* StopPlaytimeTrackingForAllItemsAsync(
class UObject* WorldContextObject
, 
float Timeout
);
...
bool bWasSuccessful
	...
	public:
		...
		class USteamCoreUGCAsyncActionStopPlaytimeTracking* StopPlaytimeTrackingAsync(
class UObject* WorldContextObject
, 
TArray<struct FPublishedFileID> PublishedFileIDs
, 
...
bool bWasSuccessful
	...
	public:
		...
		class USteamCoreUGCAsyncActionStartPlaytimeTracking* StartPlaytimeTrackingAsync(
class UObject* WorldContextObject
, 
TArray<struct FPublishedFileID> PublishedFileIDs
, 
...
bool bWasSuccessful
	...
	public:
		...
		class USteamCoreUGCAsyncActionUnsubscribeItem* UnsubscribeItemAsync(
class UObject* WorldContextObject
, 
...
bool bWasSuccessful
	...
	public:
		...
		class USteamCoreUGCAsyncActionSubscribeItem* SubscribeItemAsync(
class UObject* WorldContextObject
, 
const struct FPublishedFileID& PublishedFileIDs
, 
...
bool bWasSuccessful
	...
	public:
		...
		class USteamCoreUGCAsyncActionRemoveItemFromFavorites* RemoveItemFromFavoritesAsync(
class UObject* WorldContextObject
, 
int32_t AppID
, 
...
bool bWasSuccessful
		...
		class USteamCoreUGCAsyncActionAddItemToFavorites* AddItemToFavoritesAsync(
class UObject* WorldContextObject
, 
int32_t AppID
, 
...
bool bWasSuccessful
		...
		class USteamCoreUGCAsyncActionGetUserItemVote* GetUserItemVoteAsync(
class UObject* WorldContextObject
, 
const struct FPublishedFileID& PublishedFileID
, 
float Timeout
	...
	public:
		...
		class USteamCoreUGCAsyncActionSetUserItemVote* SetUserItemVoteAsync(
class UObject* WorldContextObject
, 
const struct FPublishedFileID& PublishedFileID
, 
...
bool bWasSuccessful
	...
	public:
		...
		class USteamCoreUGCAsyncActionSubmitItemUpdate* SubmitItemUpdateAsync(
class UObject* WorldContextObject
, 
const struct FUGCUpdateHandle& Handle
, 
...
bool bWasSuccessful
		...
		class USteamCoreUGCAsyncActionCreateItem* CreateItemAsync(
class UObject* WorldContextObject
, 
int32_t ConsumerAppID
, 
...
float Timeout
	...
	public:
		...
		class USteamCoreUGCAsyncActionSendQueryUGCRequest* SendQueryUGCRequestAsync(
class UObject* WorldContextObject
, 
const struct FUGCQueryHandle& Handle
, 
...
bool bWasSuccessful
		...
		class USteamCoreUGCAsyncActionAddAppDependency* AddAppDependencyAsync(
class UObject* WorldContextObject
, 
const struct FPublishedFileID& PublishedFileID
, 
...
float Timeout
	...
	public:
		...
		class USteamCoreUGCAsyncActionRemoveAppDependency* RemoveAppDependencyAsync(
class UObject* WorldContextObject
, 
const struct FPublishedFileID& PublishedFileID
, 
...
bool bWasSuccessful
		...
		class USteamCoreUGCAsyncActionAddUGCDependency* AddDependencyAsync(
class UObject* WorldContextObject
, 
const struct FPublishedFileID& PublishedFileID
, 
...
float Timeout
	...
	public:
		...
		class USteamCoreUGCAsyncActionRemoveUGCDependency* RemoveDependencyAsync(
class UObject* WorldContextObject
, 
const struct FPublishedFileID& PublishedFileID
, 
...
bool bWasSuccessful
		...
		class USteamCoreUGCAsyncActionDeleteItem* DeleteItemAsync(
class UObject* WorldContextObject
, 
const struct FPublishedFileID& PublishedFileID
, 
...
bool bWasSuccessful
		...
		class USteamCoreUGCAsyncActionGetAppDependencies* GetAppDependenciesAsync(
class UObject* WorldContextObject
, 
const struct FPublishedFileID& PublishedFileID
, 
...
bool bWasSuccessful
		...
		class USteamCoreUGCAsyncActionDownloadItem* DownloadItemAsync(
class UObject* WorldContextObject
, 
const struct FPublishedFileID& PublishedFileID
, 
...
float Timeout
	...
	public:
		...
		unsigned char                                            UnknownData_MEHL[0x160];                                 // 0x00F8(0x0160) MISSED OFFSET (PADDING)
...
TArray<unsigned char>* Ticket
		...
		ESteamVoiceResult GetAvailableVoice(
...
const struct FSteamID& SteamID
		...
		ESteamVoiceResult DecompressVoice(
...
int32_t ServerPort
	...
	public:
		...
		class USteamCoreUserAsyncActionRequestEncryptedAppTicket* RequestEncryptedAppTicketAsync(
class UObject* WorldContextObject
, 
TArray<unsigned char> DataToInclude
, 
...
bool bWasSuccessful
	...
	public:
		...
		class USteamCoreUserAsyncActionRequestStoreAuthURL* RequestStoreAuthURLAsync(
class UObject* WorldContextObject
, 
const class FString& RedirectURL
, 
...
bool bWasSuccessful
	...
	public:
		...
		unsigned char                                            UnknownData_UX1P[0xA0];                                  // 0x0098(0x00A0) MISSED OFFSET (PADDING)
...
const class FScriptDelegate& Callback
		...
		int32_t GetNextMostAchievedAchievementInfo(
...
bool* bAchieved
		...
		int32_t GetMostAchievedAchievementInfo(
class FString* Name
, 
float* Percent
, 
bool* bAchieved
		...
		ESteamLeaderboardSortMethod GetLeaderboardSortMethod(
const struct FSteamLeaderboard& SteamLeaderboard
);

		class FString GetLeaderboardName(
const struct FSteamLeaderboard& SteamLeaderboard
);

		int32_t GetLeaderboardEntryCount(
const struct FSteamLeaderboard& SteamLeaderboard
);

		ESteamLeaderboardDisplayType GetLeaderboardDisplayType(
const struct FSteamLeaderboard& SteamLeaderboard
);

		bool GetGlobalStatInt(
const class FString& StatName
, 
int32_t* Data
);

		int32_t GetGlobalStatHistoryInt(
const class FString& StatName
, 
int32_t HistoryDays
, 
TArray<int32_t>* Data
		...
		int32_t GetGlobalStatHistoryFloat(
const class FString& StatName
, 
int32_t HistoryDays
, 
...
float* MaxProgress
		...
		bool GetAchievementProgressLimits(
const class FString& Name
, 
int32_t* MinProgress
, 
int32_t* MaxProgress
		...
		class FString GetAchievementName(
int32_t Achievement
);

		class UTexture2D* GetAchievementIcon(
const class FString& Name
);

		class FString GetAchievementDisplayAttribute(
const class FString& Name
, 
const class FString& Key
);
...
bool bWasSuccessful
		...
		class USteamCoreUserStatsAsyncActionFindLeaderboard* FindLeaderboardAsync(
class UObject* WorldContextObject
, 
const class FString& LeaderboardName
, 
...
bool bWasSuccessful
		...
		class USteamCoreUserStatsAsyncActionDownloadLeaderboardEntries* DownloadLeaderboardEntriesAsync(
class UObject* WorldContextObject
, 
const struct FSteamLeaderboard& SteamLeaderboard
, 
...
float Timeout
	...
	public:
		...
		class USteamCoreUserStatsAsyncActionDownloadRequestGlobalStats* RequestGlobalStatsAsync(
class UObject* WorldContextObject
, 
int32_t HistoryDays
, 
...
bool bWasSuccessful
	...
	public:
		...
		class USteamCoreUserStatsAsyncActionRequestGlobalAchievementPercentages* RequestGlobalAchievementPercentagesAsync(
class UObject* WorldContextObject
, 
float Timeout
);
...
bool bWasSuccessful
		...
		class USteamCoreUserStatsAsyncActionGetNumberOfCurrentPlayers* GetNumberOfCurrentPlayersAsync(
class UObject* WorldContextObject
, 
float Timeout
);
...
bool bWasSuccessful
		...
		class USteamCoreUserStatsAsyncActionFindOrCreateLeaderboard* FindOrCreateLeaderboardAsync(
class UObject* WorldContextObject
, 
const class FString& LeaderboardName
, 
...
float Timeout
	...
	public:
		...
		class USteamCoreUserStatsAsyncActionRequestUserStats* RequestUserStatsAsync(
class UObject* WorldContextObject
, 
const struct FSteamID& SteamID
, 
...
bool bWasSuccessful
		...
		class USteamCoreUserStatsAsyncActionDownloadLeaderboardEntriesForUsers* DownloadLeaderboardEntriesForUsersAsync(
class UObject* WorldContextObject
, 
const struct FSteamLeaderboard& SteamLeaderboard
, 
...
bool bWasSuccessful
		...
		class USteamCoreUserStatsAsyncActionAttachLeaderboardUGC* AttachLeaderboardUGCAsync(
class UObject* WorldContextObject
, 
const struct FSteamLeaderboard& SteamLeaderboard
, 
...
float Timeout
	...
	public:
		...
		void DestroySteamCoreVoice(
class USteamCoreVoice* Obj
);

		class USteamCoreVoice* ConstructSteamCoreVoice(
...
TArray<unsigned char> DataBuffer
		...
		void SteamItemInstanceID_Equals_Exec(
...
ESteamCoreIdentical* Result
		...
		bool SteamItemInstanceID_Equals(
const struct FSteamItemInstanceID& A
, 
const struct FSteamItemInstanceID& B
);
		...
		TArray<unsigned char> ReadFileToBytes(
const class FString& AbsoluteFilePath
);

		bool PublishedFileID_NotEquals(
const struct FPublishedFileID& A
, 
const struct FPublishedFileID& B
);

		void PublishedFileID_Equals_Exec(
const struct FPublishedFileID& A
, 
const struct FPublishedFileID& B
, 
...
const struct FSteamID& B
		...
		struct FSteamUGCHandle MakeUGCHandle(
const class FString& Value
);

		struct FSteamTicketHandle MakeTicketHandle(
const class FString& Value
);

		struct FSteamSessionSetting MakeString(
const class FString& Value
);

		struct FSteamID MakeSteamID(
const class FString& Value
);

		struct FSteamGameID MakeSteamGameID(
const class FString& Value
);

		struct FSteamSessionSearchSetting MakeSearchString(
const class FString& Value
);

		struct FSteamSessionSearchSetting MakeSearchInteger(
ESteamComparisonOp ComparisonOperator
, 
int32_t Value
);

		struct FSteamSessionSearchSetting MakeSearchBool(
bool bValue
);

		struct FPublishedFileID MakePublishedFileID(
const class FString& Value
);

		struct FSteamInventoryUpdateHandle MakeInventoryUpdateHandle(
const class FString& Value
);

		struct FSteamSessionSetting MakeInteger(
int32_t Value
);

		struct FSteamSessionSetting MakeBool(
bool bValue
);

		void ListenForSteamMessages(
const class FScriptDelegate& Callback
);
...
const struct FSteamID& SteamID
		...
		void IsUGCHandleValid_Exec(
const struct FSteamUGCHandle& Handle
, 
ESteamCoreValid* Result
);

		bool IsUGCHandleValid(
const struct FSteamUGCHandle& Handle
);

		void IsSteamTicketHandleValid_Exec(
const struct FSteamTicketHandle& Handle
, 
ESteamCoreValid* Result
);

		bool IsSteamTicketHandleValid(
const struct FSteamTicketHandle& Handle
);

		bool IsSteamServerInitialized();

		void IsSteamInventoryUpdateHandleValid_Exec(
const struct FSteamInventoryUpdateHandle& Handle
, 
ESteamCoreValid* Result
);

		bool IsSteamInventoryUpdateHandleValid(
const struct FSteamInventoryUpdateHandle& Handle
);

		void IsSteamIDValid_Exec(
const struct FSteamID& SteamID
, 
ESteamCoreValid* Result
);
		...
		void IsPublishedFileIDValid_Exec(
const struct FPublishedFileID& Handle
, 
ESteamCoreValid* Result
);

		bool IsPublishedFileIDValid(
const struct FPublishedFileID& PublishedFileID
);
...
class FString* Key
		...
		struct FSteamID GetSteamIdFromPlayerState(
...
class FString* Key
		...
		ESteamAccountType GetAccountType(
const struct FSteamID& SteamID
);

		struct FDateTime FromUnixTimestamp(
...
const struct FSteamID& B
		...
		class FString EncryptString(
const class FString& String
);

		class UServerFilter* ConstructServerFilter(
class UObject* WorldContextObject
);

		void CancelQuery();

		class FString BreakUGCHandle(
const struct FSteamUGCHandle& Handle
);

		class FString BreakTicketHandle(
const struct FSteamTicketHandle& Handle
);

		class FString BreakSteamID(
const struct FSteamID& SteamID
);

		class FString BreakSteamGameID(
const struct FSteamGameID& SteamID
);

		class FString BreakPublishedFileID(
const struct FPublishedFileID& FileID
);

		class FString BreakInventoryUpdateHandle(
const struct FSteamInventoryUpdateHandle& Handle
);

		TArray<unsigned char> BP_StringToBytes(
const class FString& String
);

		class FString BP_BytesToString(
TArray<unsigned char> Array
	...
	public:
		...
		unsigned char                                            UnknownData_MJAF[0xA0];                                  // 0x0098(0x00A0) MISSED OFFSET (PADDING)
...
class FString* Text
	...
	public:
		...
		unsigned char                                            UnknownData_SYNW[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
