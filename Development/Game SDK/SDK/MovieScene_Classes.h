...
namespace CG
{
	...
	public:
		...
		unsigned char                                            UnknownData_MX2L[0x18];                                  // 0x0038(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_4IKX[0x1];                                   // 0x0054(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_SVW8[0x2];                                   // 0x0056(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_8QQ4[0x6];                                   // 0x0052(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_CGZI[0x3];                                   // 0x00B1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_0UJV[0x3];                                   // 0x00C5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_HH9W[0x1D];                                  // 0x00CB(0x001D) MISSED OFFSET (PADDING)
...
EMovieSceneBlendType InBlendType
	...
	public:
		...
		unsigned char                                            UnknownData_OS4K[0x4];                                   // 0x005C(0x0004) MISSED OFFSET (PADDING)


	public:

		TArray<struct FMovieSceneObjectBindingID> FindBindingsByTag(
const class FName& InBindingName
);

		struct FMovieSceneObjectBindingID FindBindingByTag(
const class FName& InBindingName
);
	...
	public:
		...
		unsigned char                                            UnknownData_DCPS[0x3E8];                                 // 0x0028(0x03E8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_IOCI[0x3];                                   // 0x0461(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_TT4A[0x3];                                   // 0x0465(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_H7NY[0x4];                                   // 0x0494(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_O2G0[0x68];                                  // 0x0580(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_PJHZ[0x70];                                  // 0x0610(0x0070) MISSED OFFSET (PADDING)
...
const struct FMovieSceneSequencePlaybackParams& PlaybackParams
);
...
const class FString& InLabel
);

		void ScrubToFrame(
const struct FFrameTime& NewPosition
);

		void Scrub();

		void RPC_OnStopEvent(
const struct FFrameTime& StoppedTime
);

		void RPC_ExplicitServerUpdateEvent(
EUpdatePositionMethod Method
, 
const struct FFrameTime& RelevantTime
);
...
const struct FFrameTime& NewPosition
		...
		TArray<struct FMovieSceneObjectBindingID> GetObjectBindings(
...
const struct FMovieSceneObjectBindingID& ObjectBinding
);
	...
	public:
		...
		unsigned char                                            UnknownData_JOH7[0x4];                                   // 0x013C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
class UMovieSceneSequence* Sequence
	...
	public:
		...
		unsigned char                                            UnknownData_D75F[0x10];                                  // 0x0030(0x0010) MISSED OFFSET (PADDING)
...
float InPlayRate
		...
		void OnStopPlaying(
const struct FQualifiedFrameTime& InStopTime
);

		void OnStartPlaying(
const struct FQualifiedFrameTime& InStartTime
);

		struct FFrameTime OnRequestCurrentTime(
const struct FQualifiedFrameTime& InCurrentTime
, 
float InPlayRate
);
	...
	public:
		...
		unsigned char                                            UnknownData_W9S5[0x6];                                   // 0x011A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_YPGH[0x58];                                  // 0x0038(0x0058) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_Y35D[0x20];                                  // 0x0040(0x0020) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_ELVI[0x7];                                   // 0x00E9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_SCY2[0x5];                                   // 0x03F3(0x0005) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_HIR2[0xB0];                                  // 0x0028(0x00B0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_GGDI[0x18];                                  // 0x0218(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_MW1T[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_UA8U[0x7];                                   // 0x0031(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_XGIY[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
float Interp
	...
	public:
		...
		unsigned char                                            UnknownData_WQIK[0x210];                                 // 0x0028(0x0210) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)


		struct FMovieSceneEntitySystemGraph                      SystemGraph;                                             // 0x0238(0x0138) NativeAccessSpecifierPublic


		unsigned char                                            UnknownData_9R5X[0xE8];                                  // 0x0370(0x00E8) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_N8T9[0x10];                                  // 0x0040(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_4D4K[0x10];                                  // 0x0060(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_FJ8L[0x90];                                  // 0x0040(0x0090) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_63BJ[0x8];                                   // 0x0180(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_6BAK[0x8];                                   // 0x0078(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_XZDI[0x7];                                   // 0x0081(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_T9WT[0x7];                                   // 0x0031(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_6GQR[0xB0];                                  // 0x0040(0x00B0) MISSED OFFSET (PADDING)
