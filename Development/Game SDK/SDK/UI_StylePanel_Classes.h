...
namespace CG
{
	...
	public:
		...
		unsigned char                                            UnknownData_3URZ[0x7];                                   // 0x02A1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class USoundBase*                                        Sound;                                                   // 0x02B8(0x0008) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
...
bool IsDesignTime
		...
		void ExecuteUbergraph_UI_StylePanel(
int32_t EntryPoint
);

		void OnUpdateStyle__DelegateSignature(
int32_t StyleIndex
);
