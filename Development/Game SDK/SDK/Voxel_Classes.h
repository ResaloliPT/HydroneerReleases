...
namespace CG
{
	...
	public:
		...
		unsigned char                                            UnknownData_Z6QL[0x7];                                   // 0x0229(0x0007) MISSED OFFSET (PADDING)
...
class AVoxelWorld* World
	...
	public:
		...
		unsigned char                                            UnknownData_LVBJ[0x3];                                   // 0x029D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_F96J[0x3];                                   // 0x02BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_IOLS[0x3];                                   // 0x02C5(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		...
		unsigned char                                            UnknownData_NVF4[0x2];                                   // 0x02CA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
bool bConvertToVoxelSpace
		...
		class UVoxelDataAsset* CreateDataAssetFromWorldSection(
class AVoxelWorld* World
, 
const struct FVoxelIntBox& Bounds
, 
...
const class FName& Name
		...
		class UMaterialInterface* GetIndexMaterial(
unsigned char Index
);
...
TArray<struct FVoxelIntBox>* OutUpdatedBounds
		...
		struct FBox TransformVoxelBoxToGlobalBox(
class AVoxelWorld* World
, 
const struct FVoxelIntBox& Box
);

		struct FVoxelIntBox TransformGlobalBoxToVoxelBox(
class AVoxelWorld* World
, 
const struct FBox& Box
);

		struct FIntVector Substract_IntVectorIntVector(
const struct FIntVector& Left
, 
const struct FIntVector& Right
);

		void SetToolRenderingMaterial(
class AVoxelWorld* World
, 
...
class UObject* Object
		...
		struct FIntVector Multiply_IntVectorIntVector(
const struct FIntVector& Left
, 
const struct FIntVector& Right
);

		struct FIntVector Multiply_IntVectorInt(
const struct FIntVector& Left
, 
int32_t Right
);

		struct FIntVector Multiply_IntIntVector(
int32_t Left
, 
const struct FIntVector& Right
);

		void MarkSpawnersDirty(
class AVoxelWorld* World
, 
const struct FVoxelIntBox& Bounds
);

		struct FVoxelMaterial MakeSingleIndexMaterial(
unsigned char Index
);

		struct FVoxelMaterial MakeRawMaterial(
unsigned char R
, 
unsigned char G
, 
...
bool V3
		...
		struct FVoxelIntBox MakeIntBoxFromGlobalPositionAndRadius(
class AVoxelWorld* World
, 
...
float Radius
		...
		struct FVoxelMaterial MakeColorMaterial(
const struct FLinearColor& Color
);

		void LogMemoryStats();

		bool IsVoxelWorldMeshLoading(
class AVoxelWorld* World
);

		bool IsVoxelWorldFoliageLoading(
class AVoxelWorld* World
);

		bool IsVoxelPluginPro();

		bool IsVoxelFloatTextureValid(
const struct FVoxelFloatTexture& Texture
);

		bool IsVoxelColorTextureValid(
const struct FVoxelFloatTexture& Texture
);
...
const struct FVoxelToolRenderingRef& Ref
		...
		bool IntervalContains_Int32(
const struct FVoxelInt32Interval& Interval
, 
int32_t Value
);

		bool IntervalContains_Float(
...
class AVoxelWorld* World
		...
		class AVoxelWorld* GetVoxelWorldOverlappingBox(
class UObject* WorldContextObject
, 
const struct FBox& Box
);

		class AVoxelWorld* GetVoxelWorldOverlappingActor(
class AActor* Actor
);

		class AVoxelWorld* GetVoxelWorldContainingPosition(
class UObject* WorldContextObject
, 
const struct FVector& Position
);

		struct FIntPoint GetVoxelFloatTextureSize(
const struct FVoxelFloatTexture& Texture
);

		struct FIntPoint GetVoxelColorTextureSize(
...
class AVoxelWorld* World
		...
		unsigned char GetSingleIndex(
const struct FVoxelMaterial& Material
);

		struct FVoxelIntBox GetRenderBoundsOverlappingDataBounds(
class AVoxelWorld* World
, 
...
EVoxelMemoryUsageType Type
		...
		int32_t GetMax_Intvector(
const struct FIntVector& Vector
);

		int32_t GetIntOutput(
class AVoxelWorld* World
, 
const class FName& Name
, 
...
float DefaultValue
		...
		float GetEstimatedCollisionsMemoryUsageInMB(
class AVoxelWorld* World
);
...
class AVoxelWorld* World
		...
		TArray<class AVoxelWorld*> GetAllVoxelWorldsOverlappingBox(
class UObject* WorldContextObject
, 
const struct FBox& Box
);

		TArray<class AVoxelWorld*> GetAllVoxelWorldsOverlappingActor(
class AActor* Actor
);

		TArray<class AVoxelWorld*> GetAllVoxelWorldsContainingPosition(
class UObject* WorldContextObject
, 
const struct FVector& Position
);

		struct FIntVector Divide_IntVectorInt(
const struct FIntVector& Left
, 
int32_t Right
);

		void DestroyToolRendering(
class AVoxelWorld* World
, 
const struct FVoxelToolRenderingRef& Ref
);

		struct FVoxelFloatTexture CreateVoxelFloatTextureFromTextureChannel(
class UTexture2D* Texture
, 
EVoxelRGBA Channel
);

		struct FVoxelColorTexture CreateVoxelColorTextureFromVoxelFloatTexture(
const struct FVoxelFloatTexture& Texture
, 
EVoxelRGBA Channel
, 
bool bNormalize
		...
		struct FVoxelPaintMaterial CreateUVPaintMaterial(
const struct FVoxelPaintMaterialUV& UV
);

		struct FVoxelToolRenderingRef CreateToolRendering(
class AVoxelWorld* World
);

		class UTexture2D* CreateTextureFromVoxelFloatTexture(
const struct FVoxelFloatTexture& VoxelTexture
);

		class UTexture2D* CreateTextureFromVoxelColorTexture(
const struct FVoxelColorTexture& VoxelTexture
);

		struct FVoxelPaintMaterial CreateSingleIndexPaintMaterial(
const struct FVoxelPaintMaterialSingleIndex& SingleIndex
);

		class UTexture2D* CreateOrUpdateTextureFromVoxelFloatTexture(
const struct FVoxelFloatTexture& VoxelTexture
, 
class UTexture2D** Texture
);

		class UTexture2D* CreateOrUpdateTextureFromVoxelColorTexture(
const struct FVoxelColorTexture& VoxelTexture
, 
class UTexture2D** Texture
);

		struct FVoxelPaintMaterial CreateMultiIndexWetnessPaintMaterial(
const struct FVoxelPaintMaterialMultiIndexWetness& MultiIndexWetness
);

		struct FVoxelPaintMaterial CreateMultiIndexRawPaintMaterial(
const struct FVoxelPaintMaterialMultiIndexRaw& MultiIndexRaw
);

		struct FVoxelPaintMaterial CreateMultiIndexPaintMaterial(
const struct FVoxelPaintMaterialMultiIndex& MultiIndex
);

		struct FVoxelPaintMaterial CreateFiveWayBlendPaintMaterial(
const struct FVoxelPaintMaterialFiveWayBlend& FiveWayBlend
);

		struct FVoxelPaintMaterial CreateColorPaintMaterial(
const struct FVoxelPaintMaterialColor& Color
);

		void CompactVoxelTexturePool(
class AVoxelWorld* World
);
...
bool bConvertToVoxelSpace
		...
		struct FVoxelMaterial ApplyPaintMaterial(
const struct FVoxelMaterial& Material
, 
...
class AVoxelWorld* World
		...
		struct FIntVector Add_IntVectorIntVector(
const struct FIntVector& Left
, 
const struct FIntVector& Right
);
	...
	public:
		...
		unsigned char                                            UnknownData_F1JN[0x3];                                   // 0x002D(0x0003) MISSED OFFSET (PADDING)
	...
	public:
		...
		class UMaterialInterface* GetMaterialForIndices(
TArray<unsigned char> Indices
);

		class UMaterialInterface* GetMaterialForIndex(
int32_t Index
, 
EVoxelCubicFace Face
	...
	public:
		...
		struct FVoxelIntBox GetModifiedVoxelValuesBounds(
TArray<struct FModifiedVoxelValue> ModifiedVoxels
);

		struct FVoxelIntBox GetModifiedVoxelMaterialsBounds(
...
bool bUpdateRender
	...
	public:
		...
		unsigned char                                            UnknownData_3ZJ2[0x8];                                   // 0x04B8(0x0008) Fix Super Size
	...
	public:
		...
		struct FVoxelCookingSettings MakeVoxelCookingSettingsFromVoxelWorld(
class AVoxelWorld* World
);

		void LoadCookedVoxelData(
const struct FVoxelCookedData& CookedData
, 
class AVoxelWorld* World
);

		struct FVoxelCookedData CookVoxelDataWithSave(
const struct FVoxelCookingSettings& Settings
, 
const struct FVoxelUncompressedWorldSave& Save
);

		struct FVoxelCookedData CookVoxelData(
const struct FVoxelCookingSettings& Settings
);
...
bool bValue
		...
		bool GetCubicVoxelValue(
class AVoxelWorld* World
, 
const struct FIntVector& Position
);

		struct FIntVector GetCubicVoxelPositionFromHit(
class AVoxelWorld* World
, 
...
bool bSelectVoxelOutside
	...
	public:
		...
		unsigned char                                            UnknownData_USTC[0x3];                                   // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_K5YP[0x3];                                   // 0x0051(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY


		unsigned char                                            UnknownData_GWF7[0x4];                                   // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_KS6Y[0x10];                                  // 0x0070(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_BH5H[0x14];                                  // 0x008C(0x0014) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_ELAY[0x3];                                   // 0x0221(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_YADC[0x20];                                  // 0x0228(0x0020) MISSED OFFSET (PADDING)
...
const struct FVoxelUncompressedWorldSave& Save
		...
		bool LoadFromCompressedSave(
class AVoxelWorld* World
, 
const struct FVoxelCompressedWorldSave& Save
);

		void GetVoxelsValueAndMaterialAsync(
class UObject* WorldContextObject
, 
const struct FLatentActionInfo& LatentInfo
, 
...
bool bHideLatentWarnings
		...
		void GetVoxelsValueAndMaterial(
TArray<struct FVoxelValueMaterial>* Voxels
, 
class AVoxelWorld* World
, 
...
const struct FVector& Position
		...
		struct FVoxelDataMemoryUsageInMB GetDataMemoryUsageInMB(
class AVoxelWorld* World
);

		void GetCompressedSaveAsync(
class UObject* WorldContextObject
, 
const struct FLatentActionInfo& LatentInfo
, 
...
bool bHideLatentWarnings
		...
		void GetCompressedSave(
class AVoxelWorld* World
, 
struct FVoxelCompressedWorldSave* OutSave
);

		void FindClosestNonEmptyVoxelAsync(
class UObject* WorldContextObject
, 
const struct FLatentActionInfo& LatentInfo
, 
...
bool bHeightmapAssetMatchesWorld
		...
		void ClearUnusedMaterialsAsync(
class UObject* WorldContextObject
, 
const struct FLatentActionInfo& LatentInfo
, 
...
const struct FVoxelIntBox& Bounds
		...
		void ClearCachedMaterialsAsync(
class UObject* WorldContextObject
, 
const struct FLatentActionInfo& LatentInfo
, 
...
const struct FVoxelIntBox& Bounds
		...
		void CheckIfSameAsGeneratorAsync(
class UObject* WorldContextObject
, 
const struct FLatentActionInfo& LatentInfo
, 
...
bool bHideLatentWarnings
		...
		void CheckIfSameAsGenerator(
class AVoxelWorld* World
, 
const struct FVoxelIntBox& Bounds
);

		void CheckForSingleValuesAsync(
class UObject* WorldContextObject
, 
const struct FLatentActionInfo& LatentInfo
, 
...
bool bHideLatentWarnings
		...
		void CheckForSingleValues(
class AVoxelWorld* World
, 
const struct FVoxelIntBox& Bounds
);

		void CheckForSingleMaterialsAsync(
class UObject* WorldContextObject
, 
const struct FLatentActionInfo& LatentInfo
, 
...
bool bHideLatentWarnings
		...
		void CheckForSingleMaterials(
class AVoxelWorld* World
, 
const struct FVoxelIntBox& Bounds
);

		void CacheValuesAsync(
class UObject* WorldContextObject
, 
const struct FLatentActionInfo& LatentInfo
, 
...
const struct FLinearColor& TextColor
	...
	public:
		...
		unsigned char                                            UnknownData_TULD[0x4];                                   // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_5TOK[0xA8];                                  // 0x0080(0x00A8) MISSED OFFSET (PADDING)
...
int32_t Count
	...
	public:
		...
		unsigned char                                            UnknownData_IZ15[0x6];                                   // 0x004A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_A1CL[0x7];                                   // 0x0059(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		struct FVoxelToolTickData MakeVoxelToolTickData(
...
ECollisionChannel CollisionChannel
		...
		class UVoxelTool* MakeVoxelTool(
class UClass* ToolClass
);

		TMap<class FName, bool> MakeToolKeys(
bool bAlternativeMode
);

		TMap<class FName, float> MakeToolAxes(
...
const class FName& Axis
		...
		void DoEditDynamicOverride__DelegateSignature(
const struct FVector& Position
, 
...
TMap<class FName, float> Axes
	 ...
	 * Size -> 0x03C8 (FullSize[0x0548] - InheritedSize[0x0180])
	 */
	...
	public:
		...
		unsigned char                                            UnknownData_CC0E[0x3A8];                                 // 0x0188(0x03A8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
const class FName& ID
		...
		void SetToolOverlayBounds(
const struct FBox& Bounds
);

		bool LastFrameCanEdit();

		void K2_UpdateRender(
...
float Max
		...
		struct FVoxelIntBox GetBoundsToCache(
const struct FVoxelIntBox& Bounds
);
	...
	public:
		...
		unsigned char                                            UnknownData_0KEQ[0x1];                                   // 0x0557(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_33O6[0x1];                                   // 0x0567(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_EE6I[0x24];                                  // 0x056C(0x0024) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_YQY2[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (PADDING)


	public:

		class UVoxelTransformableGeneratorInstanceWrapper* MakeTransformableGeneratorInstance(
const struct FVoxelTransformableGeneratorPicker& Picker
);

		class UVoxelGeneratorInstanceWrapper* MakeGeneratorInstance(
const struct FVoxelGeneratorPicker& Picker
	...
	public:
		...
		unsigned char                                            UnknownData_5T02[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_CJDK[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		bool SetTransformableGeneratorParameter(
const struct FVoxelTransformableGeneratorPicker& Picker
, 
...
int32_t Value
		...
		struct FVoxelTransformableGeneratorPicker MakeTransformableGeneratorPickerFromObject(
class UVoxelTransformableGenerator* Generator
);

		struct FVoxelTransformableGeneratorPicker MakeTransformableGeneratorPickerFromClass(
...
const struct FVoxelGeneratorInit& GeneratorInit
		...
		struct FVoxelGeneratorPicker MakeGeneratorPickerFromObject(
class UVoxelGenerator* Generator
);

		struct FVoxelGeneratorPicker MakeGeneratorPickerFromClass(
class UClass* GeneratorClass
);
...
const struct FVoxelGeneratorInit& GeneratorInit
		...
		bool IsValid_TransformableGeneratorPicker(
const struct FVoxelTransformableGeneratorPicker& GeneratorPicker
);

		bool IsValid_GeneratorPicker(
const struct FVoxelGeneratorPicker& GeneratorPicker
);

		void CreateFloatTextureFromGeneratorAsync(
class UObject* WorldContextObject
, 
const struct FLatentActionInfo& LatentInfo
, 
...
bool bHideLatentWarnings
		...
		void CreateFloatTextureFromGenerator(
struct FVoxelFloatTexture* OutTexture
, 
class UVoxelGeneratorInstanceWrapper* Generator
, 
...
int32_t StartY
		...
		void CreateColorTextureFromGeneratorAsync(
class UObject* WorldContextObject
, 
const struct FLatentActionInfo& LatentInfo
, 
...
bool bHideLatentWarnings
		...
		void CreateColorTextureFromGenerator(
struct FVoxelColorTexture* OutTexture
, 
class UVoxelGeneratorInstanceWrapper* Generator
, 
...
int32_t StartY
	...
	public:
		...
		unsigned char                                            UnknownData_B95U[0x3];                                   // 0x0035(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_06FO[0x10];                                  // 0x0050(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_TEL3[0x10];                                  // 0x0060(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_65N5[0x7];                                   // 0x0071(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_AJCE[0x10];                                  // 0x0098(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_17CE[0x4];                                   // 0x007C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		struct FVoxelIntBox TranslateBox(
const struct FVoxelIntBox& Box
, 
const struct FIntVector& Position
);

		struct FVoxelIntBox Scale(
const struct FVoxelIntBox& Box
, 
int32_t Scale
);

		struct FVoxelIntBox RemoveTranslation(
const struct FVoxelIntBox& Box
);

		struct FVoxelIntBox Overlap(
const struct FVoxelIntBox& A
, 
const struct FVoxelIntBox& B
);

		bool NotEqual_IntBoxIntBox(
const struct FVoxelIntBox& A
, 
const struct FVoxelIntBox& B
);

		struct FVoxelIntBoxWithValidity MakeIntBoxWithValidity(
const struct FVoxelIntBox& Box
, 
bool bIsValid
);

		struct FVoxelIntBox MakeIntBoxFromPoints(
TArray<struct FVector> Points
);

		struct FVoxelIntBox MakeIntBox(
const struct FIntVector& Min
, 
const struct FIntVector& Max
);

		struct FVoxelIntBox MakeBoxFromPositionAndRadius(
const struct FVector& Position
, 
float Radius
);

		struct FVoxelIntBox MakeBoxFromLocalPositionAndRadius(
const struct FIntVector& Position
, 
int32_t Radius
);

		bool IsVectorInsideBox(
const struct FVoxelIntBox& Box
, 
const struct FVector& Position
);
...
const struct FVoxelIntBox& Box
		...
		TArray<struct FIntVector> GetCorners(
const struct FVoxelIntBox& Box
);
...
const struct FVoxelIntBox& Box
		...
		struct FVoxelIntBox Extend_IntVector(
const struct FVoxelIntBox& Box
, 
const struct FIntVector& Extent
);

		struct FVoxelIntBox Extend(
const struct FVoxelIntBox& Box
, 
int32_t Extent
);

		bool EqualEqual_IntBoxIntBox(
const struct FVoxelIntBox& A
, 
const struct FVoxelIntBox& B
);

		struct FVoxelIntBox Conv_IntVectorToVoxelIntBox(
const struct FIntVector& Vector
);

		class FString Conv_IntBoxToString(
...
const struct FVoxelIntBox& Other
		...
		struct FVoxelIntBox Center(
const struct FVoxelIntBox& Box
);

		void BreakIntBoxWithValidity(
...
struct FIntVector* Max
		...
		struct FVoxelIntBox ApplyTransform(
const struct FVoxelIntBox& Box
, 
const struct FTransform& Transform
);

		struct FVoxelIntBox AddPoint(
const struct FVoxelIntBox& Box
, 
const struct FIntVector& Point
);

		struct FVoxelIntBox AddBox(
const struct FVoxelIntBox& Box
, 
const struct FVoxelIntBox& BoxToAdd
	...
	public:
		...
		unsigned char                                            UnknownData_AENF[0x8];                                   // 0x01F8(0x0008) Fix Super Size


	public:

		bool ShouldUseInvoker(
class AVoxelWorld* VoxelWorld
);
		...
		struct FIntVector GetInvokerVoxelPosition(
class AVoxelWorld* VoxelWorld
);

		struct FVoxelInvokerSettings GetInvokerSettings(
class AVoxelWorld* VoxelWorld
);
	...
	public:
		...
		unsigned char                                            UnknownData_CHUG[0x3];                                   // 0x0201(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_S2CJ[0x3];                                   // 0x020D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_XLKD[0x3];                                   // 0x0215(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_5LWR[0x4];                                   // 0x021C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_5EO1[0x3];                                   // 0x0221(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_L01U[0x8];                                   // 0x0228(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_BEFZ[0x3];                                   // 0x0201(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_CUDJ[0x6];                                   // 0x020A(0x0006) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_MVBI[0x7];                                   // 0x0229(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_YIRC[0x4];                                   // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_FGBG[0x8];                                   // 0x0568(0x0008) MISSED OFFSET (PADDING)
...
bool bUpdateRender
	...
	public:
		...
		unsigned char                                            UnknownData_ILA7[0x30];                                  // 0x0440(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_T4OF[0xB];                                   // 0x0475(0x000B) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_BCTB[0x4];                                   // 0x0224(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
class UVoxelMagicaVoxScene* Scene
	...
	public:
		...
		void ResetHaltonStream(
const struct FVoxelHaltonStream& Stream
);

		struct FVoxelHaltonStream MakeHaltonStream(
int32_t InitialSeed
);

		struct FVector GetUnitVectorFromRandom(
const struct FVector2D& Random
);

		struct FVector GetHalton3D(
const struct FVoxelHaltonStream& Stream
);

		struct FVector2D GetHalton2D(
const struct FVoxelHaltonStream& Stream
);
...
const struct FVoxelHaltonStream& Stream
	...
	public:
		...
		unsigned char                                            UnknownData_RXPE[0x30];                                  // 0x0028(0x0030) MISSED OFFSET (PADDING)
	...
	public:
		...
		class UTextureRenderTarget2D* CreateTextureFromMaterial(
class UObject* WorldContextObject
, 
class UMaterialInterface* Material
, 
...
int32_t Height
		...
		class UVoxelMeshImporterInputData* CreateMeshDataFromStaticMesh(
class UStaticMesh* StaticMesh
);

		void ConvertMeshToVoxels_NoMaterials(
class UObject* WorldContextObject
, 
...
int32_t* NumLeaks
	...
	public:
		...
		unsigned char                                            UnknownData_YXRB[0x4];                                   // 0x026C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_DTE8[0x4];                                   // 0x027C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_UM27[0x4];                                   // 0x02AC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_WB6V[0x8];                                   // 0x02C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_FSYQ[0x4];                                   // 0x0548(0x0004) Fix Super Size
		...
		unsigned char                                            UnknownData_MHMV[0x7];                                   // 0x0551(0x0007) Fix size for supers
	 ...
	 * Size -> 0x0128 (FullSize[0x0680] - InheritedSize[0x0558])
	 */
	...
	public:
		...
		unsigned char                                            UnknownData_E61K[0x3];                                   // 0x056D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_JD8H[0x3];                                   // 0x0575(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_U45Q[0x2];                                   // 0x058E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_7HFB[0x2];                                   // 0x0596(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_KWKV[0x2];                                   // 0x05A6(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_6VEN[0x6];                                   // 0x05C2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_AFCJ[0x3];                                   // 0x05E9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_Z980[0x2];                                   // 0x05FA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_K59Q[0x18];                                  // 0x0608(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_YUL8[0x20];                                  // 0x0028(0x0020) MISSED OFFSET (PADDING)
...
int32_t Port
	...
	public:
		...
		unsigned char                                            UnknownData_OS0W[0x4];                                   // 0x01F8(0x0004) Fix Super Size
		...
		unsigned char                                            UnknownData_GBGE[0x3];                                   // 0x0201(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_1BRQ[0x3];                                   // 0x0209(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_T94N[0x37];                                  // 0x0249(0x0037) MISSED OFFSET (PADDING)


	public:

		bool ShouldUseVoxelWorld(
class AVoxelWorld* VoxelWorld
);
...
bool bHideLatentWarnings
	...
	public:
		...
		unsigned char                                            UnknownData_28MK[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_4RX8[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_EAV5[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_74E9[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_NE1A[0x4];                                   // 0x0044(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_J5VN[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_L6BD[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_8QIB[0x3];                                   // 0x00B1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_Y1X6[0x2C];                                  // 0x00BC(0x002C) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_34OH[0x4];                                   // 0x0224(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_GDW0[0x3];                                   // 0x02AD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_WF8Z[0x5];                                   // 0x02DB(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_NFUI[0x3];                                   // 0x0311(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_ZMES[0x6];                                   // 0x031A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_RSEK[0x6];                                   // 0x0372(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_7S4L[0x3];                                   // 0x03DD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_JO46[0x2];                                   // 0x03E6(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_6NBV[0x3];                                   // 0x03ED(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_3XYC[0x2];                                   // 0x0402(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_VRM6[0x2];                                   // 0x040A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_COEM[0x2];                                   // 0x041E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_ZWQP[0x3];                                   // 0x0425(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_YWNN[0x4];                                   // 0x042C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_1PS5[0x2];                                   // 0x0442(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_1BR2[0x4];                                   // 0x044C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_2CFW[0x7];                                   // 0x0459(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_2DBP[0x3];                                   // 0x05BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_H2S3[0x4];                                   // 0x05C4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_AHME[0x2];                                   // 0x05D2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_9BH1[0x1];                                   // 0x05DF(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_RY7U[0x4];                                   // 0x05E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_MJUV[0x3];                                   // 0x0695(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_789W[0x4];                                   // 0x06A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_P3KG[0x8];                                   // 0x06C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_PBNF[0x5];                                   // 0x073B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_M4L9[0x1];                                   // 0x0763(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_4UVX[0x4];                                   // 0x0774(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_DA9S[0x87];                                  // 0x07E9(0x0087) MISSED OFFSET (PADDING)
...
int32_t NewWorldSizeInVoxel
		...
		void SetRenderOctreeDepth(
int32_t NewDepth
);

		void SetRenderOctreeChunkSize(
int32_t NewChunkSize
);

		void SetGeneratorObject(
class UVoxelGenerator* NewGenerator
);

		void SetGeneratorClass(
...
ECollisionResponse NewResponse
		...
		void LogCompressedSaveSize(
class AVoxelWorld* VoxelWorld
, 
const struct FVoxelCompressedWorldSave& Save
);

		struct FVector K2_LocalToGlobalFloat(
const struct FVector& Position
);

		struct FBox K2_LocalToGlobalBounds(
const struct FVoxelIntBox& Bounds
);

		struct FVector K2_LocalToGlobal(
const struct FIntVector& Position
);

		struct FVector K2_GlobalToLocalFloat(
const struct FVector& Position
);

		struct FVoxelIntBox K2_GlobalToLocalBounds(
const struct FBox& Bounds
);

		struct FIntVector K2_GlobalToLocal(
const struct FVector& Position
, 
EVoxelWorldCoordinatesRounding Rounding
		...
		TArray<struct FIntVector> GetNeighboringPositions(
const struct FVector& GlobalPosition
);
...
const struct FVoxelWorldCreateInfo& Info
	...
	public:
		...
		unsigned char                                            UnknownData_ZQJH[0x50];                                  // 0x0028(0x0050) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_BEB3[0x6];                                   // 0x002A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_5FP5[0x20];                                  // 0x0048(0x0020) MISSED OFFSET (PADDING)
...
const struct FVoxelPerlinWormsSettings& Settings
		...
		void AddWorm__DelegateSignature(
const struct FVector& Start
, 
const struct FVector& End
, 
float Radius
	...
	public:
		...
		unsigned char                                            UnknownData_OALN[0xB8];                                  // 0x0480(0x00B8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_QL3Q[0xD0];                                  // 0x0550(0x00D0) MISSED OFFSET (PADDING)


	public:

		void SetVoxelCollisionsFrozen(
class AVoxelWorld* VoxelWorld
, 
bool bFrozen
);
...
float DrawTime
		...
		TArray<struct FIntVector> GetHitsPositions(
TArray<struct FVoxelProjectionHit> Hits
);

		struct FVector GetHitsAveragePosition(
TArray<struct FVoxelProjectionHit> Hits
);

		struct FVector GetHitsAverageNormal(
TArray<struct FVoxelProjectionHit> Hits
);

		int32_t FindProjectionVoxelsAsync(
class UObject* WorldContextObject
, 
const struct FLatentActionInfo& LatentInfo
, 
...
float MaxDistance
		...
		struct FVoxelSurfaceEditsVoxels CreateSurfaceVoxelsFromHitsWithExactValues(
class AVoxelWorld* World
, 
TArray<struct FVoxelProjectionHit> Hits
);

		struct FVoxelSurfaceEditsVoxels CreateSurfaceVoxelsFromHits(
TArray<struct FVoxelProjectionHit> Hits
);
	...
	public:
		...
		unsigned char                                            UnknownData_IGAY[0x4];                                   // 0x0568(0x0004) Fix Super Size
		...
		unsigned char                                            UnknownData_7QLB[0xC];                                   // 0x0574(0x000C) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_WLIF[0x4];                                   // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
struct FVoxelCompressedWorldSave* OutCompressedSave
	...
	public:
		...
		unsigned char                                            UnknownData_WA2Z[0x2];                                   // 0x0552(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_J6ZC[0x3];                                   // 0x0561(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_NUXB[0x8];                                   // 0x0568(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_LOEG[0x2];                                   // 0x0572(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_FA4Y[0x3];                                   // 0x057D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_0JJE[0x3];                                   // 0x0585(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_J221[0x4];                                   // 0x058C(0x0004) MISSED OFFSET (PADDING)
...
bool bUpdateRender
		...
		void RevertSphereToGeneratorAsync(
class UObject* WorldContextObject
, 
const struct FLatentActionInfo& LatentInfo
, 
...
bool bHideLatentWarnings
		...
		void RemoveSphereWithDurability(
TArray<struct FModifiedVoxelValue>* ModifiedValues
, 
struct FVoxelIntBox* EditedBounds
, 
...
bool bUpdateRender
		...
		void ApplyMaterialKernelSphereAsync(
class UObject* WorldContextObject
, 
const struct FLatentActionInfo& LatentInfo
, 
...
bool bHideLatentWarnings
		...
		void ApplyMaterialKernelSphere(
TArray<struct FModifiedVoxelMaterial>* ModifiedMaterials
, 
struct FVoxelIntBox* EditedBounds
, 
...
bool bUpdateRender
	...
	public:
		...
		void PropagateVoxelMaterialsAsync(
class UObject* WorldContextObject
, 
const struct FLatentActionInfo& LatentInfo
, 
...
bool bUpdateRender
	 ...
	 * Size -> 0x0208 (FullSize[0x0750] - InheritedSize[0x0548])
	 */
	...
	public:
		...
		unsigned char                                            UnknownData_AQN2[0x3];                                   // 0x0551(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_OQ58[0x2];                                   // 0x055A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_A1O2[0x2];                                   // 0x0562(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_IJCA[0x3];                                   // 0x0569(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_LDZ2[0x1];                                   // 0x057B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_H0C7[0x7];                                   // 0x0581(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)


		struct FVoxelSurfaceToolMask                             Mask;                                                    // 0x0588(0x00A8) Edit, BlueprintVisible, NativeAccessSpecifierPublic


		unsigned char                                            UnknownData_DIAL[0x110];                                 // 0x0630(0x0110) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_YH9C[0x8];                                   // 0x0748(0x0008) MISSED OFFSET (PADDING)
...
const struct FVoxelSurfaceEditsProcessedVoxels& Voxels
		...
		void FindSurfaceVoxelsFromDistanceField(
...
float LifeTime
		...
		struct FVoxelSurfaceEditsStackElement ApplyTerrace(
...
int32_t ImmutableVoxels
		...
		struct FVoxelSurfaceEditsStackElement ApplyStrengthMask(
class AVoxelWorld* World
, 
const struct FVoxelFloatTexture& Mask
, 
...
bool bConvertToVoxelSpace
		...
		struct FVoxelSurfaceEditsStackElement ApplyStrengthCurve(
class AVoxelWorld* World
, 
...
bool bHideLatentWarnings
		...
		struct FVoxelSurfaceEditsProcessedVoxels ApplyStack(
const struct FVoxelSurfaceEditsVoxels& Voxels
, 
const struct FVoxelSurfaceEditsStack& Stack
);

		struct FVoxelSurfaceEditsStackElement ApplyFlatten(
class AVoxelWorld* World
, 
...
bool bConvertToVoxelSpace
		...
		struct FVoxelSurfaceEditsStackElement ApplyFalloff(
class AVoxelWorld* World
, 
EVoxelFalloff FalloffType
, 
...
bool bConvertToVoxelSpace
		...
		struct FVoxelSurfaceEditsStackElement ApplyConstantStrength(
float Strength
);

		struct FVoxelSurfaceEditsStack AddToStack(
const struct FVoxelSurfaceEditsStack& Stack
, 
...
const struct FVoxelTestValues& ValuesB
		...
		struct FVoxelTestValues ReadValues(
class AVoxelWorld* World
, 
const struct FVoxelIntBox& Bounds
);
	...
	public:
		...
		struct FVoxelFloatTexture Minimum(
const struct FVoxelFloatTexture& Texture
, 
float Radius
);

		struct FVoxelFloatTexture Maximum(
const struct FVoxelFloatTexture& Texture
, 
float Radius
);
	...
	public:
		...
		unsigned char                                            UnknownData_QWXZ[0x4];                                   // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_SHAX[0x4];                                   // 0x00D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_DQGK[0x1];                                   // 0x00EF(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_9OA8[0x4];                                   // 0x00F4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_GUL4[0x18];                                  // 0x0118(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		void UpdateSphereOverlayMaterial(
...
float Falloff
	...
	public:
		...
		void SetActiveToolByName(
const class FName& NewActiveTool
);

		void SetActiveToolByClass(
...
bool bLoadBlueprints
	...
	public:
		...
		unsigned char                                            UnknownData_16DN[0x18];                                  // 0x0558(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_3501[0x8];                                   // 0x0440(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_TZ6Y[0x60];                                  // 0x0450(0x0060) MISSED OFFSET (PADDING)
