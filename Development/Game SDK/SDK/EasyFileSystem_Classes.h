...
const class FString& from
		...
		class FString LoadFileToString(
const class FString& inPath
);
...
const class FString& Filename
		...
		class FString GetStringFieldJson(
...
const class FString& inPath
		...
		int32_t GetIntegerFieldJson(
const class FString& Data
, 
const class FString& fieldName
);

		class FString GetFilenameOnDisk(
const class FString& Filename
);
...
const class FString& inPath
		...
		bool GetBoolFieldJson(
const class FString& Data
, 
const class FString& fieldName
);

		TArray<class FString> FindFiles(
