...
namespace CG
{
	...
	public:
		...
		unsigned char                                            UnknownData_FTO4[0x3];                                   // 0x026D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
class APlayerController* Player
	...
	public:
		...
		unsigned char                                            UnknownData_ONXD[0x4];                                   // 0x026C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
const struct FCapturedInput& CapturedInput
	...
	public:
		...
		unsigned char                                            UnknownData_TI6X[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_ZYXM[0x6];                                   // 0x0042(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_B7SV[0x7];                                   // 0x00B9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_PSHU[0x4];                                   // 0x0154(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		TArray<class UTexture*> LoadKeyIcons(
const struct FGameplayTagContainer& KeyIconTags
);

		struct FGameplayTag GetKeyGroupStatic(
const struct FKey& Key
);

		class FText GetKeyFriendlyNameStatic(
const struct FKey& Key
);
	...
	public:
		...
		unsigned char                                            UnknownData_Q221[0x8];                                   // 0x0030(0x0008) MISSED OFFSET (PADDING)
...
struct FPlayerInputMappings* InputMappings
	...
	public:
		...
		unsigned char                                            UnknownData_8F2H[0x4];                                   // 0x029C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_U5XS[0x4];                                   // 0x02A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_YOGZ[0x14];                                  // 0x0274(0x0014) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
const struct FCapturedInput& CapturedInput
	...
	public:
		...
		unsigned char                                            UnknownData_3OG7[0x1];                                   // 0x0263(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)


		struct FGameplayTag                                      KeyGroup;                                                // 0x0264(0x0008) NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic


		unsigned char                                            UnknownData_EU98[0x4];                                   // 0x026C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_Q0BP[0x3];                                   // 0x02B1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_0KAG[0x4];                                   // 0x02BC(0x0004) MISSED OFFSET (PADDING)
...
const struct FKey& PrimaryKey
	...
	public:
		...
		void SetGlobalKeyIconTags(
const struct FGameplayTagContainer& InGlobalIconTags
);

		class UTexture* GetIconForKey(
...
float AxisScale
	...
	public:
		...
		void SetPlayerKeyGroupStatic(
class APlayerController* Player
, 
const struct FGameplayTag& KeyGroup
);

		void SetPlayerInputPresetStatic(
class APlayerController* Player
, 
const struct FInputMappingPreset& Preset
);

		void SetPlayerInputPresetByTag(
class APlayerController* Player
, 
const struct FGameplayTag& PresetTag
);

		void OnRegisteredPlayerControllerDestroyed(
class AActor* DestroyedActor
);

		bool InitializePlayerInputOverridesStatic(
class APlayerController* Player
);

		void GetPlayerMappingsByKey(
class APlayerController* Player
, 
const struct FKey& Key
, 
...
TArray<struct FInputAxisKeyMapping>* Axes
		...
		struct FPlayerInputMappings GetPlayerInputMappingsStatic(
class APlayerController* Player
);

		struct FInputAxisKeyMapping GetPlayerAxisMappingStatic(
class APlayerController* Player
, 
...
int32_t MappingGroup
		...
		TArray<struct FInputAxisKeyMapping> GetPlayerAxisMappings(
class APlayerController* Player
, 
const class FName& AxisName
, 
...
bool bUsePlayerKeyGroup
		...
		struct FInputAxisKeyMapping GetPlayerAxisMapping(
class APlayerController* Player
, 
const class FName& AxisName
, 
...
bool bUsePlayerKeyGroup
		...
		struct FInputActionKeyMapping GetPlayerActionMappingStatic(
class APlayerController* Player
, 
...
int32_t MappingGroup
		...
		TArray<struct FInputActionKeyMapping> GetPlayerActionMappings(
class APlayerController* Player
, 
const class FName& ActionName
, 
...
bool bUsePlayerKeyGroup
		...
		struct FInputActionKeyMapping GetPlayerActionMapping(
class APlayerController* Player
, 
const class FName& ActionName
, 
...
bool bUsePlayerKeyGroup
		...
		void AddPlayerAxisOverrideStatic(
class APlayerController* Player
, 
...
bool bAnyKeyGroup
		...
		void AddPlayerActionOverrideStatic(
class APlayerController* Player
, 
...
bool bAnyKeyGroup
	...
	public:
		...
		unsigned char                                            UnknownData_M7AP[0x4];                                   // 0x02AC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
