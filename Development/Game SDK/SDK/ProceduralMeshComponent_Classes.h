...
, 
const struct FVector& PlanePosition
, 
...
const struct FVector& BoxRadius
, 
TArray<struct FVector>* Vertices
, 
TArray<int32_t>* Triangles
...
TArray<struct FProcMeshTangent>* Tangents
	...
	public:
		...
		unsigned char                                            UnknownData_105J[0x8];                                   // 0x0468(0x0008) Fix Super Size
		...
		unsigned char                                            UnknownData_6JQW[0x6];                                   // 0x0472(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_QAHJ[0x4];                                   // 0x04BC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
