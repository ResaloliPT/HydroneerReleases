...
namespace CG
{
	...
	public:
		...
		bool                                                     CanHighlight;                                            // 0x00D0(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor


		unsigned char                                            UnknownData_3Q1V[0x7];                                   // 0x00D1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)


		TArray<int32_t>                                          HighlightArray;                                          // 0x00D8(0x0010) Edit, BlueprintVisible, DisableEditOnInstance


		bool                                                     IsHighlighted;                                           // 0x00E8(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
...
class ABP_GameController_C* Controller
		...
		void TogglePlayerHighlight(
bool Highlight
, 
class ABP_GameController_C* Controller
);

		void OnUnhighlighted__DelegateSignature(
class ABP_GameController_C* Controller
);

		void OnHighlighted__DelegateSignature(
class ABP_GameController_C* Controller
);
