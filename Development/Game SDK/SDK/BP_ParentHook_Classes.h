...
namespace CG
{
	...
	public:
		...
		class ABP_ParentBuild_C*                                 HookedParent;                                            // 0x0410(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash


		TArray<class UClass*>                                    AllowedToHookTo;                                         // 0x0418(0x0010) Edit, BlueprintVisible
...
class ABP_ParentBuild_C* HookedTo
		...
		void OnCompleted_B369DA2141FEE07E81DC2BA7EA68CDD3();
...
const class FString& Logic
		...
		void ExecuteUbergraph_BP_ParentHook(
int32_t EntryPoint
);
