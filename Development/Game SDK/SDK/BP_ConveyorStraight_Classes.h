...
namespace CG
{
	 ...
	 * Size -> 0x0038 (FullSize[0x04A4] - InheritedSize[0x046C])
	 */
	class ABP_ConveyorStraight_C : public ABP_ParentConveyor_C
	{
	public:

		unsigned char                                            UnknownData_KVMH[0x4];                                   // 0x046C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		struct FTimerHandle                                      ConveyorTimerHandle;                                     // 0x0490(0x0008) Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash


		struct FVector                                           BeltDelta;                                               // 0x0498(0x000C) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
...
float DeltaSeconds
		...
		void ExecuteUbergraph_BP_ConveyorStraight(
int32_t EntryPoint
);
