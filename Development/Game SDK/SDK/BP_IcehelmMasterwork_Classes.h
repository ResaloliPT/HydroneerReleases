...
namespace CG
{
	...
	public:
		...
		bool                                                     Ready;                                                   // 0x02B0(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor


		unsigned char                                            UnknownData_B38X[0x7];                                   // 0x02B1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
TArray<class UActorComponent*>* Components
		...
		void Add_to_Contents(
const struct FS_ResourceEnumAndWeight& Resource
);

		void IsClassInOurRequirements(
...
E_MetalType* Type
		...
		void FindWeightNeededOfSpecific(
E_MetalType Type
, 
float* Weight
);
		...
		void Has_All_Required_Contents(
...
class UClass* Class
		...
		void BndEvt__BP_IcehelmMasterwork_MouldBox_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature(
...
const struct FHitResult& SweepResult
		...
		void ExecuteUbergraph_BP_IcehelmMasterwork(
int32_t EntryPoint
);
