...
namespace CG
{
	...
	/**
	 * BlueprintGeneratedClass BP_BuildGreenhouseDoorway.BP_BuildGreenhouseDoorway_C
	...
	public:
		...
		bool                                                     DoorOpen;                                                // 0x0420(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
...
class ABP_GameController_C* Insigator
		...
		void ExecuteUbergraph_BP_BuildGreenhouseDoorway(
int32_t EntryPoint
);
