...
namespace CG
{
	 ...
	 */
	void ABP_HardHat_C::OverrideHatOn(
class ABP_GameCharacter_C* Character
	 ...
	 * 		class ABP_GameCharacter_C*                         Character                                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void ABP_HardHat_C::OverrideHatOff(
class ABP_GameCharacter_C* Character
)
	{
		static UFunction* fn = nullptr;
	 ...
	 */
	void ABP_HardHat_C::ExecuteUbergraph_BP_HardHat(
int32_t EntryPoint
)
	{
		static UFunction* fn = nullptr;
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ABP_HardHat_C.StaticClass
