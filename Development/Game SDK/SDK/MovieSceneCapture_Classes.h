...
namespace CG
{
	...
	public:
		...
		unsigned char                                            UnknownData_61OK[0x28];                                  // 0x0028(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_6PHO[0x7];                                   // 0x0051(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_6DKS[0x28];                                  // 0x0068(0x0028) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_VRZZ[0x3];                                   // 0x0069(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_XN75[0x7];                                   // 0x0071(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_XTBV[0x7];                                   // 0x0091(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_RNH5[0x20];                                  // 0x00A0(0x0020) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_73TD[0x10];                                  // 0x0058(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_T427[0x70];                                  // 0x0068(0x0070) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_CL49[0x4];                                   // 0x00DC(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_PSE3[0xE];                                   // 0x00DA(0x000E) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_V16V[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_OAYE[0x6];                                   // 0x00EA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_U5YF[0x110];                                 // 0x0110(0x0110) MISSED OFFSET (PADDING)
...
class UClass* ProtocolType
	...
	public:
		...
		unsigned char                                            UnknownData_B10T[0xB];                                   // 0x0221(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_7JMB[0x4];                                   // 0x023C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_51GP[0x78];                                  // 0x0060(0x0078) MISSED OFFSET (PADDING)
...
const struct FCapturedPixelsID& StreamID
);

		void ResolveBuffer(
class UTexture* Buffer
, 
const struct FCapturedPixelsID& BufferID
);
...
const struct FCapturedPixels& Pixels
, 
const struct FCapturedPixelsID& ID
, 
const struct FFrameMetrics& FrameMetrics
);
...
const struct FFrameMetrics& InFrameMetrics
);
	...
	public:
		...
		unsigned char                                            UnknownData_6VX0[0x2];                                   // 0x00DA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
const struct FCapturedPixels& PixelData
, 
const struct FCapturedPixelsID& StreamID
, 
const struct FFrameMetrics& FrameMetrics
...
const struct FCapturedPixelsID& StreamID
	...
	public:
		...
		unsigned char                                            UnknownData_5AG8[0x3];                                   // 0x0069(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_RJVP[0x10];                                  // 0x0070(0x0010) MISSED OFFSET (PADDING)
