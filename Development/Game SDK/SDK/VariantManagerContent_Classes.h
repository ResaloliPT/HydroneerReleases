...
namespace CG
{
	...
	public:
		...
		unsigned char                                            UnknownData_1XXL[0x50];                                  // 0x0040(0x0050) MISSED OFFSET (PADDING)


	public:

		class UVariantSet* GetVariantSetByName(
const class FString& VariantSetName
);
...
const class FString& VariantSetName
, 
const class FString& VariantName
);
...
bool bLoad
	...
	public:
		...
		unsigned char                                            UnknownData_WUK1[0x18];                                  // 0x0028(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_DM5U[0x60];                                  // 0x0028(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_QPJD[0x7];                                   // 0x0121(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_FFFR[0x8];                                   // 0x0130(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_DZ8B[0x6F];                                  // 0x0149(0x006F) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_S2ZS[0x18];                                  // 0x0220(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_RU8M[0x4];                                   // 0x0244(0x0004) MISSED OFFSET (PADDING)
...
int32_t OptionIndex
	...
	public:
		...
		unsigned char                                            UnknownData_M4YO[0x18];                                  // 0x0050(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
, 
const struct FTransform& CameraTransform
, 
float FOVDegrees
, 
float MinZ
...
float Gamma
		...
		void SetDisplayText(
const class FText& NewDisplayText
);
...
struct FVariantDependency* Dependency
	...
	public:
		...
		unsigned char                                            UnknownData_3R5F[0x4];                                   // 0x006C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_7KZI[0x18];                                  // 0x0040(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_LBDJ[0x7];                                   // 0x0059(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
