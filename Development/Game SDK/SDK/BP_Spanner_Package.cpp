...
namespace CG
{
	 ...
	 */
	void ABP_Spanner_C::LMBDownWhileCarrying(
...
class ABP_ParentItem_C* RepairingTool
	 ...
	 */
	void ABP_Spanner_C::FindDurability(
class ABP_ParentItem_C* Item
	 ...
	 */
	void ABP_Spanner_C::ReturnDurability(
float DurabilityAmount
	 ...
	 */
	void ABP_Spanner_C::OverrideHit(
class AActor* OtherActor
	 ...
	 */
	void ABP_Spanner_C::ExecuteUbergraph_BP_Spanner(
int32_t EntryPoint
)
	{
		static UFunction* fn = nullptr;
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ABP_Spanner_C.StaticClass
