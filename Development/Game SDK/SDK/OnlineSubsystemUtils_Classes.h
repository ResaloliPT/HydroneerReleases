...
bool* bHidden
	...
	public:
		...
		unsigned char                                            UnknownData_R0P2[0x18];                                  // 0x0050(0x0018) MISSED OFFSET (PADDING)


	public:

		class UAchievementQueryCallbackProxy* CacheAchievements(
class UObject* WorldContextObject
, 
class APlayerController* PlayerController
);
...
class APlayerController* PlayerController
	...
	public:
		...
		unsigned char                                            UnknownData_OYG7[0x30];                                  // 0x0050(0x0030) MISSED OFFSET (PADDING)


	public:

		class UAchievementWriteCallbackProxy* WriteAchievementProgress(
class UObject* WorldContextObject
, 
class APlayerController* PlayerController
, 
...
int32_t UserTag
	...
	public:
		...
		unsigned char                                            UnknownData_ZR3Z[0x28];                                  // 0x0050(0x0028) MISSED OFFSET (PADDING)


	public:

		class UConnectionCallbackProxy* ConnectToService(
class UObject* WorldContextObject
, 
class APlayerController* PlayerController
);
	...
	public:
		...
		unsigned char                                            UnknownData_EA9H[0x48];                                  // 0x0050(0x0048) MISSED OFFSET (PADDING)


	public:

		class UCreateSessionCallbackProxy* CreateSession(
class UObject* WorldContextObject
, 
class APlayerController* PlayerController
, 
...
bool bUseLAN
	...
	public:
		...
		unsigned char                                            UnknownData_XFBW[0x28];                                  // 0x0050(0x0028) MISSED OFFSET (PADDING)


	public:

		class UDestroySessionCallbackProxy* DestroySession(
class UObject* WorldContextObject
, 
class APlayerController* PlayerController
);
	...
	public:
		...
		unsigned char                                            UnknownData_J7XS[0x30];                                  // 0x0050(0x0030) MISSED OFFSET (PADDING)


	public:

		class UEndMatchCallbackProxy* EndMatch(
class UObject* WorldContextObject
, 
class APlayerController* PlayerController
, 
...
EMPMatchOutcome OtherPlayersOutcome
	...
	public:
		...
		unsigned char                                            UnknownData_YD4N[0x28];                                  // 0x0050(0x0028) MISSED OFFSET (PADDING)


	public:

		class UEndTurnCallbackProxy* EndTurn(
class UObject* WorldContextObject
, 
class APlayerController* PlayerController
, 
const class FString& MatchID
	...
	public:
		...
		unsigned char                                            UnknownData_UR51[0x40];                                  // 0x0050(0x0040) MISSED OFFSET (PADDING)
...
const struct FBlueprintSessionResult& Result
		...
		int32_t GetCurrentPlayers(
const struct FBlueprintSessionResult& Result
);

		class UFindSessionsCallbackProxy* FindSessions(
class UObject* WorldContextObject
, 
class APlayerController* PlayerController
, 
...
bool bUseLAN
	...
	public:
		...
		unsigned char                                            UnknownData_64SS[0x38];                                  // 0x0050(0x0038) MISSED OFFSET (PADDING)


	public:

		class UFindTurnBasedMatchCallbackProxy* FindTurnBasedMatch(
class UObject* WorldContextObject
, 
class APlayerController* PlayerController
, 
...
bool ShowExistingMatches
	...
	public:
		...
		unsigned char                                            UnknownData_ADRG[0x38];                                  // 0x0048(0x0038) MISSED OFFSET (PADDING)


	public:

		class UInAppPurchaseCallbackProxy* CreateProxyObjectForInAppPurchase(
class APlayerController* PlayerController
, 
const struct FInAppPurchaseProductRequest& ProductRequest
	...
	public:
		...
		unsigned char                                            UnknownData_Z7TQ[0x60];                                  // 0x0048(0x0060) MISSED OFFSET (PADDING)
...
const struct FInAppPurchaseProductRequest2& ProductRequest
	...
	public:
		...
		unsigned char                                            UnknownData_XZHN[0x48];                                  // 0x0048(0x0048) MISSED OFFSET (PADDING)


	public:

		class UInAppPurchaseQueryCallbackProxy* CreateProxyObjectForInAppPurchaseQuery(
class APlayerController* PlayerController
, 
TArray<class FString> ProductIdentifiers
	...
	public:
		...
		unsigned char                                            UnknownData_B4OM[0x20];                                  // 0x0048(0x0020) MISSED OFFSET (PADDING)
...
TArray<class FString> ProductIdentifiers
	...
	public:
		...
		unsigned char                                            UnknownData_W7JJ[0x48];                                  // 0x0048(0x0048) MISSED OFFSET (PADDING)


	public:

		class UInAppPurchaseRestoreCallbackProxy* CreateProxyObjectForInAppPurchaseRestore(
...
class APlayerController* PlayerController
	...
	public:
		...
		unsigned char                                            UnknownData_AWJP[0x60];                                  // 0x0048(0x0060) MISSED OFFSET (PADDING)
...
class APlayerController* PlayerController
	...
	public:
		...
		unsigned char                                            UnknownData_ZKUV[0x50];                                  // 0x1AF0(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_VPT0[0x4C];                                  // 0x1B44(0x004C) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_DATN[0x3];                                   // 0x0749(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_V7FX[0xC];                                   // 0x0750(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_SCMV[0x4];                                   // 0x076C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_TB8O[0x38];                                  // 0x0780(0x0038) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_HZ1R[0x130];                                 // 0x0050(0x0130) MISSED OFFSET (PADDING)


	public:

		class UJoinSessionCallbackProxy* JoinSession(
class UObject* WorldContextObject
, 
class APlayerController* PlayerController
, 
...
int32_t StatValue
	...
	public:
		...
		unsigned char                                            UnknownData_FFZE[0x20];                                  // 0x0048(0x0020) MISSED OFFSET (PADDING)
...
const class FName& SessionName
	...
	public:
		...
		unsigned char                                            UnknownData_IET2[0x50];                                  // 0x0048(0x0050) MISSED OFFSET (PADDING)
...
const class FName& StatName
	...
	public:
		...
		unsigned char                                            UnknownData_1BD4[0x18];                                  // 0x0050(0x0018) MISSED OFFSET (PADDING)


	public:

		class ULogoutCallbackProxy* Logout(
class UObject* WorldContextObject
, 
class APlayerController* PlayerController
);
	...
	public:
		...
		unsigned char                                            UnknownData_XDA0[0x8];                                   // 0x0220(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_2Q3L[0x18];                                  // 0x0238(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_UH7T[0x4F];                                  // 0x0261(0x004F) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_IWRS[0x4];                                   // 0x0254(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)


		TArray<class AOnlineBeaconClient*>                       ClientActors;                                            // 0x0258(0x0010) ZeroConstructor, NativeAccessSpecifierPrivate


		unsigned char                                            UnknownData_VGV1[0xA0];                                  // 0x0268(0x00A0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_VXIJ[0xF8];                                  // 0x0030(0x00F8) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_V77J[0x7];                                   // 0x0039(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_T5QG[0x1B0];                                 // 0x0028(0x01B0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_VNGJ[0x6];                                   // 0x01DA(0x0006) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_MI60[0x30];                                  // 0x02B0(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_C687[0x2D];                                  // 0x0343(0x002D) MISSED OFFSET (PADDING)
...
EPartyReservationResult ReservationResponse
	...
	public:
		...
		unsigned char                                            UnknownData_JRQU[0x60];                                  // 0x0250(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_DQZD[0x3];                                   // 0x02B1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_10HV[0x4];                                   // 0x02BC(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_O0LZ[0x6];                                   // 0x0052(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_30ZK[0x10];                                  // 0x0068(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_EE5V[0x28];                                  // 0x0050(0x0028) MISSED OFFSET (PADDING)


	public:

		class UQuitMatchCallbackProxy* QuitMatch(
class UObject* WorldContextObject
, 
class APlayerController* PlayerController
, 
...
int32_t TurnTimeoutInSeconds
	...
	public:
		...
		unsigned char                                            UnknownData_ENCF[0x10];                                  // 0x0050(0x0010) MISSED OFFSET (PADDING)
...
class APlayerController* InPlayerController
	...
	public:
		...
		unsigned char                                            UnknownData_B5D4[0x30];                                  // 0x02B0(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_DJO3[0x2D];                                  // 0x036B(0x002D) MISSED OFFSET (PADDING)
...
ESpectatorReservationResult ReservationResponse
	...
	public:
		...
		unsigned char                                            UnknownData_SHQ9[0x60];                                  // 0x0250(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)


		bool                                                     bLogoutOnSessionTimeout;                                 // 0x02B0(0x0001) ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected


		unsigned char                                            UnknownData_Q1SZ[0x3];                                   // 0x02B1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_9NFK[0x4];                                   // 0x02BC(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_QPO5[0x7];                                   // 0x0039(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_3LVH[0x10];                                  // 0x0050(0x0010) MISSED OFFSET (PADDING)
...
bool* bIsMyTurn
	...
	public:
		...
		unsigned char                                            UnknownData_Y2DM[0x60];                                  // 0x06C0(0x0060) MISSED OFFSET (PADDING)
