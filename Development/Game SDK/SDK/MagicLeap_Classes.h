...
namespace CG
{
	...
	public:
		...
		unsigned char                                            UnknownData_EUUN[0x8];                                   // 0x0120(0x0008) MISSED OFFSET (PADDING)
...
TArray<struct FPurchaseItemDetails> ItemsDetails
	...
	public:
		...
		unsigned char                                            UnknownData_14KX[0x50];                                  // 0x0180(0x0050) MISSED OFFSET (PADDING)
...
struct FMagicLeapHeadTrackingState* State
		...
		bool GetGraphicsClientPerformanceInfo(
struct FMagicLeapGraphicsClientPerformanceInfo* PerformanceInfo
	...
	public:
		...
		unsigned char                                            UnknownData_JJ7R[0x8];                                   // 0x01F8(0x0008) Fix Super Size
		...
		unsigned char                                            UnknownData_GPJY[0x6];                                   // 0x0212(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_9JM9[0x3];                                   // 0x0221(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_57S6[0x3];                                   // 0x0229(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_DFM8[0x5];                                   // 0x0233(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_DHN3[0x7];                                   // 0x0269(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_663N[0x14];                                  // 0x027C(0x0014) MISSED OFFSET (PADDING)
...
class UMRMeshComponent* InMRMeshPtr
	...
	public:
		...
		unsigned char                                            UnknownData_NWIG[0x5];                                   // 0x002B(0x0005) MISSED OFFSET (PADDING)
...
TArray<struct FMagicLeapMeshBlockRequest>* RequestedMesh
	...
	public:
		...
		unsigned char                                            UnknownData_RJOQ[0x68];                                  // 0x00B0(0x0068) MISSED OFFSET (PADDING)
...
const struct FMagicLeapRaycastHitResult& HitResult
	...
	public:
		...
		struct FMagicLeapRaycastQueryParams MakeRaycastQueryParams(
