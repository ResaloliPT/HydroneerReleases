...
namespace CG
{
	...
	/**
	 * BlueprintGeneratedClass BP_VegetableBasket.BP_VegetableBasket_C
	...
	public:
		...
		unsigned char                                            UnknownData_ZQKE[0x7];                                   // 0x03C9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
int32_t OtherBodyIndex
		...
		void ExecuteUbergraph_BP_VegetableBasket(
int32_t EntryPoint
);
