...
bool bEnable
		...
		EXRDeviceConnectionResult ConnectRemoteXRDevice(
...
const struct FTransform& ExternalTrackingTransform
	...
	public:
		...
		unsigned char                                            UnknownData_5ADB[0x3];                                   // 0x0445(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_KPAI[0x3];                                   // 0x0451(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_EMAX[0x2];                                   // 0x0456(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_ZT8V[0x68];                                  // 0x0478(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_A7QO[0x18];                                  // 0x04E8(0x0018) MISSED OFFSET (PADDING)
...
bool* bValueFound
		...
		struct FVector GetHandJointPosition(
int32_t jointIndex
, 
bool* bValueFound
);
...
class UMotionControllerComponent* MotionControllerComponent
	...
	public:
		...
		class UPrimitiveComponent* AddNamedDeviceVisualizationComponentBlocking(
class AActor* Target
, 
...
struct FXRDeviceId* XRDeviceId
		...
		class UPrimitiveComponent* AddDeviceVisualizationComponentBlocking(
class AActor* Target
, 
const struct FXRDeviceId& XRDeviceId
, 
...
const struct FTransform& RelativeTransform
	...
	public:
		...
		unsigned char                                            UnknownData_LX7L[0x8];                                   // 0x0050(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		class UAsyncTask_LoadXRDeviceVisComponent* AddNamedDeviceVisualizationComponentAsync(
class AActor* Target
, 
const class FName& SystemName
, 
...
class UPrimitiveComponent** NewComponent
		...
		class UAsyncTask_LoadXRDeviceVisComponent* AddDeviceVisualizationComponentAsync(
class AActor* Target
, 
const struct FXRDeviceId& XRDeviceId
, 
