...
namespace CG
{
	 ...
	 */
	void ABP_Rake_C::TestDepthLocation(
...
bool* CanModify
	 ...
	 */
	float ABP_Rake_C::TestAreaDensity(
class USceneComponent* Component
	 ...
	 */
	void ABP_Rake_C::GetPlayerCameraInfo(
struct FVector* Location
, 
...
struct FRotator* Rotation
	 ...
	 */
	void ABP_Rake_C::TryFindVoxelWorldHit(
...
class ABP_HydroVoxelWorld_C** VoxelWorld
	 ...
	 */
	struct FVoxelIntBox ABP_Rake_C::GetBoxBoundsInVoxel(
...
float Bounds
	 ...
	 */
	struct FRotator ABP_Rake_C::NormalToClampedRotation(
...
class ABP_GameController_C* Controller
	 ...
	 */
	void ABP_Rake_C::LMBDownWhileCarrying(
class ABP_GameController_C* Controller
, 
...
bool* Result
	 ...
	 */
	void ABP_Rake_C::OverrideDroppedItem(
class ABP_GameCharacter_C* Character
	 ...
	 * 		struct FVector                                     HitLocation                                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void ABP_Rake_C::RMBDownWhileCarrying(
class ABP_GameController_C* Controller
, 
...
const struct FVector& HitLocation
	 ...
	 */
	void ABP_Rake_C::ExecuteUbergraph_BP_Rake(
int32_t EntryPoint
)
	{
		static UFunction* fn = nullptr;
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ABP_Rake_C.StaticClass
