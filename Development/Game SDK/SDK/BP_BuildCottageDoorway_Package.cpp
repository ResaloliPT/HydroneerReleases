...
namespace CG
{
	 ...
	 */
	void ABP_BuildCottageDoorway_C::LMBDownIsTarget(
...
class ABP_GameController_C* Insigator
	 ...
	 */
	void ABP_BuildCottageDoorway_C::ExecuteUbergraph_BP_BuildCottageDoorway(
int32_t EntryPoint
)
	{
		static UFunction* fn = nullptr;
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ABP_BuildCottageDoorway_C.StaticClass
