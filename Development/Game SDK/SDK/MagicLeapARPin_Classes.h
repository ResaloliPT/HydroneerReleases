...
namespace CG
{
	...
	public:
		...
		unsigned char                                            UnknownData_N6L6[0x2];                                   // 0x020E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_XH6P[0xF0];                                  // 0x02C0(0x00F0) MISSED OFFSET (PADDING)
	...
	public:
		...
		class UMagicLeapARPinSaveGame* TryGetPinData(
...
bool bRestoredOrSynced
		...
		void MagicLeapARPinDataLoadAttemptCompleted__DelegateSignature(
bool bDataRestored
);
...
struct FGuid* PinId
		...
		class UMagicLeapARPinSaveGame* GetPinData(
class UClass* PinDataClass
	...
	public:
		...
		void UnBindToOnMagicLeapContentBindingFoundDelegate(
...
const class FScriptDelegate& Delegate
		...
		EMagicLeapPassableWorldError SetGlobalQueryFilter(
const struct FMagicLeapARPinQuery& InGlobalFilter
);

		void SetContentBindingSaveGameUserIndex(
int32_t UserIndex
);

		EMagicLeapPassableWorldError QueryARPins(
const struct FMagicLeapARPinQuery& Query
, 
TArray<struct FGuid>* Pins
);

		bool ParseStringToARPinId(
...
int32_t* Count
		...
		EMagicLeapPassableWorldError GetGlobalQueryFilter(
struct FMagicLeapARPinQuery* CurrentGlobalFilter
);

		int32_t GetContentBindingSaveGameUserIndex();

		EMagicLeapPassableWorldError GetClosestARPin(
...
TArray<struct FGuid>* Pins
		...
		class FString GetARPinStateToString(
...
bool* PinFoundInEnvironment
		...
		bool GetARPinPositionAndOrientation(
const struct FGuid& PinId
, 
struct FVector* Position
, 
...
const struct FGuid& ARPinId
	...
	public:
		...
		unsigned char                                            UnknownData_1WP8[0x7];                                   // 0x0231(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_GAPV[0x7];                                   // 0x0221(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)


		TMap<struct FGuid, class AMagicLeapARPinInfoActorBase*>  AllInfoActors;                                           // 0x0228(0x0050) NativeAccessSpecifierPrivate


		unsigned char                                            UnknownData_P8Q6[0x8];                                   // 0x0278(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
bool InVisibilityOverride
	...
	public:
		...
		unsigned char                                            UnknownData_78BM[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_G8XM[0xF];                                   // 0x00A1(0x000F) MISSED OFFSET (PADDING)
