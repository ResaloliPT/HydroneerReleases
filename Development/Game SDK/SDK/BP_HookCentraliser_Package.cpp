...
namespace CG
{
	 ...
	 */
	void ABP_HookCentraliser_C::HookFunctionality(
...
const struct FHitResult& SweepResult
	 ...
	 */
	void ABP_HookCentraliser_C::ExecuteUbergraph_BP_HookCentraliser(
int32_t EntryPoint
)
	{
		static UFunction* fn = nullptr;
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ABP_HookCentraliser_C.StaticClass
