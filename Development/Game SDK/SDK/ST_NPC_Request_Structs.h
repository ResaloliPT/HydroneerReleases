...
namespace CG
{
	...
	public:
		...
		unsigned char                                            UnknownData_BKUL[0x4];                                   // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		bool                                                     RandomizeContents__CA9F1A5A4050A4640A1006ABCFFCBAC9;     // 0x002C(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
