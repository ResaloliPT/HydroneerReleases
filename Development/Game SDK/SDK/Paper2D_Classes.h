...
namespace CG
{
	...
	public:
		...
		unsigned char                                            UnknownData_WBK8[0x3];                                   // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_IMVS[0x4];                                   // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_8LHM[0x7];                                   // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
int32_t Index
		...
		class UPaperSprite* GetSpriteAtTime(
float Time
, 
bool bClampToEnds
);

		class UPaperSprite* GetSpriteAtFrame(
int32_t FrameIndex
);
		...
		int32_t GetKeyFrameIndexAtTime(
float Time
, 
bool bClampToEnds
);
	...
	public:
		...
		unsigned char                                            UnknownData_JFUM[0x3];                                   // 0x047D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
class UPaperFlipbook* OldFlipbook
	...
	public:
		...
		unsigned char                                            UnknownData_J4KJ[0x18];                                  // 0x0488(0x0018) MISSED OFFSET (PADDING)
...
const struct FLinearColor& Color
	...
	public:
		...
		unsigned char                                            UnknownData_UO7Q[0x5];                                   // 0x002B(0x0005) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_D7CB[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_BGFY[0x3];                                   // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_A11U[0x4];                                   // 0x0094(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		struct FSlateBrush MakeBrushFromSprite(
class UPaperSprite* Sprite
, 
int32_t Width
, 
int32_t Height
	...
	public:
		...
		unsigned char                                            UnknownData_UCJM[0x8];                                   // 0x0488(0x0008) MISSED OFFSET (PADDING)
...
class UPaperSprite* NewSprite
	...
	public:
		...
		unsigned char                                            UnknownData_NGD0[0x6];                                   // 0x044A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_B9R3[0x3];                                   // 0x0475(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_06Q8[0x4];                                   // 0x047C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_GKS2[0x18];                                  // 0x0488(0x0018) MISSED OFFSET (PADDING)
...
const struct FLinearColor& NewColor
	...
	public:
		...
		unsigned char                                            UnknownData_1PKX[0x10];                                  // 0x0540(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_F6NC[0x3];                                   // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_JRPJ[0x4];                                   // 0x006C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_N8OD[0x2];                                   // 0x008E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_8AUP[0x4];                                   // 0x0094(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_07EP[0x4];                                   // 0x00A4(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_LI2W[0x4];                                   // 0x0468(0x0004) Fix Super Size
		...
		unsigned char                                            UnknownData_49FJ[0x3];                                   // 0x04AD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_BCT9[0x8];                                   // 0x04B8(0x0008) MISSED OFFSET (PADDING)
...
bool bWorldSpace
		...
		struct FVector GetTileCornerPosition(
int32_t TileX
, 
int32_t TileY
, 
...
bool bWorldSpace
		...
		struct FVector GetTileCenterPosition(
int32_t TileX
, 
int32_t TileY
, 
...
bool bCreateLayer
	...
	public:
		...
		struct FPaperTileInfo MakeTile(
int32_t TileIndex
, 
...
bool bFlipD
		...
		class FName GetTileUserData(
const struct FPaperTileInfo& Tile
);

		struct FTransform GetTileTransform(
const struct FPaperTileInfo& Tile
);
