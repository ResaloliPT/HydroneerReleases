...
namespace CG
{
	...
	public:
		...
		unsigned char                                            UnknownData_5VKW[0x3];                                   // 0x00B5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_R1IH[0x27];                                  // 0x00D1(0x0027) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
const class FName& WidgetToFocus
		...
		struct FEventReply OnPointerEvent__DelegateSignature(
...
bool bForce
	...
	public:
		...
		unsigned char                                            UnknownData_HA5U[0x8];                                   // 0x0108(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_FK3B[0x18];                                  // 0x0178(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_R5EW[0xB];                                   // 0x01E5(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_ZAMF[0x7];                                   // 0x01F1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_7U3F[0x50];                                  // 0x0210(0x0050) MISSED OFFSET (PADDING)
...
class UWidgetAnimation* InAnimation
		...
		struct FEventReply OnTouchStarted(
const struct FGeometry& MyGeometry
, 
const struct FPointerEvent& InTouchEvent
);

		struct FEventReply OnTouchMoved(
const struct FGeometry& MyGeometry
, 
const struct FPointerEvent& InTouchEvent
);

		struct FEventReply OnTouchGesture(
const struct FGeometry& MyGeometry
, 
const struct FPointerEvent& GestureEvent
);

		struct FEventReply OnTouchForceChanged(
const struct FGeometry& MyGeometry
, 
const struct FPointerEvent& InTouchEvent
);

		struct FEventReply OnTouchEnded(
const struct FGeometry& MyGeometry
, 
const struct FPointerEvent& InTouchEvent
);
...
const struct FFocusEvent& InFocusEvent
		...
		struct FEventReply OnPreviewMouseButtonDown(
const struct FGeometry& MyGeometry
, 
const struct FPointerEvent& MouseEvent
);

		struct FEventReply OnPreviewKeyDown(
const struct FGeometry& MyGeometry
, 
...
struct FPaintContext* Context
		...
		struct FEventReply OnMouseWheel(
const struct FGeometry& MyGeometry
, 
const struct FPointerEvent& MouseEvent
);

		struct FEventReply OnMouseMove(
const struct FGeometry& MyGeometry
, 
const struct FPointerEvent& MouseEvent
);
...
const struct FPointerEvent& MouseEvent
		...
		struct FEventReply OnMouseButtonUp(
const struct FGeometry& MyGeometry
, 
const struct FPointerEvent& MouseEvent
);

		struct FEventReply OnMouseButtonDown(
const struct FGeometry& MyGeometry
, 
const struct FPointerEvent& MouseEvent
);
...
const struct FPointerEvent& InMouseEvent
		...
		struct FEventReply OnMotionDetected(
const struct FGeometry& MyGeometry
, 
const struct FMotionEvent& InMotionEvent
);

		struct FEventReply OnKeyUp(
const struct FGeometry& MyGeometry
, 
const struct FKeyEvent& InKeyEvent
);

		struct FEventReply OnKeyDown(
const struct FGeometry& MyGeometry
, 
const struct FKeyEvent& InKeyEvent
);

		struct FEventReply OnKeyChar(
const struct FGeometry& MyGeometry
, 
const struct FCharacterEvent& InCharacterEvent
		...
		struct FEventReply OnFocusReceived(
const struct FGeometry& MyGeometry
, 
const struct FFocusEvent& InFocusEvent
);
...
class UWidgetAnimation* Animation
		...
		struct FEventReply OnAnalogValueChanged(
const struct FGeometry& MyGeometry
, 
...
const class FString& URL
	...
	public:
		...
		unsigned char                                            UnknownData_L03Y[0x8];                                   // 0x0118(0x0008) MISSED OFFSET (PADDING)
...
class UWidget* Content
	...
	public:
		...
		unsigned char                                            UnknownData_EOVQ[0x1];                                   // 0x0133(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_6O7M[0x3];                                   // 0x0139(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_K4WQ[0x10];                                  // 0x01C8(0x0010) MISSED OFFSET (PADDING)
...
bool bInApplyAlphaToBlur
	...
	public:
		...
		unsigned char                                            UnknownData_F7R9[0x16];                                  // 0x004A(0x0016) MISSED OFFSET (PADDING)
...
EHorizontalAlignment InHorizontalAlignment
	...
	public:
		...
		unsigned char                                            UnknownData_2VDY[0x1];                                   // 0x0123(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_Q9RM[0x4];                                   // 0x0154(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_GG9K[0x3];                                   // 0x0219(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_WNEA[0x14];                                  // 0x025C(0x0014) MISSED OFFSET (PADDING)
...
const struct FSlateBrush& InBrush
	...
	public:
		...
		unsigned char                                            UnknownData_6W0E[0x16];                                  // 0x004A(0x0016) MISSED OFFSET (PADDING)
...
EHorizontalAlignment InHorizontalAlignment
	...
	public:
		...
		unsigned char                                            UnknownData_MG0D[0x8];                                   // 0x0060(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_HZ39[0x4];                                   // 0x03C4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_3NSE[0x10];                                  // 0x0418(0x0010) MISSED OFFSET (PADDING)
...
const struct FLinearColor& InBackgroundColor
	...
	public:
		...
		unsigned char                                            UnknownData_4PQ6[0x16];                                  // 0x004A(0x0016) MISSED OFFSET (PADDING)
...
EHorizontalAlignment InHorizontalAlignment
	...
	public:
		...
		unsigned char                                            UnknownData_XHBS[0x10];                                  // 0x0120(0x0010) MISSED OFFSET (PADDING)


	public:

		class UCanvasPanelSlot* AddChildToCanvas(
class UWidget* Content
);
	...
	public:
		...
		unsigned char                                            UnknownData_8F66[0x3];                                   // 0x0061(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_HAWZ[0x8];                                   // 0x0068(0x0008) MISSED OFFSET (PADDING)
...
const struct FVector2D& InAlignment
	...
	public:
		...
		unsigned char                                            UnknownData_L4TY[0x3];                                   // 0x0121(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_CYBZ[0x4];                                   // 0x0134(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_E2MR[0x3];                                   // 0x0709(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)


		struct FMargin                                           Padding;                                                 // 0x070C(0x0010) ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic


		unsigned char                                            UnknownData_960M[0x4];                                   // 0x071C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_21PH[0x4];                                   // 0x074C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_AM3X[0x10];                                  // 0x0760(0x0010) MISSED OFFSET (PADDING)
...
ECheckBoxState InCheckedState
	...
	public:
		...
		unsigned char                                            UnknownData_LWOU[0x8];                                   // 0x0060(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_30MN[0x4];                                   // 0x0114(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_BRU7[0x17];                                  // 0x01A9(0x0017) MISSED OFFSET (PADDING)
...
int32_t InNumberOfPieces
	...
	public:
		...
		unsigned char                                            UnknownData_ASTV[0x8];                                   // 0x0060(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_NMRC[0x17];                                  // 0x0129(0x0017) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_5FX8[0x2];                                   // 0x0CF6(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_OVV6[0x3];                                   // 0x0D79(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_AKY7[0x4];                                   // 0x0D8C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_WYQZ[0x50];                                  // 0x0DB0(0x0050) MISSED OFFSET (PADDING)
...
const class FString& Option
	...
	public:
		...
		unsigned char                                            UnknownData_T45G[0x3];                                   // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_E4XE[0x4];                                   // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
const struct FPointerEvent& PointerEvent
	...
	public:
		...
		unsigned char                                            UnknownData_22L1[0x3];                                   // 0x0109(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_1VRX[0x4];                                   // 0x0114(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_06NY[0x2];                                   // 0x0132(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_Z6Q6[0x14];                                  // 0x0144(0x0014) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
class UClass* EntryClass
	...
	public:
		...
		unsigned char                                            UnknownData_UN7F[0x2];                                   // 0x041A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_1P0J[0x2];                                   // 0x042E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_0VPZ[0x10];                                  // 0x0450(0x0010) MISSED OFFSET (PADDING)
...
const class FText& Text
	...
	public:
		...
		unsigned char                                            UnknownData_Z6EK[0x2];                                   // 0x09E2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_Y44S[0x2];                                   // 0x0A06(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_KLTO[0x10];                                  // 0x0A28(0x0010) MISSED OFFSET (PADDING)
...
const class FText& Text
	...
	public:
		...
		unsigned char                                            UnknownData_X2K1[0x8];                                   // 0x0108(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_8A62[0x3];                                   // 0x02E1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_U3ML[0x10];                                  // 0x0328(0x0010) MISSED OFFSET (PADDING)
...
bool IsExpanded
	...
	public:
		...
		unsigned char                                            UnknownData_MGXQ[0x10];                                  // 0x0140(0x0010) MISSED OFFSET (PADDING)
...
float Coefficient
		...
		class UGridSlot* AddChildToGrid(
class UWidget* Content
, 
int32_t InRow
, 
int32_t InColumn
	...
	public:
		...
		unsigned char                                            UnknownData_GX6H[0x2];                                   // 0x004A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_DEVG[0x8];                                   // 0x0068(0x0008) MISSED OFFSET (PADDING)
...
int32_t InColumn
	...
	public:
		...
		unsigned char                                            UnknownData_TAEU[0x10];                                  // 0x0120(0x0010) MISSED OFFSET (PADDING)


	public:

		class UHorizontalBoxSlot* AddChildToHorizontalBox(
class UWidget* Content
);
	...
	public:
		...
		unsigned char                                            UnknownData_H2L9[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_UWI2[0x6];                                   // 0x005A(0x0006) MISSED OFFSET (PADDING)
...
EHorizontalAlignment InHorizontalAlignment
	...
	public:
		...
		unsigned char                                            UnknownData_TO1I[0x3];                                   // 0x01C1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_K7PR[0x3C];                                  // 0x01D4(0x003C) MISSED OFFSET (PADDING)
...
const struct FSlateBrush& InBrush
	...
	public:
		...
		unsigned char                                            UnknownData_CJCV[0x6];                                   // 0x06BA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_2OF6[0x10];                                  // 0x06F0(0x0010) MISSED OFFSET (PADDING)
...
const struct FInputChord& SelectedKey
	...
	public:
		...
		unsigned char                                            UnknownData_SO46[0x16];                                  // 0x0122(0x0016) MISSED OFFSET (PADDING)
...
class UObject* ListItemObject
	...
	public:
		...
		unsigned char                                            UnknownData_AGFN[0x2];                                   // 0x0116(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_HAW7[0x4];                                   // 0x011C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_JWMK[0x58];                                  // 0x01C0(0x0058) MISSED OFFSET (PADDING)
...
ESlateVisibility InVisibility
	...
	public:
		...
		unsigned char                                            UnknownData_7IKK[0xC0];                                  // 0x0218(0x00C0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_E79P[0x3];                                   // 0x02DD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_AWLA[0x3];                                   // 0x02E5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)


		TArray<class UObject*>                                   ListItems;                                               // 0x02E8(0x0010) ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected


		unsigned char                                            UnknownData_9QT5[0x10];                                  // 0x02F8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
class UObject* Item
	...
	public:
		...
		unsigned char                                            UnknownData_1OB9[0x4];                                   // 0x014C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_ZXSF[0x10];                                  // 0x0160(0x0010) MISSED OFFSET (PADDING)
...
bool bFit
	...
	public:
		...
		unsigned char                                            UnknownData_ZQI9[0x8];                                   // 0x00E8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)


		struct FMovieScene2DTransformMask                        TransformMask;                                           // 0x00F0(0x0004) NoDestructor, NativeAccessSpecifierPublic


		unsigned char                                            UnknownData_PQ0V[0x4];                                   // 0x00F4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_R0SD[0x8];                                   // 0x00A8(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_9FHL[0x8];                                   // 0x0088(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_8JLN[0x2];                                   // 0x010E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
ETextJustify InJustification
	...
	public:
		...
		unsigned char                                            UnknownData_6W6C[0x7];                                   // 0x03D9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_HQLF[0x1];                                   // 0x043F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_4133[0x10];                                  // 0x0460(0x0010) MISSED OFFSET (PADDING)
...
const class FText& Text
	...
	public:
		...
		unsigned char                                            UnknownData_6528[0x4];                                   // 0x0BD4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_A8BC[0x10];                                  // 0x0C88(0x0010) MISSED OFFSET (PADDING)
...
const class FText& Text
	...
	public:
		...
		unsigned char                                            UnknownData_JT7H[0x10];                                  // 0x0120(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_G4XT[0x10];                                  // 0x0108(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_89C2[0x10];                                  // 0x0120(0x0010) MISSED OFFSET (PADDING)


	public:

		class UOverlaySlot* AddChildToOverlay(
class UWidget* Content
);
	...
	public:
		...
		unsigned char                                            UnknownData_B468[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_MVV3[0x6];                                   // 0x0052(0x0006) MISSED OFFSET (PADDING)
...
EHorizontalAlignment InHorizontalAlignment
	...
	public:
		...
		unsigned char                                            UnknownData_SGS3[0x2];                                   // 0x02CE(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_CW20[0x10];                                  // 0x0308(0x0010) MISSED OFFSET (PADDING)
...
const struct FLinearColor& InColor
	...
	public:
		...
		unsigned char                                            UnknownData_NXQZ[0x1];                                   // 0x0123(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_E0HV[0x4];                                   // 0x012C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_EJSK[0x10];                                  // 0x0140(0x0010) MISSED OFFSET (PADDING)
...
class UMaterialInterface* EffectMaterial
	...
	public:
		...
		unsigned char                                            UnknownData_6VUU[0x7];                                   // 0x0159(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_HHNE[0x3];                                   // 0x03D5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_ZM2Z[0x20];                                  // 0x0658(0x0020) MISSED OFFSET (PADDING)
...
class UClass* DecoratorClass
	...
	public:
		...
		unsigned char                                            UnknownData_GCNW[0x14];                                  // 0x0124(0x0014) MISSED OFFSET (PADDING)
...
bool InPadBottom
	...
	public:
		...
		unsigned char                                            UnknownData_1JYQ[0x3];                                   // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_3F13[0x2];                                   // 0x004E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_2GMO[0x2];                                   // 0x0122(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_2HDL[0x17];                                  // 0x0129(0x0017) MISSED OFFSET (PADDING)
...
bool bInIgnoreInheritedScale
	...
	public:
		...
		unsigned char                                            UnknownData_SS9Z[0x16];                                  // 0x004A(0x0016) MISSED OFFSET (PADDING)
...
EHorizontalAlignment InHorizontalAlignment
	...
	public:
		...
		unsigned char                                            UnknownData_JQLC[0x1];                                   // 0x05E3(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_6RH1[0x14];                                  // 0x05FC(0x0014) MISSED OFFSET (PADDING)
...
float InThumbSizeFraction
	...
	public:
		...
		unsigned char                                            UnknownData_SJR9[0x1];                                   // 0x082B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_QQ6T[0x3];                                   // 0x0849(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_6GEO[0x2];                                   // 0x0852(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_R95K[0x18];                                  // 0x0868(0x0018) MISSED OFFSET (PADDING)
...
float Padding
	...
	public:
		...
		unsigned char                                            UnknownData_HUYU[0xE];                                   // 0x004A(0x000E) MISSED OFFSET (PADDING)
...
EHorizontalAlignment InHorizontalAlignment
	...
	public:
		...
		unsigned char                                            UnknownData_E9NV[0x10];                                  // 0x0120(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_BL1W[0x7];                                   // 0x0151(0x0007) MISSED OFFSET (PADDING)
...
float InHeightOverride
	...
	public:
		...
		unsigned char                                            UnknownData_XTTE[0x10];                                  // 0x0048(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_TCDM[0x6];                                   // 0x005A(0x0006) MISSED OFFSET (PADDING)
...
EHorizontalAlignment InHorizontalAlignment
	...
	public:
		...
		struct FVector2D TransformVectorLocalToAbsolute(
const struct FGeometry& Geometry
, 
const struct FVector2D& LocalVector
);

		struct FVector2D TransformVectorAbsoluteToLocal(
const struct FGeometry& Geometry
, 
...
struct FVector2D* ViewportPosition
		...
		struct FVector2D LocalToAbsolute(
const struct FGeometry& Geometry
, 
const struct FVector2D& LocalCoordinate
);
...
const struct FVector2D& AbsoluteCoordinate
		...
		struct FVector2D GetLocalTopLeft(
const struct FGeometry& Geometry
);
...
struct FVector2D* ViewportPosition
		...
		struct FVector2D AbsoluteToLocal(
const struct FGeometry& Geometry
, 
const struct FVector2D& AbsoluteCoordinate
);
	...
	public:
		...
		unsigned char                                            UnknownData_YW8M[0x5];                                   // 0x002B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_L6S1[0x4];                                   // 0x0124(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_4P9H[0x3];                                   // 0x0469(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_E3D1[0x3];                                   // 0x0495(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_FOH2[0x10];                                  // 0x04E8(0x0010) MISSED OFFSET (PADDING)
...
bool InValue
	...
	public:
		...
		unsigned char                                            UnknownData_TPZK[0x10];                                  // 0x0110(0x0010) MISSED OFFSET (PADDING)
...
const struct FVector2D& InSize
	...
	public:
		...
		unsigned char                                            UnknownData_SL5H[0x4];                                   // 0x011C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_SX6Y[0x3];                                   // 0x0419(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_OLJ0[0x4];                                   // 0x0424(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_6MH8[0x3];                                   // 0x0481(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_MCA6[0x6];                                   // 0x048A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_H8HO[0x3];                                   // 0x04F9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_2RNI[0x14];                                  // 0x050C(0x0014) MISSED OFFSET (PADDING)
...
float InValue
	...
	public:
		...
		unsigned char                                            UnknownData_FT0S[0x8];                                   // 0x0060(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_I5XH[0x10];                                  // 0x0298(0x0010) MISSED OFFSET (PADDING)
...
bool InAutoTextWrap
	...
	public:
		...
		unsigned char                                            UnknownData_X1J0[0x1];                                   // 0x010F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_HLRZ[0x10];                                  // 0x01A0(0x0010) MISSED OFFSET (PADDING)
...
bool bInAnimateHorizontally
	...
	public:
		...
		unsigned char                                            UnknownData_QBEU[0x16];                                  // 0x0372(0x0016) MISSED OFFSET (PADDING)
...
float NewHeight
	...
	public:
		...
		unsigned char                                            UnknownData_CR7Q[0x10];                                  // 0x0368(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_A6QN[0x28];                                  // 0x0398(0x0028) MISSED OFFSET (PADDING)
...
bool bExpandItem
	...
	public:
		...
		unsigned char                                            UnknownData_TB3C[0x3E8];                                 // 0x0028(0x03E8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_LSM1[0x8];                                   // 0x0418(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)


		struct FMovieSceneRootEvaluationTemplateInstance         RootTemplateInstance;                                    // 0x0420(0x00E8) NativeAccessSpecifierPrivate


		unsigned char                                            UnknownData_38M6[0x70];                                  // 0x0508(0x0070) MISSED OFFSET (PADDING)
...
const class FName& InUserTag
	...
	public:
		...
		unsigned char                                            UnknownData_YWVX[0xA0];                                  // 0x0080(0x00A0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_2TWI[0x10];                                  // 0x0138(0x0010) MISSED OFFSET (PADDING)
...
float InMinDesiredSlotHeight
		...
		class UUniformGridSlot* AddChildToUniformGrid(
class UWidget* Content
, 
int32_t InRow
, 
int32_t InColumn
	...
	public:
		...
		unsigned char                                            UnknownData_Q3XK[0x2];                                   // 0x003A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_VKID[0xC];                                   // 0x0044(0x000C) MISSED OFFSET (PADDING)
...
int32_t InColumn
	...
	public:
		...
		unsigned char                                            UnknownData_99US[0x10];                                  // 0x0120(0x0010) MISSED OFFSET (PADDING)


	public:

		class UVerticalBoxSlot* AddChildToVerticalBox(
class UWidget* Content
);
	...
	public:
		...
		unsigned char                                            UnknownData_EDBC[0x8];                                   // 0x0050(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_HT3D[0x6];                                   // 0x005A(0x0006) MISSED OFFSET (PADDING)
...
EHorizontalAlignment InHorizontalAlignment
	...
	public:
		...
		unsigned char                                            UnknownData_JHJ6[0x38];                                  // 0x0130(0x0038) MISSED OFFSET (PADDING)
...
const struct FVector& Location
	...
	public:
		...
		unsigned char                                            UnknownData_BXZC[0x7];                                   // 0x0079(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
const class FScriptDelegate& Delegate
	...
	public:
		...
		unsigned char                                            UnknownData_92P2[0x10];                                  // 0x0038(0x0010) MISSED OFFSET (PADDING)


	public:

		class UWidgetAnimationPlayCallbackProxy* CreatePlayAnimationTimeRangeProxyObject(
...
float PlaybackSpeed
		...
		class UWidgetAnimationPlayCallbackProxy* CreatePlayAnimationProxyObject(
class UUMGSequencePlayer** Result
, 
class UUserWidget* Widget
, 
...
float PlaybackSpeed
	...
	public:
		...
		unsigned char                                            UnknownData_6RA7[0x7];                                   // 0x0331(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
bool bActive
		...
		struct FEventReply SetUserFocus(
struct FEventReply* Reply
, 
...
bool bInAllUsers
		...
		struct FEventReply SetMousePosition(
struct FEventReply* Reply
, 
...
bool bInAllJoysticks
		...
		struct FSlateBrush MakeBrushFromTexture(
class UTexture2D* Texture
, 
int32_t Width
, 
int32_t Height
		...
		struct FSlateBrush MakeBrushFromMaterial(
class UMaterialInterface* Material
, 
int32_t Width
, 
int32_t Height
		...
		struct FSlateBrush MakeBrushFromAsset(
...
const struct FLinearColor& Tint
		...
		struct FEventReply DetectDragIfPressed(
const struct FPointerEvent& PointerEvent
, 
...
bool bInAllJoysticks
	...
	public:
		...
		unsigned char                                            UnknownData_8VHO[0x8];                                   // 0x0468(0x0008) Fix Super Size
		...
		unsigned char                                            UnknownData_40OB[0x2];                                   // 0x0482(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_5XNK[0x8];                                   // 0x0488(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_IDRL[0x3];                                   // 0x0499(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_UJQG[0x1];                                   // 0x04D7(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_22C2[0x2];                                   // 0x0522(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_4CA8[0x3];                                   // 0x0531(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_KILL[0x27];                                  // 0x0539(0x0027) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_2P3Z[0x28];                                  // 0x0568(0x0028) MISSED OFFSET (PADDING)
...
const struct FLinearColor& NewBackgroundColor
	...
	public:
		...
		unsigned char                                            UnknownData_T9WH[0x10];                                  // 0x0208(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_ONSS[0x3];                                   // 0x0221(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_B4TN[0x1];                                   // 0x022B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_I838[0x7C];                                  // 0x0244(0x007C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_OWGU[0x4];                                   // 0x035C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_TRLE[0x9];                                   // 0x03F7(0x0009) MISSED OFFSET (PADDING)
...
class UObject* WorldContextObject
	...
	public:
		...
		unsigned char                                            UnknownData_4LNI[0x14];                                  // 0x0124(0x0014) MISSED OFFSET (PADDING)
...
int32_t Index
	...
	public:
		...
		unsigned char                                            UnknownData_7SUR[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_FX2K[0x6];                                   // 0x0052(0x0006) MISSED OFFSET (PADDING)
...
EHorizontalAlignment InHorizontalAlignment
	...
	public:
		...
		unsigned char                                            UnknownData_WK58[0x1E];                                  // 0x0122(0x001E) MISSED OFFSET (PADDING)
...
EHorizontalAlignment InHorizontalAlignment
	...
	public:
		...
		unsigned char                                            UnknownData_SCM5[0x16];                                  // 0x004A(0x0016) MISSED OFFSET (PADDING)
...
EHorizontalAlignment InHorizontalAlignment
	...
	public:
		...
		unsigned char                                            UnknownData_SRK9[0x15];                                  // 0x0133(0x0015) MISSED OFFSET (PADDING)
...
const struct FVector2D& InPadding
		...
		class UWrapBoxSlot* AddChildToWrapBox(
class UWidget* Content
);
	...
	public:
		...
		unsigned char                                            UnknownData_JN90[0x3];                                   // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_LAWK[0xE];                                   // 0x0052(0x000E) MISSED OFFSET (PADDING)
