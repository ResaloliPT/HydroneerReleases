...
namespace CG
{
	...
	public:
		...
		unsigned char                                            UnknownData_3PUV[0x7];                                   // 0x0289(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class USoundBase*                                        PressSound;                                              // 0x02A0(0x0008) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash
...
bool isSelected
		...
		void ExecuteUbergraph_UI_StyleOption(
int32_t EntryPoint
);
