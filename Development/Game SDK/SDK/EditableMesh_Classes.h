...
namespace CG
{
	...
	public:
		...
		unsigned char                                            UnknownData_FNC1[0x9C];                                  // 0x003C(0x009C) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_PP8D[0x390];                                 // 0x0028(0x0390) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)


		TArray<class UEditableMeshAdapter*>                      Adapters;                                                // 0x03B8(0x0010) ZeroConstructor, NativeAccessSpecifierPublic


		unsigned char                                            UnknownData_5Y1T[0x8];                                   // 0x03C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_F0EZ[0x148];                                 // 0x03D4(0x0148) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_TAQX[0x1E4];                                 // 0x0524(0x01E4) MISSED OFFSET (PADDING)
...
TArray<struct FVertexToMove> VerticesToMove
		...
		struct FVertexID MakeVertexID(
int32_t VertexIndex
);

		struct FPolygonID MakePolygonID(
int32_t PolygonIndex
);

		struct FPolygonGroupID MakePolygonGroupID(
int32_t PolygonGroupIndex
);

		struct FEdgeID MakeEdgeID(
int32_t EdgeIndex
);
...
TArray<struct FEdgeID>* OutNewEdgeIDs
		...
		struct FEdgeID GetVertexPairEdge(
const struct FVertexID& VertexID
, 
...
TArray<struct FPolygonID>* OutConnectedPolygonIDs
		...
		int32_t GetVertexInstanceConnectedPolygonCount(
const struct FVertexInstanceID& VertexInstanceID
);

		struct FPolygonID GetVertexInstanceConnectedPolygon(
const struct FVertexInstanceID& VertexInstanceID
, 
...
TArray<struct FEdgeID>* OutConnectedEdgeIDs
		...
		int32_t GetVertexConnectedEdgeCount(
const struct FVertexID& VertexID
);

		struct FEdgeID GetVertexConnectedEdge(
const struct FVertexID& VertexID
, 
...
TArray<struct FVertexID>* OutAdjacentVertexIDs
		...
		int32_t GetPolygonTriangulatedTriangleCount(
const struct FPolygonID& PolygonID
);

		struct FTriangleID GetPolygonTriangulatedTriangle(
const struct FPolygonID& PolygonID
, 
...
int32_t PolygonVertexNumber
		...
		int32_t GetPolygonPerimeterVertexCount(
const struct FPolygonID& PolygonID
);

		struct FVertexID GetPolygonPerimeterVertex(
const struct FPolygonID& PolygonID
, 
int32_t PolygonVertexNumber
);
...
TArray<struct FEdgeID>* OutPolygonPerimeterEdgeIDs
		...
		int32_t GetPolygonPerimeterEdgeCount(
const struct FPolygonID& PolygonID
);

		struct FEdgeID GetPolygonPerimeterEdge(
const struct FPolygonID& PolygonID
, 
...
bool* bOutEdgeWindingIsReversedForPolygon
		...
		struct FPolygonID GetPolygonInGroup(
const struct FPolygonGroupID& PolygonGroupID
, 
int32_t PolygonNumber
		...
		int32_t GetPolygonCountInGroup(
const struct FPolygonGroupID& PolygonGroupID
);
...
TArray<struct FPolygonID>* OutAdjacentPolygons
		...
		struct FPolygonGroupID GetGroupForPolygon(
const struct FPolygonID& PolygonID
);
...
TArray<struct FPolygonID>* OutConnectedPolygonIDs
		...
		int32_t GetEdgeConnectedPolygonCount(
const struct FEdgeID& EdgeID
);

		struct FPolygonID GetEdgeConnectedPolygon(
const struct FEdgeID& EdgeID
, 
int32_t ConnectedPolygonNumber
);
...
TArray<struct FPolygonID> PolygonIDs
		...
		int32_t FindPolygonPerimeterVertexNumberForVertex(
const struct FPolygonID& PolygonID
, 
const struct FVertexID& VertexID
);

		int32_t FindPolygonPerimeterEdgeNumberForVertices(
const struct FPolygonID& PolygonID
, 
...
TArray<struct FEdgeID>* OutSharedEdgeIDs
		...
		struct FPlane ComputePolygonPlane(
const struct FPolygonID& PolygonID
);

		struct FVector ComputePolygonNormal(
const struct FPolygonID& PolygonID
);

		struct FVector ComputePolygonCenter(
const struct FPolygonID& PolygonID
);
		...
		class UEditableMesh* CommitInstance(
...
bool bDeleteOrphanedPolygonGroups
	...
	public:
		...
		class UEditableMesh* MakeEditableMesh(
...
int32_t LODIndex
	...
	public:
		...
		unsigned char                                            UnknownData_DNXZ[0xA4];                                  // 0x003C(0x00A4) MISSED OFFSET (PADDING)
