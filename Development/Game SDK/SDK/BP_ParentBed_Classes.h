...
namespace CG
{
	 ...
	 * Size -> 0x004C (FullSize[0x0454] - InheritedSize[0x0408])
	 */
	...
	public:
		...
		unsigned char                                            UnknownData_K2IP[0x8];                                   // 0x0418(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)


		struct FTransform                                        OriginalPlayerTransform;                                 // 0x0420(0x0030) Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData, NoDestructor


		float                                                    EyeFade;                                                 // 0x0450(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
...
class ABP_GameController_C* Insigator
		...
		void ExecuteUbergraph_BP_ParentBed(
int32_t EntryPoint
);
