...
namespace CG
{
	...
	public:
		...
		bool                                                     Used;                                                    // 0x00D8(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor


		unsigned char                                            UnknownData_JRGE[0x3];                                   // 0x00D9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_MX96[0x4];                                   // 0x00E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_IKZ1[0x3];                                   // 0x00F9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void GetRandomSpaceInRadius(
struct FVector* Location
);

		void TraceForVoxelWorld(
...
class AActor* Object
		...
		void ExecuteUbergraph_AC_Explosive(
int32_t EntryPoint
);
