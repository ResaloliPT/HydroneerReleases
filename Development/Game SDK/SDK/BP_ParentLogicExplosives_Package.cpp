...
namespace CG
{
	 ...
	 */
	void ABP_ParentLogicExplosives_C::OverrideLogicIn(
class USceneComponent* Component
	 ...
	 */
	void ABP_ParentLogicExplosives_C::ExecuteUbergraph_BP_ParentLogicExplosives(
int32_t EntryPoint
)
	{
		static UFunction* fn = nullptr;
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ABP_ParentLogicExplosives_C.StaticClass
