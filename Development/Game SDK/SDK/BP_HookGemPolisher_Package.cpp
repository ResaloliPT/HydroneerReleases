...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function BP_HookGemPolisher.BP_HookGemPolisher_C.TogglePolish
	 * 		Flags  -> ()
	 * Parameters:
	 * 		bool                                               Polish                                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 */
	void ABP_HookGemPolisher_C::TogglePolish(
bool Polish
)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_HookGemPolisher.BP_HookGemPolisher_C.TogglePolish");
	 ...
	 */
	void ABP_HookGemPolisher_C::SpawnGem(
...
class ABP_ParentItem_C* OldUncut
	 ...
	 */
	void ABP_HookGemPolisher_C::HookFunctionality(
...
const struct FHitResult& SweepResult
	 ...
	 */
	void ABP_HookGemPolisher_C::ExecuteUbergraph_BP_HookGemPolisher(
int32_t EntryPoint
)
	{
		static UFunction* fn = nullptr;
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ABP_HookGemPolisher_C.StaticClass
