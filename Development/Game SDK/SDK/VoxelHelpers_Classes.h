...
namespace CG
{
	...
	public:
		...
		unsigned char                                            UnknownData_AU68[0x8];                                   // 0x0050(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)


		struct FMaterialAttributesInput                          B;                                                       // 0x0058(0x0010) NoDestructor, NativeAccessSpecifierPublic


		unsigned char                                            UnknownData_8B5O[0x8];                                   // 0x0068(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)


		struct FMaterialAttributesInput                          C;                                                       // 0x0070(0x0010) NoDestructor, NativeAccessSpecifierPublic


		unsigned char                                            UnknownData_Q9EW[0x8];                                   // 0x0080(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)


		struct FExpressionInput                                  AlphaA;                                                  // 0x0088(0x000C) NoDestructor, NativeAccessSpecifierPublic


		unsigned char                                            UnknownData_2IZA[0x8];                                   // 0x0094(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)


		struct FExpressionInput                                  AlphaB;                                                  // 0x009C(0x000C) NoDestructor, NativeAccessSpecifierPublic


		unsigned char                                            UnknownData_I92U[0x8];                                   // 0x00A8(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_KZPQ[0x18];                                  // 0x0050(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_YYN8[0x8];                                   // 0x004C(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_4G39[0x3];                                   // 0x0055(0x0003) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_Z3OG[0x10];                                  // 0x0128(0x0010) MISSED OFFSET (PADDING)
