...
namespace CG
{
	 ...
	 */
	void ABP_ProjectileSpanner_C::TryRepair(
class ABP_ParentItem_C* RepairingTool
	 ...
	 */
	void ABP_ProjectileSpanner_C::FindDurability(
class ABP_ParentItem_C* Item
	 ...
	 */
	void ABP_ProjectileSpanner_C::ReturnDurability(
float DurabilityAmount
	 ...
	 */
	void ABP_ProjectileSpanner_C::BndEvt__StaticMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature(
...
const struct FHitResult& Hit
	 ...
	 */
	void ABP_ProjectileSpanner_C::ExecuteUbergraph_BP_ProjectileSpanner(
int32_t EntryPoint
)
	{
		static UFunction* fn = nullptr;
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ABP_ProjectileSpanner_C.StaticClass
