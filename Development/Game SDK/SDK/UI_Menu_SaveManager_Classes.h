...
namespace CG
{
	...
	public:
		...
		bool                                                     ShowBackups;                                             // 0x031C(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor


	public:

		void ShowCloudSaveConflictWarning(
bool Show
, 
...
const class FString& Save
		...
		void BndEvt__UI_Menu_SaveManager_BackupVisibility_K2Node_ComponentBoundEvent_0_OnCheckBoxComponentStateChanged__DelegateSignature(
bool bIsChecked
);
		...
		void ExecuteUbergraph_UI_Menu_SaveManager(
int32_t EntryPoint
);
