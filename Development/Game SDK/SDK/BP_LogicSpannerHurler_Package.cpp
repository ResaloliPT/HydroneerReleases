...
namespace CG
{
	 ...
	 */
	void ABP_LogicSpannerHurler_C::OverrideLogicIn(
...
const struct FHitResult& SweepResult
	 ...
	 */
	void ABP_LogicSpannerHurler_C::ExecuteUbergraph_BP_LogicSpannerHurler(
int32_t EntryPoint
)
	{
		static UFunction* fn = nullptr;
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ABP_LogicSpannerHurler_C.StaticClass
