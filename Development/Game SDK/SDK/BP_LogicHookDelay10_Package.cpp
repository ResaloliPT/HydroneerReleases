...
namespace CG
{
	 ...
	 */
	void ABP_LogicHookDelay10_C::HookFunctionality(
...
bool* CanPass
	 ...
	 * 		class USceneComponent*                             Component                                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void ABP_LogicHookDelay10_C::WaitForDelay(
...
class USceneComponent* Component
	 ...
	 */
	void ABP_LogicHookDelay10_C::ExecuteUbergraph_BP_LogicHookDelay10(
int32_t EntryPoint
)
	{
		static UFunction* fn = nullptr;
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ABP_LogicHookDelay10_C.StaticClass
