...
namespace CG
{
	...
	public:
		...
		unsigned char                                            UnknownData_TT48[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_7HKC[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_SGJ8[0x8];                                   // 0x0060(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
class UObject* InMetaData
	...
	public:
		...
		unsigned char                                            UnknownData_VYVB[0x7];                                   // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void SetBurnIn(
const struct FSoftClassPath& InBurnInClass
);
	...
	public:
		...
		unsigned char                                            UnknownData_1X9R[0x10];                                  // 0x0220(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_5RIB[0x4];                                   // 0x0244(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_USCD[0x6];                                   // 0x026A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_HP3H[0x7];                                   // 0x0281(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_P740[0x7];                                   // 0x0299(0x0007) MISSED OFFSET (PADDING)
...
bool bAllowBindingsFromAsset
		...
		void SetBinding(
const struct FMovieSceneObjectBindingID& Binding
, 
TArray<class AActor*> Actors
, 
bool bAllowBindingsFromAsset
...
class UObject* InSettings
	...
	public:
		...
		unsigned char                                            UnknownData_NO8K[0x108];                                 // 0x0690(0x0108) MISSED OFFSET (PADDING)
	...
	public:
		...
		class ULevelSequencePlayer* CreateLevelSequencePlayer(
...
class ALevelSequenceActor** OutActor
	...
	public:
		...
		unsigned char                                            UnknownData_MVAC[0x8];                                   // 0x0220(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_Q7SZ[0xC];                                   // 0x023C(0x000C) MISSED OFFSET (PADDING)
