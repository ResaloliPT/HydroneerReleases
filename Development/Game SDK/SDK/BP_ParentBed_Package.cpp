...
namespace CG
{
	 ...
	 */
	void ABP_ParentBed_C::Deactivated(
class ABP_GameController_C* Controller
	 ...
	 */
	void ABP_ParentBed_C::LMBDownIsTarget(
...
class ABP_GameController_C* Insigator
	 ...
	 */
	void ABP_ParentBed_C::ExecuteUbergraph_BP_ParentBed(
int32_t EntryPoint
)
	{
		static UFunction* fn = nullptr;
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ABP_ParentBed_C.StaticClass
