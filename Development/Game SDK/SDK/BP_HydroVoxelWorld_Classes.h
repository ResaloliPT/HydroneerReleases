...
namespace CG
{
	...
	public:
		...
		bool                                                     IsHorizontal;                                            // 0x0880(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn


		unsigned char                                            UnknownData_7JRH[0x7];                                   // 0x0881(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)


		struct FVoxelCompressedWorldSave                         CompressedSave;                                          // 0x0888(0x0020) Edit, BlueprintVisible, DisableEditOnInstance, SaveGame


		bool                                                     BeenEdited;                                              // 0x08A8(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, SaveGame, IsPlainOldData, NoDestructor


		unsigned char                                            UnknownData_1BMX[0x3];                                   // 0x08A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
TArray<class UActorComponent*>* Components
		...
		void ExecuteUbergraph_BP_HydroVoxelWorld(
int32_t EntryPoint
);
