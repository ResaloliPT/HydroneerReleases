...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function BPI_ClickEvents.BPI_ClickEvents_C.RMBUpWhileCarrying
	 * 		Flags  -> ()
	 */
	void UBPI_ClickEvents_C::RMBUpWhileCarrying()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BPI_ClickEvents.BPI_ClickEvents_C.RMBUpWhileCarrying");
	 ...
	 */
	void UBPI_ClickEvents_C::LMBDownIsTarget(
...
class ABP_GameController_C* Insigator
	 ...
	 */
	void UBPI_ClickEvents_C::RMBDownIsTarget(
class UPrimitiveComponent* Component
, 
class ABP_ParentItem_C* CarryingItem
, 
class ABP_GameController_C* Instigator
	 ...
	 */
	void UBPI_ClickEvents_C::RMBDownWhileCarrying(
...
const struct FVector& HitLocation
	 ...
	 */
	void UBPI_ClickEvents_C::LMBDownWhileCarrying(
class ABP_GameController_C* Controller
, 
...
bool* ConsumeInput
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UBPI_ClickEvents_C.StaticClass
