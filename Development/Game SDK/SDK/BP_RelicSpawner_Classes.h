...
namespace CG
{
	...
	public:
		...
		bool                                                     AlreadySpawned;                                          // 0x0248(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, SaveGame, IsPlainOldData, NoDestructor
...
TArray<class UActorComponent*>* Components
		...
		void ExecuteUbergraph_BP_RelicSpawner(
int32_t EntryPoint
);
