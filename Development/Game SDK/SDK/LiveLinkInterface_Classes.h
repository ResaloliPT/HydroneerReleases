...
namespace CG
{
	...
	public:
		...
		unsigned char                                            UnknownData_22P7[0x7];                                   // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_8JP7[0x7];                                   // 0x0061(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_2U67[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_TX3T[0x80];                                  // 0x0058(0x0080) MISSED OFFSET (PADDING)
