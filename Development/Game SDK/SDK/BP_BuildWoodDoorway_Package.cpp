...
namespace CG
{
	 ...
	 */
	void ABP_BuildWoodDoorway_C::LMBDownIsTarget(
...
class ABP_GameController_C* Insigator
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function BP_BuildWoodDoorway.BP_BuildWoodDoorway_C.OverrideLoaded
	 * 		Flags  -> ()
	 */
	void ABP_BuildWoodDoorway_C::OverrideLoaded()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_BuildWoodDoorway.BP_BuildWoodDoorway_C.OverrideLoaded");
	 ...
	 */
	void ABP_BuildWoodDoorway_C::ExecuteUbergraph_BP_BuildWoodDoorway(
int32_t EntryPoint
)
	{
		static UFunction* fn = nullptr;
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ABP_BuildWoodDoorway_C.StaticClass
