...
namespace CG
{
	...
	public:
		...
		unsigned char                                            UnknownData_AVVU[0x8];                                   // 0x02B8(0x0008) Fix Super Size
...
float MaxStretchScale
		...
		struct FVector K2_MakePerlinNoiseVectorAndRemap(
float X
, 
float Y
, 
...
float OutRangeMax
		...
		struct FVector K2_DirectionBetweenSockets(
class USkeletalMeshComponent* Component
, 
...
float VelocityMax
	...
	public:
		...
		unsigned char                                            UnknownData_KV6O[0x30];                                  // 0x0078(0x0030) MISSED OFFSET (PADDING)
...
bool bInterrupted
		...
		class UPlayMontageCallbackProxy* CreateProxyObjectForPlayMontage(
