...
float NewValue
		...
		void GamepadIconsChanged(
const class FString& NewValue
);

		void ExplosionVolumeChanged(
float NewValue
);

		void ReceiveInit();

		void MultiMonitorToggle(
bool NewValue
);
