...
namespace CG
{
	...
	public:
		...
		bool                                                     SoldItem;                                                // 0x0248(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, SaveGame, IsPlainOldData, NoDestructor
...
class ABP_ParentItem_C* ItemPickedUp
		...
		void CheckIfItemSold(
TArray<class ABP_ParentItem_C*> Items
);

		void ActorLoaded();

		void ExecuteUbergraph_BP_FiniteStoreItem(
int32_t EntryPoint
);
