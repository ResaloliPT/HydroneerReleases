...
namespace CG
{
	 ...
	 * Size -> 0x0051 (FullSize[0x0359] - InheritedSize[0x0308])
	 */
	...
	public:
		...
		bool                                                     InGame;                                                  // 0x0318(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor


		unsigned char                                            UnknownData_N4EG[0x7];                                   // 0x0319(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		bool                                                     NPCTalking;                                              // 0x0358(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor


	public:

		void LocationIndicatorColorChange(
...
const struct FTransform& SpawnTransform
		...
		class ABP_Character_HydroGuy_C* SpawnHydroguy(
const struct FTransform& SpawnTransform
, 
class AController* PlayerController
);

		class APawn* SpawnDefaultPawnFor(
class AController* NewPlayer
, 
...
bool CloudSaving
		...
		void ExecuteUbergraph_GM_Hydroneer(
int32_t EntryPoint
);
