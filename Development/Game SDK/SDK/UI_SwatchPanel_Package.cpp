...
namespace CG
{
	 ...
	 */
	void UUI_SwatchPanel_C::UpdateSelectionColorVisual(
const class FName& ColorID
	 ...
	 * 		class FName                                        ColorID                                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void UUI_SwatchPanel_C::UpdateSelectionColor(
const class FName& ColorID
)
	{
		static UFunction* fn = nullptr;
	 ...
	 */
	void UUI_SwatchPanel_C::PreConstruct(
bool IsDesignTime
)
	{
		static UFunction* fn = nullptr;
	 ...
	 */
	void UUI_SwatchPanel_C::ExecuteUbergraph_UI_SwatchPanel(
int32_t EntryPoint
)
	{
		static UFunction* fn = nullptr;
	 ...
	 * 		class FName                                        ColorID                                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void UUI_SwatchPanel_C::OnUpdate__DelegateSignature(
const class FName& ColorID
)
	{
		static UFunction* fn = nullptr;
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UUI_SwatchPanel_C.StaticClass
