...
namespace CG
{
	...
	public:
		...
		unsigned char                                            UnknownData_6CO7[0x8];                                   // 0x0220(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_QKAS[0x3];                                   // 0x02A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_2QPM[0x3];                                   // 0x02AD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_44UH[0x108];                                 // 0x02B8(0x0108) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)


		TArray<struct FSupportedAreaData>                        SupportedAreas;                                          // 0x03C0(0x0010) ZeroConstructor, Protected, NativeAccessSpecifierProtected


		unsigned char                                            UnknownData_DS9F[0x58];                                  // 0x03D0(0x0058) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_K733[0x6];                                   // 0x0042(0x0006) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_AM4R[0x10];                                  // 0x0070(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_JS2S[0x2F];                                  // 0x00A9(0x002F) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_RV3V[0x3F];                                  // 0x0049(0x003F) MISSED OFFSET (PADDING)
...
const struct FLinearColor& PathColor
	...
	public:
		...
		unsigned char                                            UnknownData_8YU2[0x8];                                   // 0x0040(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		bool                                                     UnknownData_IMM3 : 1;                                    // 0x0068(0x0001) BIT_FIELD (PADDING)
		...
		unsigned char                                            UnknownData_Z15A[0x2];                                   // 0x006A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_QCYM[0x3];                                   // 0x0071(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_GAT5[0x4];                                   // 0x008C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_8A7Q[0x10];                                  // 0x00B0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_DQ8J[0xDC];                                  // 0x00E0(0x00DC) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_WRRM[0x13FF];                                // 0x01BD(0x13FF) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_NLZE[0x20];                                  // 0x15C0(0x0020) MISSED OFFSET (PADDING)
...
float TileRemovalRadius
		...
		struct FVector ProjectPointToNavigation(
...
class UObject* WorldContextObject
		...
		struct FVector GetRandomReachablePointInRadius(
class UObject* WorldContextObject
, 
const struct FVector& Origin
, 
...
class UClass* FilterClass
		...
		ENavigationQueryResult GetPathLength(
class UObject* WorldContextObject
, 
...
class UClass* FilterClass
		...
		ENavigationQueryResult GetPathCost(
class UObject* WorldContextObject
, 
const struct FVector& PathStart
, 
...
class UClass* FilterClass
	...
	public:
		...
		unsigned char                                            UnknownData_U6FX[0x7];                                   // 0x0051(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_ZLQC[0x10];                                  // 0x0220(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_FLGA[0x7];                                   // 0x0241(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_C0L3[0x4];                                   // 0x0284(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_UDPA[0x3];                                   // 0x029D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_4PB6[0x3];                                   // 0x02A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_1X5Q[0x3];                                   // 0x02AD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_MSEP[0x3];                                   // 0x02B9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_XO39[0x30];                                  // 0x02E0(0x0030) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_MQHM[0x8];                                   // 0x0440(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_R9YB[0x8];                                   // 0x0458(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_9PPR[0x24];                                  // 0x00B0(0x0024) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_3GI0[0x3];                                   // 0x00D5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
bool bRelevant
	...
	public:
		...
		unsigned char                                            UnknownData_84Z9[0x8];                                   // 0x00E0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_Z8OV[0x4];                                   // 0x00EC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_DCWR[0x3];                                   // 0x011D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_TXCL[0x3];                                   // 0x0121(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_EF5T[0x4];                                   // 0x013C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_DTY7[0x3F];                                  // 0x0151(0x003F) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_9E7F[0x4];                                   // 0x025C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_V2HL[0x10];                                  // 0x0440(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_MVVJ[0x4B];                                  // 0x00F5(0x004B) MISSED OFFSET (PADDING)
...
class UClass* NewAreaClass
	...
	public:
		...
		unsigned char                                            UnknownData_N99U[0x8];                                   // 0x0258(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_ETTP[0x7];                                   // 0x0269(0x0007) MISSED OFFSET (PADDING)
...
class UClass* NewAreaClass
	...
	public:
		...
		unsigned char                                            UnknownData_HY94[0x6];                                   // 0x022A(0x0006) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_MYJL[0x1];                                   // 0x042B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_ZH54[0x3];                                   // 0x0431(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_ITX5[0x2];                                   // 0x048E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_VL1H[0x2];                                   // 0x049A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_QTEV[0x30];                                  // 0x04A8(0x0030) MISSED OFFSET (PADDING)
...
bool ReplaceLinks
	...
	public:
		...
		unsigned char                                            UnknownData_FAKW[0x10];                                  // 0x0030(0x0010) MISSED OFFSET (PADDING)
