...
namespace CG
{
	 ...
	 */
	void ABP_IcehelmElevator_C::SetCableLength(
float Lerp
)
	{
	 ...
	 */
	void ABP_IcehelmElevator_C::MovePlatform(
bool Direction
)
	{
		static UFunction* fn = nullptr;
	 ...
	 */
	void ABP_IcehelmElevator_C::ExecuteUbergraph_BP_IcehelmElevator(
int32_t EntryPoint
)
	{
		static UFunction* fn = nullptr;
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ABP_IcehelmElevator_C.StaticClass
