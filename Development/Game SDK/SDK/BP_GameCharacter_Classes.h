...
namespace CG
{
	 ...
	 * Size -> 0x00C8 (FullSize[0x0588] - InheritedSize[0x04C0])
	 */
	...
	public:
		...
		unsigned char                                            UnknownData_9F55[0x3];                                   // 0x0525(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_HSNQ[0x3];                                   // 0x0535(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		bool                                                     Free;                                                    // 0x0540(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor


		unsigned char                                            UnknownData_CEP3[0x7];                                   // 0x0541(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		bool                                                     Headbob;                                                 // 0x0558(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor


		bool                                                     UsingCart;                                               // 0x0559(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor


		unsigned char                                            UnknownData_MIP6[0x2];                                   // 0x055A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)


		float                                                    CartRotSpeed;                                            // 0x055C(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash


		struct FTimerHandle                                      FlyingHatVertTimerHandle;                                // 0x0560(0x0008) Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash


		float                                                    FlyingVertDirection;                                     // 0x0568(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash


		bool                                                     InvertMouseY;                                            // 0x056C(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor


		bool                                                     UsingPallete;                                            // 0x056D(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor


		unsigned char                                            UnknownData_T7LY[0x2];                                   // 0x056E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)


		class ABP_GameController_C*                              GameController;                                          // 0x0570(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash


		bool                                                     ToggleCrouch;                                            // 0x0578(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, SaveGame, IsPlainOldData, NoDestructor


		bool                                                     ToggleSprint;                                            // 0x0579(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, SaveGame, IsPlainOldData, NoDestructor


		bool                                                     SprintingWhileToggle;                                    // 0x057A(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor


		unsigned char                                            UnknownData_ZCXK[0x5];                                   // 0x057B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)


		class UMaterialInstanceDynamic*                          DecalMaterial;                                           // 0x0580(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
...
class UStaticMeshComponent* ValidMeshIfTrue
		...
		void InpActEvt_Jump_K2Node_InputActionEvent_6(
const struct FKey& Key
);

		void InpActEvt_Jump_K2Node_InputActionEvent_5(
const struct FKey& Key
);

		void InpActEvt_Crouch_K2Node_InputActionEvent_4(
const struct FKey& Key
);

		void InpActEvt_Crouch_K2Node_InputActionEvent_3(
const struct FKey& Key
);

		void InpActEvt_Sprint_K2Node_InputActionEvent_2(
const struct FKey& Key
);

		void InpActEvt_Sprint_K2Node_InputActionEvent_1(
const struct FKey& Key
);

		void InpAxisEvt_MouseUp_K2Node_InputAxisEvent_3(
float AxisValue
);

		void InpAxisEvt_MouseRight_K2Node_InputAxisEvent_4(
float AxisValue
);
...
class AActor* DestroyedActor
		...
		void ToggleSprintChange(
float NewValue
);

		void ToggleCrouchChange(
float NewValue
);

		void ExecuteUbergraph_BP_GameCharacter(
int32_t EntryPoint
);
