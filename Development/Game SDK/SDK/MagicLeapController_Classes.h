...
namespace CG
{
	...
	public:
		...
		bool SetMotionSourceForHand(
EControllerHand Hand
, 
const class FName& MotionSource
);

		bool SetControllerTrackingMode(
...
EControllerHand Hand
		...
		EMagicLeapControllerType GetMLControllerType(
EControllerHand Hand
);

		EControllerHand GetHandForMotionSource(
const class FName& MotionSource
);

		EMagicLeapControllerType GetControllerType(
const class FName& MotionSource
);

		EMagicLeapControllerTrackingMode GetControllerTrackingMode();

		bool GetControllerMapping(
...
EControllerHand* Hand
	...
	public:
		...
		unsigned char                                            UnknownData_36W2[0x8];                                   // 0x00B0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_S0GS[0x58];                                  // 0x00E8(0x0058) MISSED OFFSET (PADDING)
