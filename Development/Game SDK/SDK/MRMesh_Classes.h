...
class UMRMeshComponent* Mesh
	...
	public:
		...
		unsigned char                                            UnknownData_EPIJ[0x4];                                   // 0x020C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_KQ90[0x4];                                   // 0x0244(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_IM5D[0x20];                                  // 0x0250(0x0020) MISSED OFFSET (PADDING)
...
class UMRMeshComponent* InMRMeshPtr
	...
	public:
		...
		unsigned char                                            UnknownData_BKZS[0x10];                                  // 0x0440(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_IWGR[0x5];                                   // 0x0463(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_G2XN[0x80];                                  // 0x0480(0x0080) MISSED OFFSET (PADDING)
