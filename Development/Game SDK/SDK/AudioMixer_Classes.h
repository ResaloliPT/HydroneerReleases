...
namespace CG
{
	...
	public:
		...
		unsigned char                                            UnknownData_EYUL[0x8];                                   // 0x01F8(0x0008) Fix Super Size
		...
		unsigned char                                            UnknownData_GSF5[0x3];                                   // 0x0649(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_YA3P[0x4];                                   // 0x0654(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_4TR7[0x20];                                  // 0x0668(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_03BH[0x28];                                  // 0x0698(0x0028) MISSED OFFSET (PADDING)
...
bool InLowPassFilterEnabled
	...
	public:
		...
		unsigned char                                            UnknownData_SDPW[0x80];                                  // 0x0028(0x0080) MISSED OFFSET (PADDING)
...
float InMegabytesToFree
		...
		class USoundWave* StopRecordingOutput(
...
class USoundSubmix* SubmixToPause
		...
		TArray<struct FSoundSubmixSpectralAnalysisBandSettings> MakePresetSpectralAnalysisBandSettings(
...
int32_t InReleaseTimeMsec
		...
		TArray<struct FSoundSubmixSpectralAnalysisBandSettings> MakeMusicalSpectralAnalysisBandSettings(
...
int32_t InReleaseTimeMsec
		...
		TArray<struct FSoundSubmixSpectralAnalysisBandSettings> MakeFullSpectrumSpectralAnalysisBandSettings(
int32_t InNumBands
, 
...
class USoundSubmix* SubmixToAnalyze
		...
		int32_t GetNumberOfEntriesInSourceEffectChain(
class UObject* WorldContextObject
, 
class USoundEffectSourcePresetChain* PresetChain
);
...
class USoundEffectSubmixPreset* SubmixEffectPreset
	...
	public:
		...
		unsigned char                                            UnknownData_BF4J[0x168];                                 // 0x0028(0x0168) MISSED OFFSET (PADDING)
...
class UObject* WorldContextObject
	...
	public:
		...
		unsigned char                                            UnknownData_RC16[0x78];                                  // 0x0068(0x0078) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
class USoundSubmix* Submix
	...
	public:
		...
		unsigned char                                            UnknownData_XZKP[0x38];                                  // 0x0068(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
const struct FSubmixEffectSubmixEQSettings& InSettings
	...
	public:
		...
		unsigned char                                            UnknownData_KTE3[0x68];                                  // 0x0068(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
const struct FSubmixEffectReverbSettings& InSettings
	...
	public:
		...
		unsigned char                                            UnknownData_S804[0x50];                                  // 0x0030(0x0050) MISSED OFFSET (PADDING)
...
const class FName& ClockName
		...
		class UQuartzClockHandle* CreateNewClock(
class UObject* WorldContextObject
, 
const class FName& ClockName
, 
...
bool bOverrideSettingsIfClockExists
	...
	public:
		...
		unsigned char                                            UnknownData_4JQQ[0x18];                                  // 0x03C8(0x0018) MISSED OFFSET (PADDING)
