...
namespace CG
{
	 ...
	 */
	void ABP_ThrownTNT_C::LMBDownWhileCarrying(
...
class ABP_GameController_C* Controller
	 ...
	 */
	void ABP_ThrownTNT_C::ExecuteUbergraph_BP_ThrownTNT(
int32_t EntryPoint
)
	{
		static UFunction* fn = nullptr;
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ABP_ThrownTNT_C.StaticClass
