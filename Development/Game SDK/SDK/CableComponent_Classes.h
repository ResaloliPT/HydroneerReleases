...
namespace CG
{
	...
	public:
		...
		unsigned char                                            UnknownData_K7CR[0x8];                                   // 0x0468(0x0008) Fix Super Size
		...
		unsigned char                                            UnknownData_EVNL[0x3];                                   // 0x04C1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_57O0[0x1C];                                  // 0x04E4(0x001C) MISSED OFFSET (PADDING)
