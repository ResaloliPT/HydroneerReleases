...
namespace CG
{
	 ...
	 */
	void ABP_ParentRawResource_C::SetDoNotClear(
bool DoNotClear
)
	{
	 ...
	 */
	void ABP_ParentRawResource_C::ToggleSaveRawResourcesChanged(
bool NewValue
)
	{
		static UFunction* fn = nullptr;
	 ...
	 */
	void ABP_ParentRawResource_C::ExecuteUbergraph_BP_ParentRawResource(
int32_t EntryPoint
)
	{
		static UFunction* fn = nullptr;
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ABP_ParentRawResource_C.StaticClass
