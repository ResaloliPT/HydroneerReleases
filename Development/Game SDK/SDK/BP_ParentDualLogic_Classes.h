...
namespace CG
{
	...
	public:
		...
		class UBoxComponent*                                     X_Box2;                                                  // 0x0450(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash


		class FString                                            LogicB;                                                  // 0x0458(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, SaveGame, HasGetValueTypeHash
...
const class FString& Logic
		...
		void ExecuteUbergraph_BP_ParentDualLogic(
int32_t EntryPoint
);
