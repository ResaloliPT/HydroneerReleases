...
namespace CG
{
	 ...
	 */
	void ABP_ParentPipeStraight_C::OverrideWaterIn(
...
float RootPressure
	 ...
	 */
	void ABP_ParentPipeStraight_C::ExecuteUbergraph_BP_ParentPipeStraight(
int32_t EntryPoint
)
	{
		static UFunction* fn = nullptr;
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ABP_ParentPipeStraight_C.StaticClass
