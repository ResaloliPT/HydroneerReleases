...
namespace CG
{
	...
	public:
		...
		unsigned char                                            UnknownData_T9VH[0x58];                                  // 0x0028(0x0058) MISSED OFFSET (PADDING)
...
bool Value
	...
	public:
		...
		unsigned char                                            UnknownData_NVKP[0x17];                                  // 0x0099(0x0017) MISSED OFFSET (PADDING)
...
int32_t Filter
	...
	public:
		...
		unsigned char                                            UnknownData_RR6U[0x2];                                   // 0x00C2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_6E32[0x3];                                   // 0x00C5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_3WR8[0x4];                                   // 0x00D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_PEN5[0x2C];                                  // 0x00F4(0x002C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_6WP0[0x8];                                   // 0x0130(0x0008) MISSED OFFSET (PADDING)
...
int32_t FormatIndex
		...
		int32_t GetAudioTrackSampleRate(
int32_t TrackIndex
, 
int32_t FormatIndex
);

		int32_t GetAudioTrackChannels(
int32_t TrackIndex
, 
int32_t FormatIndex
);
...
class UMediaSource* MediaSource
	...
	public:
		...
		unsigned char                                            UnknownData_IOJL[0x3];                                   // 0x06C1(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		...
		unsigned char                                            UnknownData_2YTN[0x3];                                   // 0x06C5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_2K88[0x4];                                   // 0x06DC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_6KUW[0x1F8];                                 // 0x06E8(0x01F8) MISSED OFFSET (PADDING)
...
struct FSoundAttenuationSettings* OutAttenuationSettings
	...
	public:
		...
		unsigned char                                            UnknownData_L90Z[0x1];                                   // 0x00DB(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_PVV4[0x3];                                   // 0x00F5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_KHZG[0xB0];                                  // 0x0100(0x00B0) MISSED OFFSET (PADDING)
...
class UMediaPlayer* NewMediaPlayer
	...
	public:
		...
		unsigned char                                            UnknownData_1CS9[0x3];                                   // 0x0089(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
