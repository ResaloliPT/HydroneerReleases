...
namespace CG
{
	 ...
	 */
	void ABP_ParentPipeIntake_C::OverridePlacedDown(
class ABP_GameCharacter_C* Character
	 ...
	 */
	void ABP_ParentPipeIntake_C::ExecuteUbergraph_BP_ParentPipeIntake(
int32_t EntryPoint
)
	{
		static UFunction* fn = nullptr;
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ABP_ParentPipeIntake_C.StaticClass
