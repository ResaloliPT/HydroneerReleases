...
namespace CG
{
	 ...
	 */
	void ABP_ParentTool_C::LMBDownWhileCarrying(
...
bool* ConsumeInput
)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_ParentTool.BP_ParentTool_C.LMBDownWhileCarrying");
	...
	void ABP_ParentTool_C::LMBUpWhileCarrying()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_ParentTool.BP_ParentTool_C.LMBUpWhileCarrying");
	 ...
	 * 		struct FVector                                     HitLocation                                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void ABP_ParentTool_C::RMBDownWhileCarrying(
class ABP_GameController_C* Controller
, 
...
const struct FVector& HitLocation
)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_ParentTool.BP_ParentTool_C.RMBDownWhileCarrying");
	 ...
	 */
	void ABP_ParentTool_C::RMBDownIsTarget(
...
class ABP_GameController_C* Instigator
)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_ParentTool.BP_ParentTool_C.RMBDownIsTarget");
	 ...
	 */
	void ABP_ParentTool_C::LMBDownIsTarget(
class UPrimitiveComponent* Component
, 
class ABP_ParentItem_C* CarryingItem
, 
class ABP_GameController_C* Insigator
)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_ParentTool.BP_ParentTool_C.LMBDownIsTarget");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function BP_ParentTool.BP_ParentTool_C.RMBUpWhileCarrying
	 * 		Flags  -> ()
	 */
	void ABP_ParentTool_C::RMBUpWhileCarrying()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_ParentTool.BP_ParentTool_C.RMBUpWhileCarrying");
	...
	void ABP_ParentTool_C::OverrideAnimFinished()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_ParentTool.BP_ParentTool_C.OverrideAnimFinished");
	 ...
	 */
	void ABP_ParentTool_C::ExecuteUbergraph_BP_ParentTool(
int32_t EntryPoint
)
	{
		static UFunction* fn = nullptr;
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ABP_ParentTool_C.StaticClass
