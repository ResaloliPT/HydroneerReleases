...
namespace CG
{
	 ...
	 */
	void ABP_ParentBuildLighting_C::LMBDownIsTarget(
...
class ABP_GameController_C* Insigator
	 ...
	 */
	void ABP_ParentBuildLighting_C::ExecuteUbergraph_BP_ParentBuildLighting(
int32_t EntryPoint
)
	{
		static UFunction* fn = nullptr;
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ABP_ParentBuildLighting_C.StaticClass
