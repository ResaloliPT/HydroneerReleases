...
TArray<class UActorComponent*>* Components
	...
	public:
		...
		unsigned char                                            UnknownData_R8RJ[0x38];                                  // 0x0040(0x0038) MISSED OFFSET (PADDING)


	public:

		class UEMSAsyncLoadGame* AsyncLoadActors(
...
bool bFullReload
	...
	public:
		...
		unsigned char                                            UnknownData_YTMU[0x20];                                  // 0x0040(0x0020) MISSED OFFSET (PADDING)


	public:

		class UEMSAsyncSaveGame* AsyncSaveActors(
class UObject* WorldContextObject
, 
int32_t Data
);
	...
	public:
		...
		unsigned char                                            UnknownData_HGD3[0x18];                                  // 0x0040(0x0018) MISSED OFFSET (PADDING)


	public:

		class UEMSAsyncWait* AsyncWaitForOperation(
class UObject* WorldContextObject
);
	...
	public:
		...
		unsigned char                                            UnknownData_3GRB[0x7];                                   // 0x0039(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		void SetCurrentSaveUserName(
class UObject* WorldContextObject
, 
const class FString& UserName
);

		void SetCurrentSaveGameName(
class UObject* WorldContextObject
, 
const class FString& SaveGameName
);

		void SetActorSaveProperties(
class UObject* WorldContextObject
, 
bool bSkipSave
, 
...
class UObject* WorldContextObject
		...
		class UTexture2D* ImportSaveThumbnail(
class UObject* WorldContextObject
, 
const class FString& SaveGameName
);

		TArray<class FString> GetSortedSaveSlots(
class UObject* WorldContextObject
);

		class UEMSInfoSaveGame* GetSlotInfoSaveGame(
class UObject* WorldContextObject
, 
class FString* SaveGameName
);

		class UEMSPersistentSaveGame* GetPersistentSave(
class UObject* WorldContextObject
);

		class UEMSInfoSaveGame* GetNamedSlotInfo(
class UObject* WorldContextObject
, 
const class FString& SaveGameName
);

		class UEMSProfileSaveGame* GetLocalProfileSaveGame(
class UObject* WorldContextObject
);

		class UEMSCustomSaveGame* GetCustomSave(
class UObject* WorldContextObject
, 
class UClass* SaveGameClass
);

		TArray<class FString> GetAllSaveUsers(
class UObject* WorldContextObject
);

		void ExportSaveThumbnail(
class UObject* WorldContextObject
, 
...
class UObject* WorldContextObject
		...
		void DeleteCustomSave(
class UObject* WorldContextObject
, 
class UEMSCustomSaveGame* SaveGame
);

		void DeleteAllSaveDataForSlot(
class UObject* WorldContextObject
, 
const class FString& SaveGameName
);
	...
	public:
		...
		unsigned char                                            UnknownData_MI3L[0x108];                                 // 0x00C8(0x0108) MISSED OFFSET (PADDING)


	public:

		void OuterActorEndPlay(
class AActor* Actor
, 
EEndPlayReason EndPlayReason
	...
	public:
		...
		unsigned char                                            UnknownData_L4ZQ[0x7];                                   // 0x0059(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
