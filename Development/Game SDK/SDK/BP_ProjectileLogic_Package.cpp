...
namespace CG
{
	 ...
	 */
	void ABP_ProjectileLogic_C::BndEvt__StaticMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature(
...
const struct FHitResult& Hit
	 ...
	 */
	void ABP_ProjectileLogic_C::ExecuteUbergraph_BP_ProjectileLogic(
int32_t EntryPoint
)
	{
		static UFunction* fn = nullptr;
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ABP_ProjectileLogic_C.StaticClass
