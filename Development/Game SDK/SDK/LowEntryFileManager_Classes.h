...
namespace CG
{
	...
	public:
		...
		unsigned char                                            UnknownData_PBWL[0x7];                                   // 0x0059(0x0007) MISSED OFFSET (PADDING)
...
ELowEntryFileManagerYesNo* Branch
		...
		class ULowEntryFileManagerFile* GetFile(
const class FString& File
);

		class ULowEntryFileManagerDirectory* GetDirectory(
...
TArray<unsigned char> Data
		...
		class FString ReplaceInvalidPathCharacters(
const class FString& String
, 
const class FString& ReplacementCharacter
);

		class FString ReplaceInvalidFilenameCharacters(
const class FString& String
, 
const class FString& ReplacementCharacter
);

		class FString ReplaceBackslashesBySlashes(
const class FString& String
);

		class FString RemoveInvalidPathCharacters(
const class FString& String
);

		class FString RemoveInvalidFilenameCharacters(
const class FString& String
);

		class FString RelativeToAbsolutePath(
...
ELowEntryFileManagerYesNo* Branch
		...
		struct FDateTime GetFileTimestamp(
const class FString& File
);
...
const class FString& File
		...
		TArray<class FString> GetFiles(
const class FString& Directory
);

		TArray<class FString> GetFileNames(
const class FString& Directory
);

		TArray<unsigned char> GetFileData(
const class FString& File
);

		struct FDateTime GetFileAccessTimestamp(
const class FString& File
);
		...
		TArray<class FString> GetDirectoryNames(
const class FString& Directory
);
...
const class FString& Path
		...
		TArray<class FString> GetDirectories(
const class FString& Directory
);
