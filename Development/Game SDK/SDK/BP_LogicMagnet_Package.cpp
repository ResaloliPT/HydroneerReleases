...
namespace CG
{
	 ...
	 */
	void ABP_LogicMagnet_C::OverrideLogicIn(
class USceneComponent* Component
	 ...
	 */
	void ABP_LogicMagnet_C::OverridePlacedDown(
...
const struct FHitResult& SweepResult
	 ...
	 * 		int32_t                                            OtherBodyIndex                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void ABP_LogicMagnet_C::BndEvt__BP_LogicMagnet_MagnetBox_K2Node_ComponentBoundEvent_3_ComponentEndOverlapSignature__DelegateSignature(
class UPrimitiveComponent* OverlappedComponent
, 
class AActor* OtherActor
, 
...
int32_t OtherBodyIndex
	 ...
	 */
	void ABP_LogicMagnet_C::ExecuteUbergraph_BP_LogicMagnet(
int32_t EntryPoint
)
	{
		static UFunction* fn = nullptr;
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ABP_LogicMagnet_C.StaticClass
