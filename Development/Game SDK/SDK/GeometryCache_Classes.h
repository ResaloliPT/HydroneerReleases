...
namespace CG
{
	...
	public:
		...
		unsigned char                                            UnknownData_AGR8[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_BK87[0x10];                                  // 0x0050(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_69MW[0x4];                                   // 0x003C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_YFXJ[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_WBGN[0x2];                                   // 0x0472(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_U4GU[0x30];                                  // 0x0484(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_D4LM[0x7];                                   // 0x04B9(0x0007) MISSED OFFSET (PADDING)
...
class UGeometryCache* NewGeomCache
	...
	public:
		...
		unsigned char                                            UnknownData_0AUV[0x2C];                                  // 0x002C(0x002C) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_NC00[0x24];                                  // 0x005C(0x0024) MISSED OFFSET (PADDING)
...
float SampleTime
	...
	public:
		...
		unsigned char                                            UnknownData_3O1J[0x68];                                  // 0x0060(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_F3LQ[0x4];                                   // 0x00CC(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_6XKK[0xA8];                                  // 0x0058(0x00A8) MISSED OFFSET (PADDING)
...
const struct FGeometryCacheMeshData& NewMeshData
	...
	public:
		...
		unsigned char                                            UnknownData_UKRO[0xA8];                                  // 0x0058(0x00A8) MISSED OFFSET (PADDING)
