...
namespace CG
{
	 ...
	 */
	void ABP_LogicStraight_C::OverrideLogicIn(
class USceneComponent* Component
	 ...
	 */
	void ABP_LogicStraight_C::ExecuteUbergraph_BP_LogicStraight(
int32_t EntryPoint
)
	{
		static UFunction* fn = nullptr;
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ABP_LogicStraight_C.StaticClass
