...
namespace CG
{
	...
	public:
		...
		unsigned char                                            UnknownData_ZCT6[0x2];                                   // 0x0046(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_KIVR[0x3];                                   // 0x005D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_I0FA[0x1];                                   // 0x008F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_HHW9[0x4];                                   // 0x0094(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_ID5A[0x6];                                   // 0x00AA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
class UARCandidateImage* NewCandidateImage
	...
	public:
		...
		unsigned char                                            UnknownData_DEVK[0x7];                                   // 0x0051(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		class UARComponent* AddARComponent(
...
class UARPin* InPin
		...
		struct FIntPoint ResizeXRCamera(
...
const class FName& InSaveName
		...
		class UARPin* PinComponentToTraceResult(
...
const class FName& DebugName
		...
		TArray<struct FARTraceResult> LineTraceTrackedObjects3D(
...
bool bTestPlaneBoundaryPolygon
		...
		TArray<struct FARTraceResult> LineTraceTrackedObjects(
...
EARSceneReconstruction SceneReconstructionMethod
		...
		TArray<struct FARVideoFormat> GetSupportedVideoFormats(
EARSessionType SessionType
);
...
EARTextureType TextureType
		...
		TArray<class UARTrackedGeometry*> GetAllGeometriesByClass(
class UClass* GeometryClass
		...
		TArray<class UARTrackedPoint*> FindTrackedPointsByName(
...
bool bDeletePointsWithSameName
		...
		class UARCandidateImage* AddRuntimeCandidateImage(
class UARSessionConfig* SessionConfig
, 
...
const struct FARTraceResult& TraceResult
	...
	public:
		...
		unsigned char                                            UnknownData_DLBN[0x20];                                  // 0x0030(0x0020) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_Z1SW[0x10];                                  // 0x0070(0x0010) MISSED OFFSET (PADDING)
...
class UObject* WorldContextObject
	...
	public:
		...
		unsigned char                                            UnknownData_E84S[0x28];                                  // 0x0070(0x0028) MISSED OFFSET (PADDING)


	public:

		class UARGetCandidateObjectAsyncTaskBlueprintProxy* ARGetCandidateObject(
class UObject* WorldContextObject
, 
const struct FVector& Location
, 
const struct FVector& Extent
	...
	public:
		...
		unsigned char                                            UnknownData_5P6U[0x30];                                  // 0x0208(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_GH16[0x7];                                   // 0x0239(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_INI6[0x20];                                  // 0x0260(0x0020) MISSED OFFSET (PADDING)
...
const struct FARPointUpdatePayload& Payload
	...
	public:
		...
		unsigned char                                            UnknownData_W9E2[0x20];                                  // 0x02C0(0x0020) MISSED OFFSET (PADDING)
...
const struct FARFaceUpdatePayload& Payload
	...
	public:
		...
		void SetImageComponentDebugMode(
...
const struct FARImageUpdatePayload& Payload
	...
	public:
		...
		void SetQRCodeComponentDebugMode(
...
const struct FARQRCodeUpdatePayload& Payload
	...
	public:
		...
		void SetPoseComponentDebugMode(
...
const struct FARMeshUpdatePayload& Payload
	...
	public:
		...
		void SetGeoAnchorComponentDebugMode(
...
const class FString& OptionalAnchorName
	...
	public:
		...
		unsigned char                                            UnknownData_M6K3[0x30];                                  // 0x0070(0x0030) MISSED OFFSET (PADDING)


	public:

		void GeoTrackingAvailabilityDelegate__DelegateSignature(
bool bIsAvailable
, 
...
class UObject* WorldContextObject
	...
	public:
		...
		unsigned char                                            UnknownData_4UQB[0x30];                                  // 0x0070(0x0030) MISSED OFFSET (PADDING)


	public:

		void GetGeoLocationDelegate__DelegateSignature(
float Longitude
, 
float Latitude
, 
...
const struct FVector& WorldPosition
	...
	public:
		...
		unsigned char                                            UnknownData_VN2C[0x18];                                  // 0x0218(0x0018) MISSED OFFSET (PADDING)


	public:

		void ServerSpawnARActor(
...
class AARActor* Actor
		...
		void InstanceARActorToBeDestroyedDelegate__DelegateSignature(
class AARActor* Actor
);

		void InstanceARActorSpawnedDelegate__DelegateSignature(
class UClass* ComponentClass
, 
const struct FGuid& NativeID
, 
class AARActor* SpawnedActor
	...
	public:
		...
		unsigned char                                            UnknownData_8YOL[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_2VPG[0x1F];                                  // 0x00A1(0x001F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_9IRI[0x10];                                  // 0x00E0(0x0010) MISSED OFFSET (PADDING)
...
float PersistForSeconds
	...
	public:
		...
		unsigned char                                            UnknownData_UA1R[0x64];                                  // 0x030C(0x0064) MISSED OFFSET (PADDING)
...
TArray<unsigned char> ARWorldData
	...
	public:
		...
		unsigned char                                            UnknownData_OHN2[0x8];                                   // 0x02C0(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_S0Z4[0x8];                                   // 0x0570(0x0008) MISSED OFFSET (PADDING)
...
int32_t ARWorldDataSize
	...
	public:
		...
		unsigned char                                            UnknownData_SVWU[0x8];                                   // 0x0238(0x0008) MISSED OFFSET (PADDING)
...
class UAREnvironmentCaptureProbe* InCaptureProbe
	...
	public:
		...
		unsigned char                                            UnknownData_5FII[0x3];                                   // 0x00D9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_WVVU[0x5];                                   // 0x00FB(0x0005) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_1PBQ[0x3];                                   // 0x0131(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_1VJ9[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_XZ6I[0xF];                                   // 0x00A1(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_D3Z1[0x17];                                  // 0x00B9(0x0017) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_CSL0[0xC];                                   // 0x00D4(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_DXNA[0x10];                                  // 0x00E8(0x0010) Fix size for supers
	...
	public:
		...
		unsigned char                                            UnknownData_ZY6H[0x4];                                   // 0x00F8(0x0004) Fix Super Size
		...
		unsigned char                                            UnknownData_KDE4[0x4];                                   // 0x0114(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_32ZP[0x8];                                   // 0x00F8(0x0008) Fix Super Size
	...
	public:
		...
		unsigned char                                            UnknownData_RTYL[0x4];                                   // 0x011C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_G1ZW[0x3];                                   // 0x0105(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)


		TMap<EARFaceBlendShape, float>                           BlendShapes;                                             // 0x0108(0x0050) NativeAccessSpecifierPrivate


		unsigned char                                            UnknownData_9KS5[0x38];                                  // 0x0158(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
EARFaceBlendShape BlendShape
	...
	public:
		...
		unsigned char                                            UnknownData_2ILV[0x4];                                   // 0x0104(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                            UnknownData_8N1H[0x8];                                   // 0x0148(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_5I0E[0x8];                                   // 0x00F8(0x0008) Fix Super Size
...
float MaxLocationDiff
	...
	public:
		...
		unsigned char                                            UnknownData_7J5I[0x8];                                   // 0x00F8(0x0008) Fix Super Size


		unsigned char                                            UnknownData_51XP[0x10];                                  // 0x0100(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                            UnknownData_BKNV[0x4];                                   // 0x006C(0x0004) MISSED OFFSET (PADDING)
