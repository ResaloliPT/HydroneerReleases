...
namespace CG
{
	 ...
	 * Size -> 0x0292 (FullSize[0x0802] - InheritedSize[0x0570])
	 */
	...
	public:
		...
		unsigned char                                            UnknownData_ICC1[0x3];                                   // 0x057D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_9CYT[0x7];                                   // 0x0591(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		bool                                                     InStore;                                                 // 0x05B0(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor


		unsigned char                                            UnknownData_9DW5[0x7];                                   // 0x05B1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_BW8C[0x4];                                   // 0x05D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_PHJ3[0x3];                                   // 0x0659(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_YZCF[0x4];                                   // 0x066C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_VCP2[0x7];                                   // 0x0679(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                            UnknownData_3QF8[0xC];                                   // 0x06A4(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class ABP_ParentVehicle_C*                               NearestVehicle;                                          // 0x0718(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		unsigned char                                            UnknownData_70EL[0x8];                                   // 0x0738(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		bool                                                     IsCreativeMode;                                          // 0x07E8(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, SaveGame, IsPlainOldData, NoDestructor


		bool                                                     IsCloudSave;                                             // 0x07E9(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, SaveGame, IsPlainOldData, NoDestructor


		unsigned char                                            UnknownData_WWK0[0x6];                                   // 0x07EA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)


		class FString                                            PlayerName;                                              // 0x07F0(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, HasGetValueTypeHash


		bool                                                     RotationModify;                                          // 0x0800(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor


		bool                                                     HardHatMode;                                             // 0x0801(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
...
float Bounds
		...
		void Scan_for_Items_in_Voxel_Dirt(
const struct FVector& Location
, 
float Rad
);
...
const class FString& SaveSlot
		...
		class FString FormatCloudPathToLocalPath(
const class FString& SourceString
);

		void FormatSaveSlotCloudPath(
const class FString& SaveSlot
, 
...
TArray<unsigned char>* Data
		...
		void GetSaveSlotFiles(
const class FString& SaveSlot
, 
TArray<class FString>* Files
);

		class FString GetSaveSlotDirectory(
const class FString& SaveSlot
);

		class FString GetSaveDirectory();

		void LoadCurrentFilesFromCloud(
bool Override
, 
bool* Conflict
, 
...
class FText* LocalTime
		...
		void ToggleMenuFocusTimer(
bool On
);

		void ScanForItemsOnTop(
const struct FVector& Location
, 
float ExtentX
, 
float ExtentY
		...
		void SetHUD_Crosshair(
E_Crosshairs Crosshair
);

		void BoxTraceForRelics(
const struct FVector& Location
);
...
bool* TrueDrop
		...
		void InpActEvt_MouseScrollDown_K2Node_InputKeyEvent_3(
const struct FKey& Key
);

		void InpActEvt_MouseScrollUp_K2Node_InputKeyEvent_2(
const struct FKey& Key
);

		void InpActEvt_Rotate_K2Node_InputActionEvent_14(
const struct FKey& Key
);

		void InpActEvt_Rotate2_K2Node_InputActionEvent_13(
const struct FKey& Key
);

		void InpActEvt_Pickup_K2Node_InputActionEvent_12(
const struct FKey& Key
);

		void InpActEvt_Pickup_K2Node_InputActionEvent_11(
const struct FKey& Key
);

		void InpActEvt_VehicleKey_K2Node_InputActionEvent_10(
const struct FKey& Key
);

		void InpActEvt_Rotate3_K2Node_InputActionEvent_9(
const struct FKey& Key
);

		void InpActEvt_Wiki_K2Node_InputActionEvent_8(
const struct FKey& Key
);

		void InpActEvt_RMB_K2Node_InputActionEvent_7(
const struct FKey& Key
);

		void InpActEvt_RMB_K2Node_InputActionEvent_6(
const struct FKey& Key
);

		void OnCompleted_9EE0ABC14602C7545F03D1AF77EC46FC();

		void InpActEvt_LMB_K2Node_InputActionEvent_5(
const struct FKey& Key
);

		void InpActEvt_LMB_K2Node_InputActionEvent_4(
const struct FKey& Key
);
...
const struct FKey& Key
		...
		void InpActEvt_EscMenu_K2Node_InputActionEvent_3(
const struct FKey& Key
);

		void InpActEvt_RotationMod_K2Node_InputActionEvent_2(
const struct FKey& Key
);

		void InpActEvt_RotationMod_K2Node_InputActionEvent_1(
const struct FKey& Key
);
...
const struct FVoxelIntBox& Add
		...
		void RemoveDirtByLocation(
const struct FVector& Location
, 
float Radius
);

		void VehicleRemoveDirt(
const struct FVector& Location1
, 
const struct FVector& Location2
);
...
float NewValue
		...
		void InpAxisEvt_MouseRight_K2Node_InputAxisEvent_1(
float AxisValue
);
...
float NewValue
		...
		void ExecuteUbergraph_BP_GameController(
int32_t EntryPoint
);
